...
EPICS_VERSION_SHORT = _cas.EPICS_VERSION_SHORT
EPICS_VERSION_FULL = _cas.EPICS_VERSION_FULL
EPICS_VERSION_STRING = _cas.EPICS_VERSION_STRING
epicsReleaseVersion = _cas.epicsReleaseVersion
EPICS_VERSION_INT = _cas.EPICS_VERSION_INT
MAX_ENUM_STRING_SIZE = _cas.MAX_ENUM_STRING_SIZE
MAX_ENUM_STATES = _cas.MAX_ENUM_STATES
M_asLib = _cas.M_asLib
M_bucket = _cas.M_bucket
M_devLib = _cas.M_devLib
M_stdlib = _cas.M_stdlib
M_pool = _cas.M_pool
M_time = _cas.M_time
M_dbAccess = _cas.M_dbAccess
M_dbLib = _cas.M_dbLib
M_drvSup = _cas.M_drvSup
M_devSup = _cas.M_devSup
M_recSup = _cas.M_recSup
M_cas = _cas.M_cas
M_gddFuncTbl = _cas.M_gddFuncTbl
