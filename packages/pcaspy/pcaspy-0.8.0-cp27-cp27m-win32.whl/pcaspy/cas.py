...
class epicsTimeStamp(_object):
    ...
    def __init__(self, *args):
        this = _cas.new_epicsTimeStamp(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    if _newclass:
        fromPosixTimeStamp = staticmethod(_cas.epicsTimeStamp_fromPosixTimeStamp)
    else:
        fromPosixTimeStamp = _cas.epicsTimeStamp_fromPosixTimeStamp
...
def epicsTimeStamp_fromPosixTimeStamp(*args):
    return _cas.epicsTimeStamp_fromPosixTimeStamp(*args)
epicsTimeStamp_fromPosixTimeStamp = _cas.epicsTimeStamp_fromPosixTimeStamp
...
class casClientInfo(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, casClientInfo, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, casClientInfo, name)
    __repr__ = _swig_repr
    __swig_getmethods__["user"] = _cas.casClientInfo_user_get
    if _newclass:
        user = _swig_property(_cas.casClientInfo_user_get)
    __swig_getmethods__["host"] = _cas.casClientInfo_host_get
    if _newclass:
        host = _swig_property(_cas.casClientInfo_host_get)

    def __init__(self):
        this = _cas.new_casClientInfo()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
casClientInfo_swigregister = _cas.casClientInfo_swigregister
casClientInfo_swigregister(casClientInfo)
