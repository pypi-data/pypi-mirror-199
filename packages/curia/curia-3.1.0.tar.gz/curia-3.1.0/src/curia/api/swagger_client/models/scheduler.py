...
class Scheduler(object):
    ...
    def __init__(self, id=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, archived_at=None, version=None, type=None, workflow_id=None, schedule=None, organization_id=None, job_key=None, last_run_at=None, next_run_at=None, is_paused=None, organization=None, workflow=None):  # noqa: E501
