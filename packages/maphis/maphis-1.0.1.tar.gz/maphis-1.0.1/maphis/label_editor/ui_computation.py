...
class Ui_Computations(object):
    def setupUi(self, Computations):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 507, 74))
        ...
        sizePolicy3.setHeightForWidth(self.btnRegApply.sizePolicy().hasHeightForWidth())
        self.btnRegApply.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.btnRegApplyAll.sizePolicy().hasHeightForWidth())
        self.btnRegApplyAll.setSizePolicy(sizePolicy3)
