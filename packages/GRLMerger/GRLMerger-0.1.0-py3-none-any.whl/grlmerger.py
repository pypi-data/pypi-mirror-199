...
#                    m_actor_description = base_actors_df['actor_description'][base_index]
            ...
            if base_actors_df['actor_importance'][base_index]:
                if new_actors_df['actor_importance'][new_index]:
                    quantitative_base_importance, quantitative_new_importance = quantitativeImportanceValue(base_actors_df['actor_importance'][base_index], new_actors_df['actor_importance'][new_index])
                    if quantitative_base_importance != quantitative_new_importance:
                        ...
                        importance_summation = quantitative_base_importance + quantitative_new_importance
                        ...
                        traceConflict(base_actors_df['actor_name'][base_index], base_actors_df['actor_importance'][base_index], new_actors_df['actor_name'][new_index], new_actors_df['actor_importance'][new_index], m_actor_importance, m_actor_ID, 'Actor Importance')
                    else:
                        m_actor_importance = base_actors_df['actor_importance'][base_index]
                else:
            ...
            if base_actors_df['actor_metadata'][base_index]:
                if new_actors_df['actor_metadata'][new_index]:
                    ...
                    if base_actors_df['actor_metadata'][base_index] == new_actors_df['actor_metadata'][new_index]:
                        ...
                        traceConflict(base_actors_df['actor_name'][base_index], base_actors_df['actor_metadata'][base_index], new_actors_df['actor_name'][new_index], new_actors_df['actor_metadata'][new_index], m_actor_metadata, m_actor_ID, 'Actor Metadata')
            ...
            if mergingMethod == "1":
                ...
                if base_element_df['ielement_importance'].item():
                    if new_element_df['ielement_importance'].item():
                        quantitative_base_importance, quantitative_new_importance = quantitativeImportanceValue(base_element_df['ielement_importance'].item(), new_element_df['ielement_importance'].item())
                        if quantitative_base_importance != quantitative_new_importance:
...
#                                    if int(base_relations_df['contribution_value'][br]) != int(new_relations_df['contribution_value'][nr]):
...
def quantitativeContributionValue(base_contribution, new_contribution):
    ...
    return int(base_contribution), int(new_contribution)
...
def quantitativeImportanceValue(base_importance, new_importance):
    ...
    return int(base_importance), int(new_importance)
