...
def find_numbers(text):
    regex = "[০১২৩৪৫৬৭৮৯]+.[০১২৩৪৫৬৭৮৯]+|[০১২৩৪৫৬৭৮৯]+[অআইঈউঊঋএঐওঔকখগঘঙচছজঝঞযশহটঠডঢণরষতথদধনলসপফবভমড়ঢ়য়ৎংঃ‍ঁ‍্‍্য‍‍্রর্ক]+|[০১২৩৪৫৬৭৮৯]+"
    num = re.findall(regex, text)
    return num

def remove_numbers(text,alphanumeric=True):
    if(alphanumeric.capitalize()==True):
      regex = "[০১২৩৪৫৬৭৮৯]+.[০১২৩৪৫৬৭৮৯]+|[০১২৩৪৫৬৭৮৯]+[অআইঈউঊঋএঐওঔকখগঘঙচছজঝঞযশহটঠডঢণরষতথদধনলসপফবভমড়ঢ়য়ৎংঃ‍ঁ‍্‍্য‍‍্রর্ক]+|[০১২৩৪৫৬৭৮৯]+"
    elif(alphanumeric.capitalize()==False):
      regex = "([০-৯]+\.[০-৯]+|[০-৯]+)(?=[,।!?‘’;\s])"
    num = re.findall(regex, text)
    for x in num:
      text = text.replace(x, '')
