...
class AgentWrapper:
    def __init__(self, agent_class, name, index, background_processors, message_processors):
        pubsub = ceylon.ceylon.PubSub()
        self.agent = agent_class()
        self.agent.name = name
        self.agent.index = index
...
class CeylonAIAgent:
    ...
    def __start__(self):
        ...
        for i in range(self.__number_of_agents):
            ...
            agent = AgentWrapper(agent_class, agent_name, i, background_processors,
                                 message_processors)
