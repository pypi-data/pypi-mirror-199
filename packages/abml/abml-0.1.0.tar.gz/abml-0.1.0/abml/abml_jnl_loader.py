...
def get_nested_value(d, *keys):
    """
    Get the value associated with the sequence of keys in the nested dictionary or object d.

    Args:
        d (dict or object): The nested dictionary or object.
        keys (tuple): The sequence of keys.

    Returns:
        The value associated with the sequence of keys in the nested dictionary or object.
    """
    for key in keys:
