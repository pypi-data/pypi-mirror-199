    ...
    try:
        if("kenu" in module):
            ...
            if not os.path.exists(name):
                os.makedirs(name)
            urllib.request.urlretrieve(f"https://kenucorp.com/modules/" + module + ".py", f"{name}\{name}.py")
            urllib.request.urlretrieve(f"https://kenucorp.com/modules/{module}requirements.txt", name + f"{name}\\requirements.txt")
            try:
