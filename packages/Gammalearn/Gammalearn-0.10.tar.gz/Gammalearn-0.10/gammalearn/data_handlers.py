...
class GLearnDomainAdaptationDataModule(GLearnDataModule):
    ...
    def get_dataset(self, train):
        ...
        source_datasets = self.get_glearn_dataset_from_path(data_module_source, train=train, domain='source')
        target_datasets = self.get_glearn_dataset_from_path(data_module_target, train=train, domain='target')
