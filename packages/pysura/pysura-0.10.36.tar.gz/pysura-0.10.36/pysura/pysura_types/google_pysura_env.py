...
class Labels(DictModel):
    firebase: str | None = None
...
class GoogleServicesDocumentation(BaseModel):
    summary: str | None = None


class GoogleServicesLabel(BaseModel):
    description: str | None = None
    key: str


class GoogleServicesMonitoredResource(BaseModel):
    description: str | None = None
    displayName: str | None = None
    labels: List[GoogleServicesLabel] | None = None
    launchStage: str | None = None
    type: str | None = None


class GoogleServicesConsumerDestination(BaseModel):
    metrics: List[str] | None = None
    monitoredResource: str | None = None


class GoogleServicesMonitoring(BaseModel):
    consumerDestinations: List[GoogleServicesConsumerDestination] | None = None
...
class GoogleServicesConfig(BaseModel):
    ...
    documentation: GoogleServicesDocumentation | None = None
    monitoredResources: List[GoogleServicesMonitoredResource] | None = None
    monitoring: GoogleServicesMonitoring | None = None
    name: str | None = None
...
class GoogleServices(DictModel):
    config: GoogleServicesConfig | None = None
    name: str | None = None
...
class GooglePysuraEnv(DictModel):
    ...
    services: List[GoogleServices] | None = None
