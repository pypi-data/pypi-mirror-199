...
class Plan:
    ...
    def get_plans_external_plan_id(self, request: operations.GetPlansExternalPlanIDRequest) -> operations.GetPlansExternalPlanIDResponse:
        ...
        url = utils.generate_url(operations.GetPlansExternalPlanIDPathParams, base_url, '/plans/external_plan_id/{external_plan_id}', request.path_params)
    ...
    def get_plans_plan_id(self, request: operations.GetPlansPlanIDRequest) -> operations.GetPlansPlanIDResponse:
        ...
        url = utils.generate_url(operations.GetPlansPlanIDPathParams, base_url, '/plans/{plan_id}', request.path_params)
