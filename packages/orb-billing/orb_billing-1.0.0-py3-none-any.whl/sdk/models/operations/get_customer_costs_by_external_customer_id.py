...
class GetCustomerCostsByExternalCustomerIDPathParams:
...
@dataclasses.dataclass
class GetCustomerCostsByExternalCustomerIDQueryParams:
...
class GetCustomerCostsByExternalCustomerIDRequest:
    ...
    path_params: GetCustomerCostsByExternalCustomerIDPathParams = dataclasses.field()  
    query_params: GetCustomerCostsByExternalCustomerIDQueryParams = dataclasses.field()  
