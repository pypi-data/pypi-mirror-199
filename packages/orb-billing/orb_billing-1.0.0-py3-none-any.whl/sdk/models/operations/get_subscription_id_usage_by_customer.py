...
class GetSubscriptionIDUsageByCustomerRequest:
    ...
    path_params: GetSubscriptionIDUsageByCustomerPathParams = dataclasses.field()  
    query_params: GetSubscriptionIDUsageByCustomerQueryParams = dataclasses.field()  
