...
@dataclasses.dataclass
class PostSubscriptionsJSONRequest:
    
    request: Optional[PostSubscriptionsApplicationJSON] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
