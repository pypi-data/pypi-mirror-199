...
class PostCustomersCustomerIDBalanceTransactionsPathParams:
...
class PostCustomersCustomerIDBalanceTransactionsRequest:
    ...
    path_params: PostCustomersCustomerIDBalanceTransactionsPathParams = dataclasses.field()  
    request: Optional[PostCustomersCustomerIDBalanceTransactionsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
