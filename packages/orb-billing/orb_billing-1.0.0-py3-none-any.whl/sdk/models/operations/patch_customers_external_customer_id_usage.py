...
class PatchCustomersExternalCustomerIDUsagePathParams:
...
@dataclasses.dataclass
class PatchCustomersExternalCustomerIDUsageQueryParams:
...
class PatchCustomersExternalCustomerIDUsageRequest:
    ...
    path_params: PatchCustomersExternalCustomerIDUsagePathParams = dataclasses.field()  
    query_params: PatchCustomersExternalCustomerIDUsageQueryParams = dataclasses.field()  
    request: Optional[PatchCustomersExternalCustomerIDUsageRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
