...
class Customer:
    ...
    def delete_customers_customer_id(self, request: operations.DeleteCustomersCustomerIDRequest) -> operations.DeleteCustomersCustomerIDResponse:
        ...
        **Note**: This operation happens asynchronously and can be expected to take a few minutes to propagate to related resources. However, querying for the customer on subsequent GET requests while deletion is in process will reflect its deletion with a `deleted: true` property. Once the customer deletion has been fully processed, the customer will not be returned in the API.
        ...
        url = utils.generate_url(operations.DeleteCustomersCustomerIDPathParams, base_url, '/customers/{customer_id}', request.path_params)
    ...
    def get_customer_costs(self, request: operations.GetCustomerCostsRequest) -> operations.GetCustomerCostsResponse:
        ...
        url = utils.generate_url(operations.GetCustomerCostsPathParams, base_url, '/customers/{customer_id}/costs', request.path_params)
        
        query_params = utils.get_query_params(operations.GetCustomerCostsQueryParams, request.query_params)
    ...
    def get_customer_costs_by_external_customer_id(self, request: operations.GetCustomerCostsByExternalCustomerIDRequest) -> operations.GetCustomerCostsByExternalCustomerIDResponse:
        ...
        url = utils.generate_url(operations.GetCustomerCostsByExternalCustomerIDPathParams, base_url, '/customers/external_customer_id/{external_customer_id}/costs', request.path_params)
        
        query_params = utils.get_query_params(operations.GetCustomerCostsByExternalCustomerIDQueryParams, request.query_params)
    ...
    def get_customers_customer_id(self, request: operations.GetCustomersCustomerIDRequest) -> operations.GetCustomersCustomerIDResponse:
        ...
        url = utils.generate_url(operations.GetCustomersCustomerIDPathParams, base_url, '/customers/{customer_id}', request.path_params)
    ...
    def get_customers_customer_id_balance_transactions(self, request: operations.GetCustomersCustomerIDBalanceTransactionsRequest) -> operations.GetCustomersCustomerIDBalanceTransactionsResponse:
        ...
        url = utils.generate_url(operations.GetCustomersCustomerIDBalanceTransactionsPathParams, base_url, '/customers/{customer_id}/balance_transactions', request.path_params)
    ...
    def get_customers_external_customer_id_external_customer_id(self, request: operations.GetCustomersExternalCustomerIDExternalCustomerIDRequest) -> operations.GetCustomersExternalCustomerIDExternalCustomerIDResponse:
        ...
        url = utils.generate_url(operations.GetCustomersExternalCustomerIDExternalCustomerIDPathParams, base_url, '/customers/external_customer_id/{external_customer_id}', request.path_params)
    ...
    def patch_customers_customer_id_usage(self, request: operations.PatchCustomersCustomerIDUsageRequest) -> operations.PatchCustomersCustomerIDUsageResponse:
        ...
        url = utils.generate_url(operations.PatchCustomersCustomerIDUsagePathParams, base_url, '/customers/{customer_id}/usage', request.path_params)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.PatchCustomersCustomerIDUsageQueryParams, request.query_params)
    ...
    def patch_customers_external_customer_id_usage(self, request: operations.PatchCustomersExternalCustomerIDUsageRequest) -> operations.PatchCustomersExternalCustomerIDUsageResponse:
        ...
        url = utils.generate_url(operations.PatchCustomersExternalCustomerIDUsagePathParams, base_url, '/customers/external_customer_id/{external_customer_id}/usage', request.path_params)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.PatchCustomersExternalCustomerIDUsageQueryParams, request.query_params)
    ...
    def post_customers_customer_id_balance_transactions(self, request: operations.PostCustomersCustomerIDBalanceTransactionsRequest) -> operations.PostCustomersCustomerIDBalanceTransactionsResponse:
        ...
        url = utils.generate_url(operations.PostCustomersCustomerIDBalanceTransactionsPathParams, base_url, '/customers/{customer_id}/balance_transactions', request.path_params)
    ...
    def put_customers_customer_id(self, request: operations.PutCustomersCustomerIDRequest) -> operations.PutCustomersCustomerIDResponse:
        ...
        url = utils.generate_url(operations.PutCustomersCustomerIDPathParams, base_url, '/customers/{customer_id}', request.path_params)
    ...
    def put_customers_external_customer_id_external_customer_id(self, request: operations.PutCustomersExternalCustomerIDExternalCustomerIDRequest) -> operations.PutCustomersExternalCustomerIDExternalCustomerIDResponse:
        ...
        url = utils.generate_url(operations.PutCustomersExternalCustomerIDExternalCustomerIDPathParams, base_url, '/customers/external_customer_id/{external_customer_id}', request.path_params)
