...
class Invoice:
    ...
    def get_invoice_invoice_id(self, request: operations.GetInvoiceInvoiceIDRequest) -> operations.GetInvoiceInvoiceIDResponse:
        ...
        url = utils.generate_url(operations.GetInvoiceInvoiceIDPathParams, base_url, '/invoices/{invoice_id}', request.path_params)
    ...
    def get_invoices(self, request: operations.GetInvoicesRequest) -> operations.GetInvoicesResponse:
        ...
        query_params = utils.get_query_params(operations.GetInvoicesQueryParams, request.query_params)
    ...
    def get_invoices_upcoming(self, request: operations.GetInvoicesUpcomingRequest) -> operations.GetInvoicesUpcomingResponse:
        ...
        query_params = utils.get_query_params(operations.GetInvoicesUpcomingQueryParams, request.query_params)
    ...
    def post_invoice_line_items(self, request: operations.PostInvoiceLineItemsRequest) -> operations.PostInvoiceLineItemsResponse:
    ...
    def post_invoices_invoice_id_void(self, request: operations.PostInvoicesInvoiceIDVoidRequest) -> operations.PostInvoicesInvoiceIDVoidResponse:
        ...
        url = utils.generate_url(operations.PostInvoicesInvoiceIDVoidPathParams, base_url, '/invoices/{invoice_id}/void', request.path_params)
