...
class Credits:
    ...
    def get_customers_customer_id_credits(self, request: operations.GetCustomersCustomerIDCreditsRequest) -> operations.GetCustomersCustomerIDCreditsResponse:
        ...
        url = utils.generate_url(operations.GetCustomersCustomerIDCreditsPathParams, base_url, '/customers/{customer_id}/credits', request.path_params)
    ...
    def get_customers_customer_id_credits_ledger(self, request: operations.GetCustomersCustomerIDCreditsLedgerRequest) -> operations.GetCustomersCustomerIDCreditsLedgerResponse:
        ...
        url = utils.generate_url(operations.GetCustomersCustomerIDCreditsLedgerPathParams, base_url, '/customers/{customer_id}/credits/ledger', request.path_params)
        
        query_params = utils.get_query_params(operations.GetCustomersCustomerIDCreditsLedgerQueryParams, request.query_params)
    ...
    def post_customers_customer_id_credits_ledger_entry(self, request: operations.PostCustomersCustomerIDCreditsLedgerEntryRequest) -> operations.PostCustomersCustomerIDCreditsLedgerEntryResponse:
        ...
        url = utils.generate_url(operations.PostCustomersCustomerIDCreditsLedgerEntryPathParams, base_url, '/customers/{customer_id}/credits/ledger_entry', request.path_params)
