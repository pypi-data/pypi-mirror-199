...
@dataclasses.dataclass
class PostInvoiceLineItemsRequest:
    
    request: Optional[PostInvoiceLineItemsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
