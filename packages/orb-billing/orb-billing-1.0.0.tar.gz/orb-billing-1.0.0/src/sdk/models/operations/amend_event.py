...
class AmendEventRequest:
    ...
    path_params: AmendEventPathParams = dataclasses.field()  
    request: Optional[AmendEventRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
