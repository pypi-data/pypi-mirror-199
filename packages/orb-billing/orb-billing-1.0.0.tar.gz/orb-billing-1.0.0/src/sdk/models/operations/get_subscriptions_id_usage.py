...
class GetSubscriptionsIDUsagePathParams:
...
@dataclasses.dataclass
class GetSubscriptionsIDUsageQueryParams:
...
class GetSubscriptionsIDUsageRequest:
    ...
    path_params: GetSubscriptionsIDUsagePathParams = dataclasses.field()  
    query_params: GetSubscriptionsIDUsageQueryParams = dataclasses.field()  
