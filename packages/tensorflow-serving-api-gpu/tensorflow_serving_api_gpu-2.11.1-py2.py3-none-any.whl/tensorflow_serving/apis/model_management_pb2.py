...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[tensorflow__serving_dot_apis_dot_status__pb2.DESCRIPTOR,tensorflow__serving_dot_config_dot_model__server__config__pb2.DESCRIPTOR,])
...
_RELOADCONFIGRESPONSE.fields_by_name['status'].message_type = tensorflow__serving_dot_apis_dot_status__pb2._STATUSPROTO
