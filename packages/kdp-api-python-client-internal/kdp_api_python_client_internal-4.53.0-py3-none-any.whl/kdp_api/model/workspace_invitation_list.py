...
class WorkspaceInvitationList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """WorkspaceInvitationList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([WorkspaceInvitation]):  # noqa: E501

        Keyword Args:
            value ([WorkspaceInvitation]):  # noqa: E501
