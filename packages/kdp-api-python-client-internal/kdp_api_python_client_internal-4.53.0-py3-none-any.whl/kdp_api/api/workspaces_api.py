...
class WorkspacesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_workspaces_id_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'delete_workspaces_id',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def delete_workspaces_id(
        self,
        id,
        **kwargs
    ):
        """Deletes Workspace with the ID given  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_workspaces_id(id, async_req=True)
        >>> result = thread.get()

        Args:
            id (str): ID of workspace to remove
        ...
        kwargs['id'] = \
            id
        return self.delete_workspaces_id_endpoint.call_with_http_info(**kwargs)
