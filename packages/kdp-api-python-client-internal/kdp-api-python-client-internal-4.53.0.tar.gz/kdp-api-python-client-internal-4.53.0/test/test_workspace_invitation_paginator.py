...
globals()['WorkspaceInvitationList'] = WorkspaceInvitationList
from kdp_api.model.workspace_invitation_paginator import WorkspaceInvitationPaginator


class TestWorkspaceInvitationPaginator(unittest.TestCase):
    """WorkspaceInvitationPaginator unit test stubs"""
    ...
    def testWorkspaceInvitationPaginator(self):
        """Test WorkspaceInvitationPaginator"""
        # FIXME: construct object with mandatory attributes with example values
        # model = WorkspaceInvitationPaginator()  # noqa: E501
        pass
