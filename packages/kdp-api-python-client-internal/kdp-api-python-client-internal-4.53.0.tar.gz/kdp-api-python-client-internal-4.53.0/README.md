...
*AuditLogConfigsApi* | [**get_auditlog_configuration**](docs/AuditLogConfigsApi.md#get_auditlog_configuration) | **GET** /audit-log-configs/{logConfigurationId} | Get audit log configuration of a workspace by configuration Id
...
*AuditLogConfigsApi* | [**put_auditlog_configuration**](docs/AuditLogConfigsApi.md#put_auditlog_configuration) | **PUT** /audit-log-configs/{auditLogConfigsId} | Modify audit log configuration of a workspace
...
*TransferResourceRequestsApi* | [**get_transfer_resource_requests**](docs/TransferResourceRequestsApi.md#get_transfer_resource_requests) | **GET** /transfer-resource-requests | Retrieves a list of transfer resource requests
*TransferResourceRequestsApi* | [**get_transfer_resource_requests_id**](docs/TransferResourceRequestsApi.md#get_transfer_resource_requests_id) | **GET** /transfer-resource-requests/{id} | Retrieves a transfer resource request with the given ID
*TransferResourceRequestsApi* | [**patch_transfer_resource_requests_id**](docs/TransferResourceRequestsApi.md#patch_transfer_resource_requests_id) | **PATCH** /transfer-resource-requests/{id} | Patches the transfer resource request status by id
*TransferResourceRequestsApi* | [**post_transfer_resource_requests**](docs/TransferResourceRequestsApi.md#post_transfer_resource_requests) | **POST** /transfer-resource-requests | Create a transfer resource request
...
## Documentation For Models
 ...
 - [CreateATransferResourceRequest](docs/CreateATransferResourceRequest.md)
 ...
 - [TransferResourceRequestPaginator](docs/TransferResourceRequestPaginator.md)
 - [User](docs/User.md)
