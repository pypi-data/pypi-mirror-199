...
class WorkspaceInvitationCreateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, workspace_id, role, email, *args, **kwargs):  # noqa: E501
        """WorkspaceInvitationCreateRequest - a model defined in OpenAPI

        Args:
            workspace_id (str): Workspace ID
            role (str): Workspace Role for the User
    ...
    @convert_js_args_to_python_args
    def __init__(self, workspace_id, role, email, *args, **kwargs):  # noqa: E501
        """WorkspaceInvitationCreateRequest - a model defined in OpenAPI
