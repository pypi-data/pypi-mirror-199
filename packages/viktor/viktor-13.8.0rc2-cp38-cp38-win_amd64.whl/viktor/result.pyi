...
from .views import ImageResult as ImageResult, JPGResult as JPGResult, PNGResult as PNGResult, SVGResult as SVGResult
...
class OptimizationResult(_SerializableObject):
    ...
    def __init__(self, results: List[OptimizationResultElement], result_column_names_input: List[str] = ..., output_headers: dict = ..., image: Union[ImageResult, PNGResult, JPGResult, SVGResult] = ...) -> None: ...
