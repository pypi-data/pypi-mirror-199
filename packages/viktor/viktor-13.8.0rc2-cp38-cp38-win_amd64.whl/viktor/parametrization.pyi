...
from .core import Color as Color, ISCLOSE_ATOL as ISCLOSE_ATOL, UserException as UserException, _OrderedClass
...
class NumberField(Field):
    def __init__(self, ui_name: str, name: str = ..., prefix: str = ..., *, suffix: str = ..., default: float = ..., step: float = ..., min: MinMaxType = ..., max: MinMaxType = ..., min_message: str = ..., max_message: str = ..., num_decimals: int = ..., visible: VisibleType = ..., flex: int = ..., variant: str = ..., description: str = ...) -> None: ...
