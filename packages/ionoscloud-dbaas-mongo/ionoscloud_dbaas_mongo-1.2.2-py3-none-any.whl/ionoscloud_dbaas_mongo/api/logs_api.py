...
class LogsApi(object):
    ...
    def clusters_logs_get(self, cluster_id, **kwargs):  # noqa: E501
        """Get logs of your cluster  # noqa: E501

        Retrieves MongoDB logs based on the given parameters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.clusters_logs_get(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.clusters_logs_get_with_http_info(cluster_id, **kwargs)  # noqa: E501

    def clusters_logs_get_with_http_info(self, cluster_id, **kwargs):  # noqa: E501
        """Get logs of your cluster  # noqa: E501
        ...
        >>> thread = api.clusters_logs_get_with_http_info(cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method clusters_logs_get" % local_var_params_key
                )
        ...
        if self.api_client.client_side_validation and ('cluster_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `cluster_id` when calling `clusters_logs_get`")  # noqa: E501

        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 5000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `clusters_logs_get`, must be a value less than or equal to `5000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `clusters_logs_get`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
