...
class RestoresApi(object):
    ...
    def clusters_restore_post(self, cluster_id, create_restore_request, **kwargs):  # noqa: E501
        """In-place restore of a cluster  # noqa: E501

        Triggers an in-place restore of the given MongoDB cluster.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.clusters_restore_post(cluster_id, create_restore_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.clusters_restore_post_with_http_info(cluster_id, create_restore_request, **kwargs)  # noqa: E501

    def clusters_restore_post_with_http_info(self, cluster_id, create_restore_request, **kwargs):  # noqa: E501
        """In-place restore of a cluster  # noqa: E501
        ...
        >>> thread = api.clusters_restore_post_with_http_info(cluster_id, create_restore_request, async_req=True)
        >>> result = thread.get()
        ...
        for local_var_params_key, local_var_params_val in six.iteritems(local_var_params['kwargs']):
            if local_var_params_key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method clusters_restore_post" % local_var_params_key
                )
        ...
        if self.api_client.client_side_validation and ('cluster_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `cluster_id` when calling `clusters_restore_post`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('create_restore_request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `create_restore_request` when calling `clusters_restore_post`")  # noqa: E501
