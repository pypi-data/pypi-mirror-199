...
class ClusterLogsInstances(object):
    ...
    def __init__(self, name=None, messages=None, local_vars_configuration=None):  # noqa: E501
        """ClusterLogsInstances - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this ClusterLogsInstances.  # noqa: E501

        The name of the MongoDB instance.  # noqa: E501

        :return: The name of this ClusterLogsInstances.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ClusterLogsInstances.

        The name of the MongoDB instance.  # noqa: E501

        :param name: The name of this ClusterLogsInstances.  # noqa: E501
        :type name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterLogsInstances):
            return False
