...
class PaginationLinks(object):
    ...
    def prev(self):
        ...
        The URL (with offset and limit parameters) of the previous page; only present if the offset is greater than 0.   # noqa: E501
    ...
    def _self(self):
        ...
        The URL (with offset and limit parameters) of the current page.   # noqa: E501
    ...
    def next(self):
        ...
        The URL (with offset and limit parameters) of the next page; only present if the offset and limit is less than the total number of elements.   # noqa: E501
