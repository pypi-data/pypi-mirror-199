...
class QueuedJobRawFlowModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, QueuedJobRawFlowModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, QueuedJobRawFlowModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = QueuedJobRawFlowModulesItemInputTransforms.from_dict(_input_transforms)
