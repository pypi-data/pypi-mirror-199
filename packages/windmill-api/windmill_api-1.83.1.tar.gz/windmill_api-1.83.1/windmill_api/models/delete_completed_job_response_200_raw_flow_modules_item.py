...
class DeleteCompletedJobResponse200RawFlowModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, DeleteCompletedJobResponse200RawFlowModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, DeleteCompletedJobResponse200RawFlowModulesItemInputTransforms] = UNSET
