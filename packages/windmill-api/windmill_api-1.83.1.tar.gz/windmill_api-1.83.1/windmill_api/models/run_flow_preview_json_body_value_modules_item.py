...
class RunFlowPreviewJsonBodyValueModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, RunFlowPreviewJsonBodyValueModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, RunFlowPreviewJsonBodyValueModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = RunFlowPreviewJsonBodyValueModulesItemInputTransforms.from_dict(_input_transforms)
