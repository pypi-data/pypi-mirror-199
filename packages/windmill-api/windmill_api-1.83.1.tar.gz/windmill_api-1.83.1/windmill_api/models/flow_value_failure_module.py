...
class FlowValueFailureModule:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, FlowValueFailureModuleInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, FlowValueFailureModuleInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = FlowValueFailureModuleInputTransforms.from_dict(_input_transforms)
