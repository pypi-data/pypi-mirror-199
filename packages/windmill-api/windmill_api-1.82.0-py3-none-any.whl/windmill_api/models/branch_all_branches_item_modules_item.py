...
from ..models.branch_all_branches_item_modules_item_input_transforms import (
    BranchAllBranchesItemModulesItemInputTransforms,
)
...
class BranchAllBranchesItemModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, BranchAllBranchesItemModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, BranchAllBranchesItemModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = BranchAllBranchesItemModulesItemInputTransforms.from_dict(_input_transforms)
