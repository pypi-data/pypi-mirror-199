...
class FlowPreviewValueFailureModule:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, FlowPreviewValueFailureModuleInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, FlowPreviewValueFailureModuleInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = FlowPreviewValueFailureModuleInputTransforms.from_dict(_input_transforms)
