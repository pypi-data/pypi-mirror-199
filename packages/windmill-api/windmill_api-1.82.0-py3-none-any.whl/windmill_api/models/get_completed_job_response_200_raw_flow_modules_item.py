...
class GetCompletedJobResponse200RawFlowModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, GetCompletedJobResponse200RawFlowModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = GetCompletedJobResponse200RawFlowModulesItemInputTransforms.from_dict(_input_transforms)
