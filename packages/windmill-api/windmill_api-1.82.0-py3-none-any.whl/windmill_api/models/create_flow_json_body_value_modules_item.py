...
class CreateFlowJsonBodyValueModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, CreateFlowJsonBodyValueModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, CreateFlowJsonBodyValueModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = CreateFlowJsonBodyValueModulesItemInputTransforms.from_dict(_input_transforms)
