...
class UpdateFlowJsonBodyValueModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, UpdateFlowJsonBodyValueModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, UpdateFlowJsonBodyValueModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = UpdateFlowJsonBodyValueModulesItemInputTransforms.from_dict(_input_transforms)
