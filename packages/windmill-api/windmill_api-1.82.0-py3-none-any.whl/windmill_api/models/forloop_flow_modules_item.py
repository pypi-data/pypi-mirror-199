...
from ..models.forloop_flow_modules_item_input_transforms import ForloopFlowModulesItemInputTransforms
...
class ForloopFlowModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, ForloopFlowModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, ForloopFlowModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = ForloopFlowModulesItemInputTransforms.from_dict(_input_transforms)
