...
class FlowPreviewValueModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, FlowPreviewValueModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, FlowPreviewValueModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = FlowPreviewValueModulesItemInputTransforms.from_dict(_input_transforms)
