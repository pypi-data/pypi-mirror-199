...
class DeleteCompletedJobResponse200RawFlowFailureModule:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, DeleteCompletedJobResponse200RawFlowFailureModuleInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, DeleteCompletedJobResponse200RawFlowFailureModuleInputTransforms] = UNSET
