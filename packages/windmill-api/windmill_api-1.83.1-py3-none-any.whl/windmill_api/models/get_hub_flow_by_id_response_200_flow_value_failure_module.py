...
class GetHubFlowByIdResponse200FlowValueFailureModule:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, GetHubFlowByIdResponse200FlowValueFailureModuleInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, GetHubFlowByIdResponse200FlowValueFailureModuleInputTransforms] = UNSET
