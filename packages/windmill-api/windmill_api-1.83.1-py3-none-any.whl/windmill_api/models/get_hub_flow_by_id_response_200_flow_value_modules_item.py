...
class GetHubFlowByIdResponse200FlowValueModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, GetHubFlowByIdResponse200FlowValueModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, GetHubFlowByIdResponse200FlowValueModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = GetHubFlowByIdResponse200FlowValueModulesItemInputTransforms.from_dict(_input_transforms)
