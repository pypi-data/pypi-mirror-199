...
from ..models.flow_module_value_2_type_3_modules_item_input_transforms import (
    FlowModuleValue2Type3ModulesItemInputTransforms,
)
...
class FlowModuleValue2Type3ModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, FlowModuleValue2Type3ModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, FlowModuleValue2Type3ModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = FlowModuleValue2Type3ModulesItemInputTransforms.from_dict(_input_transforms)
