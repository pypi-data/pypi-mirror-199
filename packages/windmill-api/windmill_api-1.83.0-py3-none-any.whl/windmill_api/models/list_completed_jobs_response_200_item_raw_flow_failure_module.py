...
class ListCompletedJobsResponse200ItemRawFlowFailureModule:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleInputTransforms] = UNSET
