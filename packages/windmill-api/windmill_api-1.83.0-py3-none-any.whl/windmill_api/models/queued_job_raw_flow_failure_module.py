...
class QueuedJobRawFlowFailureModule:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, QueuedJobRawFlowFailureModuleInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, QueuedJobRawFlowFailureModuleInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = QueuedJobRawFlowFailureModuleInputTransforms.from_dict(_input_transforms)
