...
class ListQueueResponse200ItemRawFlowModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, ListQueueResponse200ItemRawFlowModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, ListQueueResponse200ItemRawFlowModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = ListQueueResponse200ItemRawFlowModulesItemInputTransforms.from_dict(_input_transforms)
