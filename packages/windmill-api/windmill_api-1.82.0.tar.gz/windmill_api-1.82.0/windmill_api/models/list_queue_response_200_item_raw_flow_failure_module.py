...
class ListQueueResponse200ItemRawFlowFailureModule:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, ListQueueResponse200ItemRawFlowFailureModuleInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, ListQueueResponse200ItemRawFlowFailureModuleInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = ListQueueResponse200ItemRawFlowFailureModuleInputTransforms.from_dict(_input_transforms)
