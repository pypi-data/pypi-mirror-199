...
class CompletedJobRawFlowFailureModule:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, CompletedJobRawFlowFailureModuleInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, CompletedJobRawFlowFailureModuleInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = CompletedJobRawFlowFailureModuleInputTransforms.from_dict(_input_transforms)
