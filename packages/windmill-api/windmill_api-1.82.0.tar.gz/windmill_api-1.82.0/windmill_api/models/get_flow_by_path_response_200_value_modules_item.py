...
class GetFlowByPathResponse200ValueModulesItem:
    ...
    Attributes:
        id (str):
        value (Any):
        input_transforms (Union[Unset, GetFlowByPathResponse200ValueModulesItemInputTransforms]):
    ...
    id: str
    value: Any
    input_transforms: Union[Unset, GetFlowByPathResponse200ValueModulesItemInputTransforms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_input_transforms, Unset):
            ...
            input_transforms = GetFlowByPathResponse200ValueModulesItemInputTransforms.from_dict(_input_transforms)
