...
class Audio(Signal):
    ...
    def vtlp_aug(
        ...
        *,
        ...
        _transform_data(self, partial(_custom_features.vtlp, sr=sr))
        self.__init__(self.data)
    ...
    def PitchAug(
        ...
        *,
        ...
        """Pitch augmentation of the data.
        ...
        _transform_data(self, partial(_custom_features.pitch, sr=sr, factor=factor))
        self.__init__(self.data)
    ...
    def RollAug(
        ...
        """Roll augmentation of the data.
        
        """

        _transform_data(self, partial(_custom_features.rollAudio))
        self.__init__(self.data)