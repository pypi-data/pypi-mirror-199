...
class Base(object):
    ...
    def create_metrics(self, best_programs):
        ...
        def _metrics(program, data, name):
    ...
    def calculate_result(self, dimension_data, configure, custom_params=None):
        ...
        cols = columns + [
            'sample_weight'
        ] if self._is_weighted else columns  # 主要携带的weight 但不作为特征
