...
setuptools.setup(
    ...
    install_requires=["boto3==1.26.69", "botocore==1.29.82","scikit-learn==1.2.1","onnx==1.12.0","onnxconverter-common>=1.7.0", "regex",
    "keras2onnx>=1.7.0","tensorflow==2.9.2","tf2onnx","skl2onnx>=1.14.0","onnxruntime>=1.7.0","torch>=1.8.1","pydot==1.3.0","importlib-resources==5.10.0",
