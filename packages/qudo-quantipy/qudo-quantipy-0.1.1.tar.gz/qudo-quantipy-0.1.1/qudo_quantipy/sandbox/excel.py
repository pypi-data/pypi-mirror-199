...
class Excel(Workbook):
    ...
    **formats : ``dict``
    ...
    1. ``sheet_properties``
        ...
        parameter in the ``qudo_quantipy.Excel.add_chains`` method.

        When you have a ``qudo_quantipy.ChainManager`` with many sheets the kwargs
    ...
    def add_chains(self, chains, sheet_name=None, annotations=None, **kwargs):
        ...
        **kwargs : ``dict``
            ...
            sheet.
        """
        warning_message = ('qudo_quantipy.ChainManager has folders, '
