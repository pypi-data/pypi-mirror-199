...
from qudo_quantipy.core.cache import Cache
...
from qudo_quantipy.core.helpers.functions import emulate_meta
from qudo_quantipy.core.tools.view.logic import (has_any, has_all, has_count,
                                                 not_any, not_all, not_count,
                                                 is_lt, is_ne, is_gt,
                                                 is_le, is_eq, is_ge,
                                                 union, intersection, get_logic_index)
from qudo_quantipy.core.helpers.functions import (paint_dataframe,
                                                  emulate_meta,
                                                  get_text,
                                                  finish_text_key)
from qudo_quantipy.core.tools.dp.prep import recode
from qudo_quantipy.core.tools.qp_decorators import lazy_property
...
class ChainManager(object):
    ...
    def insert(self, other_cm, index=-1, safe_names=False):
        ...
        Parameters
        ----------
        other_cm : ``qudo_quantipy.ChainManager``
        ...
        if not isinstance(other_cm, ChainManager):
            raise ValueError("other_cm must be a qudo_quantipy.ChainManager instance.")
        if not index == -1:
    ...
    def from_mtd(self, mtd_doc, ignore=None, paint=True, flatten=False):
        ...
        qudo_quantipy.Chain representations.
        ...
        Returns
        -------
        self : qudo_quantipy.ChainManager
    ...
    def from_cluster(self, clusters):
        ...
        Parameters
        ----------
        clusters : cluster-like ([dict of] qudo_quantipy.Cluster)
            Text ...
        Returns
        -------
        ...
        from qudo_quantipy.core.view_generators.view_specs import ViewManager
    ...
    def add(self, structure, meta_from=None, meta=None, name=None):
        ...
        Returns
        -------
        appended : ``qudo_quantipy.ChainManager``
        """
