...
from qudo_quantipy.core.tools.dp.dimensions.reader import quantipy_from_dimensions
from qudo_quantipy.core.tools.dp.dimensions.writer import dimensions_from_quantipy
from qudo_quantipy.core.tools.dp.decipher.reader import quantipy_from_decipher
from qudo_quantipy.core.tools.dp.confirmit.reader import quantipy_from_confirmit
from qudo_quantipy.core.tools.dp.confirmit.writer import quantipy_to_confirmit
from qudo_quantipy.core.tools.dp.ascribe.reader import quantipy_from_ascribe
...
def verify_dtypes_vs_meta(data, meta):
    ...
    column indicating if qudo_quantipy determines the comparison as viable.

    data - (pandas.DataFrame)
    meta - (dict) qudo_quantipy meta object
    '''
