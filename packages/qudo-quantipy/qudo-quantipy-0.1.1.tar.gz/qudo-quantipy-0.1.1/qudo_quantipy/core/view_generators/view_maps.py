...
import qudo_quantipy.core.tools as tools
import qudo_quantipy as qp

from qudo_quantipy.core.cache import Cache
from qudo_quantipy.core.quantify.engine import Level
...
class QuantipyViews(ViewMapper):
    ...
    def _get_view_names(cache, stack, weights, get='count'):
        ...
        Parameters
        ----------
        cache : qudo_quantipy.core.Cache
        stack : qudo_quantipy.core.Stack
