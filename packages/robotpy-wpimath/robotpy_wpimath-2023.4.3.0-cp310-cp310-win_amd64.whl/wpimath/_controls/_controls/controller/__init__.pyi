...
class LinearPlantInversionFeedforward_1_1():
    ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_1_1_3, arg1: seconds) -> None: ...
    @typing.overload
    def calculate(self, nextR: numpy.ndarray[numpy.float64, _Shape[1, 1]]) -> numpy.ndarray[numpy.float64, _Shape[1, 1]]: 
        """
        Calculate the feedforward with only the desired
...
class LinearPlantInversionFeedforward_2_1():
    ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_1_3, arg1: seconds) -> None: ...
    @typing.overload
    def calculate(self, nextR: numpy.ndarray[numpy.float64, _Shape[2, 1]]) -> numpy.ndarray[numpy.float64, _Shape[1, 1]]: 
        """
        Calculate the feedforward with only the desired
...
class LinearPlantInversionFeedforward_2_2():
    ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_2_3, arg1: seconds) -> None: ...
    @typing.overload
    def calculate(self, nextR: numpy.ndarray[numpy.float64, _Shape[2, 1]]) -> numpy.ndarray[numpy.float64, _Shape[2, 1]]: 
        """
        Calculate the feedforward with only the desired
...
class LinearPlantInversionFeedforward_3_2():
    ...
    """
    @typing.overload
    def R(self) -> numpy.ndarray[numpy.float64, _Shape[3, 1]]: 
        """
        Returns the current reference vector r.
    ...
    def R(self, i: int) -> float: ...
    @typing.overload
    def __init__(self, A: numpy.ndarray[numpy.float64, _Shape[3, 3]], B: numpy.ndarray[numpy.float64, _Shape[3, 2]], dt: seconds) -> None: 
        """
        Constructs a feedforward with the given coefficients.
        ...
        """
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_1, arg1: seconds) -> None: ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_2, arg1: seconds) -> None: ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_3, arg1: seconds) -> None: ...
    @typing.overload
    def calculate(self, nextR: numpy.ndarray[numpy.float64, _Shape[3, 1]]) -> numpy.ndarray[numpy.float64, _Shape[2, 1]]: 
        """
        Calculate the feedforward with only the desired
        future reference. This uses the internally stored "current"
        reference.
        ...
        """
    @typing.overload
    def calculate(self, r: numpy.ndarray[numpy.float64, _Shape[3, 1]], nextR: numpy.ndarray[numpy.float64, _Shape[3, 1]]) -> numpy.ndarray[numpy.float64, _Shape[2, 1]]: ...
    @typing.overload
    def reset(self) -> None: 
        """
        Resets the feedforward with a specified initial state vector.
        ...
        """
    @typing.overload
    def reset(self, initialState: numpy.ndarray[numpy.float64, _Shape[3, 1]]) -> None: ...
    @typing.overload
    def uff(self) -> numpy.ndarray[numpy.float64, _Shape[2, 1]]: 
        """
        Returns the previously calculated feedforward as an input vector.
...
class LinearQuadraticRegulator_1_1():
    ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_1_1_3, arg1: typing.Tuple[float], arg2: typing.Tuple[float], arg3: seconds) -> None: ...
    @typing.overload
...
class LinearQuadraticRegulator_2_1():
    ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_1_3, arg1: typing.Tuple[float, float], arg2: typing.Tuple[float], arg3: seconds) -> None: ...
    @typing.overload
...
class LinearQuadraticRegulator_2_2():
    ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_2_3, arg1: typing.Tuple[float, float], arg2: typing.Tuple[float, float], arg3: seconds) -> None: ...
    @typing.overload
...
class LinearQuadraticRegulator_3_2():
    ...
    """
    @typing.overload
    def K(self) -> numpy.ndarray[numpy.float64, _Shape[2, 3]]: 
        """
        Returns the controller matrix K.
    ...
    def U(self, i: int) -> float: ...
    @typing.overload
    def __init__(self, A: numpy.ndarray[numpy.float64, _Shape[3, 3]], B: numpy.ndarray[numpy.float64, _Shape[3, 2]], Q: numpy.ndarray[numpy.float64, _Shape[3, 3]], R: numpy.ndarray[numpy.float64, _Shape[2, 2]], N: numpy.ndarray[numpy.float64, _Shape[3, 2]], dt: seconds) -> None: 
        """
        Constructs a controller with the given coefficients and plant.
        ...
        """
    @typing.overload
    def __init__(self, A: numpy.ndarray[numpy.float64, _Shape[3, 3]], B: numpy.ndarray[numpy.float64, _Shape[3, 2]], Q: numpy.ndarray[numpy.float64, _Shape[3, 3]], R: numpy.ndarray[numpy.float64, _Shape[2, 2]], dt: seconds) -> None: ...
    @typing.overload
    def __init__(self, A: numpy.ndarray[numpy.float64, _Shape[3, 3]], B: numpy.ndarray[numpy.float64, _Shape[3, 2]], Qelems: typing.Tuple[float, float, float], Relems: typing.Tuple[float, float], dt: seconds) -> None: ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_1, arg1: typing.Tuple[float, float, float], arg2: typing.Tuple[float, float], arg3: seconds) -> None: ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_2, arg1: typing.Tuple[float, float, float], arg2: typing.Tuple[float, float], arg3: seconds) -> None: ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_3, arg1: typing.Tuple[float, float, float], arg2: typing.Tuple[float, float], arg3: seconds) -> None: ...
    @typing.overload
    def calculate(self, x: numpy.ndarray[numpy.float64, _Shape[3, 1]]) -> numpy.ndarray[numpy.float64, _Shape[2, 1]]: 
        """
        Returns the next output of the controller.
        ...
        """
    @typing.overload
    def calculate(self, x: numpy.ndarray[numpy.float64, _Shape[3, 1]], nextR: numpy.ndarray[numpy.float64, _Shape[3, 1]]) -> numpy.ndarray[numpy.float64, _Shape[2, 1]]: ...
    @typing.overload
    def latencyCompensate(self, plant: wpimath._controls._controls.system.LinearSystem_3_2_1, dt: seconds, inputDelay: seconds) -> None: 
        """
        Adjusts LQR controller gain to compensate for a pure time delay in the
        input.
        ...
        """
    @typing.overload
    def latencyCompensate(self, plant: wpimath._controls._controls.system.LinearSystem_3_2_2, dt: seconds, inputDelay: seconds) -> None: ...
    def reset(self) -> None: 
        """
        Resets the controller.
        """
