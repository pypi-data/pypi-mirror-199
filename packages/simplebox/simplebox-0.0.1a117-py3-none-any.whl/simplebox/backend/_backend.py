...
class _Backend(object):
    ...
    def __init__(self, func: Callable, args: Iterable = None, kwargs: Dict = None, log_path: str or Path = None):
        ...
        self.__fifo_file = f"simplebox-backend-fifo-{os.getpid()}-{self.__module_name}-{self.__func_name}-{ObjectsUtils.generate_random_str(6)}"
        ...
        self.__python_statement.append("from") \
            ...
            .append(";") \
            .append(f"{_run_module_name}('{self.__fifo_file}', {self.__func_name})") \
