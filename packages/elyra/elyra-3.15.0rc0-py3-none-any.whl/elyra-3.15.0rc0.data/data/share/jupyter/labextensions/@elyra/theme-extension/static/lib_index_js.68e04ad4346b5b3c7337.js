...
const extension = {
    ...
    activate: (app, translator, labShell, mainMenu, palette) => {
        ...
        commands.addCommand(CommandIDs.openHelp, {
            ...
            execute: (args) => {
                window.open('https://elyra.readthedocs.io/en/v3.15.0rc0/', '_blank');
            }
        });
        commands.addCommand(CommandIDs.releases, {
            label: "What's new in v3.15.0rc0",
            caption: "What's new in this release",
            icon: ui_components_1.whatsNewIcon,
            execute: (args) => {
                window.open('https://github.com/elyra-ai/elyra/releases/v3.15.0rc0/', '_blank');
            }
        });
        model.add({
...
//# sourceMappingURL=lib_index_js.68e04ad4346b5b3c7337.js.map