...
class AccentEquationNode(EquationNode):
    ...
    @overload
    def add_child(self, type : aspose.cells.drawing.equations.EquationNodeType) -> aspose.cells.drawing.equations.EquationNode:
        '''Insert a node of the specified type at the end of the child node list of the current node.
        
        :param type: Types of Equation Nodes
    ...
    def insert_child(self, index : int, type : aspose.cells.drawing.equations.EquationNodeType) -> aspose.cells.drawing.equations.EquationNode:
    ...
    def insert_after(self, type : aspose.cells.drawing.equations.EquationNodeType) -> aspose.cells.drawing.equations.EquationNode:
    ...
    def insert_before(self, type : aspose.cells.drawing.equations.EquationNodeType) -> aspose.cells.drawing.equations.EquationNode:
    ...
    @staticmethod
    def create_node(type : aspose.cells.drawing.equations.EquationNodeTypeworkbook : aspose.cells.Workbook, parent : aspose.cells.drawing.equations.EquationNode) -> aspose.cells.drawing.equations.EquationNode:
    ...
    @property
    def accent_character_type(self) -> aspose.cells.drawing.equations.CombiningCharType:
        ...
    
    @accent_character_type.setter
    def accent_character_type(self, value : aspose.cells.drawing.equations.CombiningCharType):
        ...
...
class BarEquationNode(EquationNode):
    ...
    @property
    def bar_position(self) -> aspose.cells.drawing.equations.PositionType:
        ...
    
    @bar_position.setter
    def bar_position(self, value : aspose.cells.drawing.equations.PositionType):
        ...
...
class ComponentNode(EquationNode):
...
class DelimiterEquationNode(EquationNode):
    ...
    @property
    def delimiter_shape(self) -> aspose.cells.drawing.equations.DelimiterShapeType:
        ...
    
    @delimiter_shape.setter
    def delimiter_shape(self, value : aspose.cells.drawing.equations.DelimiterShapeType):
        ...
...
class EquationNodeParagraph(EquationNode):
    ...
    @property
    def justification(self) -> aspose.cells.drawing.equations.JustificationType:
    ...
    def justification(self, value : aspose.cells.drawing.equations.JustificationType):
        '''This specifies justification of the math paragraph (a series of adjacent equations within the same paragraph). A math paragraph can be Left Justified, Right Justified, Centered, or Centered as Group. By default, the math paragraph is Centered as Group. This means that the equations can be aligned with respect to each other, but the entire group of equations is centered as a whole.'''
        ...
...
class FractionEquationNode(EquationNode):
    ...
    @property
    def fraction_type(self) -> aspose.cells.drawing.equations.FractionType:
        ...
    
    @fraction_type.setter
    def fraction_type(self, value : aspose.cells.drawing.equations.FractionType):
        ...
...
class GroupChrEquationNode(EquationNode):
    ...
    @property
    def chr_type(self) -> aspose.cells.drawing.equations.CombiningCharType:
        ...
    
    @chr_type.setter
    def chr_type(self, value : aspose.cells.drawing.equations.CombiningCharType):
        ...
    
    @property
    def position(self) -> aspose.cells.drawing.equations.PositionType:
        '''This attribute specifies the position of the character in the object'''
        ...
    
    @position.setter
    def position(self, value : aspose.cells.drawing.equations.PositionType):
        '''This attribute specifies the position of the character in the object'''
        ...
    
    @property
    def vert_jc(self) -> aspose.cells.drawing.equations.PositionType:
        ...
    
    @vert_jc.setter
    def vert_jc(self, value : aspose.cells.drawing.equations.PositionType):
        ...
    
    ...

class MathEquationNode(EquationNode):
...
class NaryEquationNode(EquationNode):
    ...
    @property
    def limit_location(self) -> aspose.cells.drawing.equations.LimitLocationType:
        ...
    
    @limit_location.setter
    def limit_location(self, value : aspose.cells.drawing.equations.LimitLocationType):
        ...
    ...
    @property
    def nary_operator_type(self) -> aspose.cells.drawing.equations.MathOptType:
        ...
    
    @nary_operator_type.setter
    def nary_operator_type(self, value : aspose.cells.drawing.equations.MathOptType):
        ...
...
class TextRun(EquationNode):
    '''The bottom node class in the equation node is used to store the actual content(a sequence of mathematical text) of the equation.
...
class CombiningCharType:
    '''Type of combining characters.'''
    
    @classmethod
    @property
    def UNKNOWN(cls) -> CombiningCharType:
        '''Use unknown type when not found in existing type.'''
        ...
    
    @classmethod
    @property
    def DOT_ABOVE(cls) -> CombiningCharType:
        '''"̇" Unicode: u0307
        Combining Dot Above'''
        ...
    ...
    @classmethod
    @property
    def DIAERESIS(cls) -> CombiningCharType:
        '''"̈" Unicode: u0308
        Combining Diaeresis'''
        ...
    ...
    @classmethod
    @property
    def THREE_DOTS_ABOVE(cls) -> CombiningCharType:
        '''"⃛" Unicode: u20db
    ...
    @classmethod
    @property
    def CIRCUMFLEX_ACCENT(cls) -> CombiningCharType:
        '''"̂" Unicode: u0302
    ...
    @classmethod
    @property
    def CARON(cls) -> CombiningCharType:
        '''"̌" Unicode: u030c
        Combining Caron'''
        ...
    ...
    @classmethod
    @property
    def ACUTE_ACCENT(cls) -> CombiningCharType:
        '''"́" Unicode: u0301
    ...
    @classmethod
    @property
    def GRAVE_ACCENT(cls) -> CombiningCharType:
        '''"̀" Unicode: u0300
    ...
    @classmethod
    @property
    def BREVE(cls) -> CombiningCharType:
        '''"̆" Unicode: u0306
    ...
    @classmethod
    @property
    def TILDE(cls) -> CombiningCharType:
        '''"̃" Unicode: u0303
        Combining Tilde'''
        ...
    ...
    @classmethod
    @property
    def OVERLINE(cls) -> CombiningCharType:
        '''"̅" Unicode: u0305
        Combining Overline'''
        ...
    ...
    @classmethod
    @property
    def DOUBLE_OVERLINE(cls) -> CombiningCharType:
        '''"̿" Unicode: u033f
    ...
    @classmethod
    @property
    def TOP_CURLY_BRACKET(cls) -> CombiningCharType:
        '''"⏞" Unicode: u23de
    ...
    @classmethod
    @property
    def BOTTOM_CURLY_BRACKET(cls) -> CombiningCharType:
        '''"⏟" Unicode: u23df
    ...
    @classmethod
    @property
    def LEFT_ARROW_ABOVE(cls) -> CombiningCharType:
        '''"⃖" Unicode: u20d6
    ...
    @classmethod
    @property
    def RIGHT_ARROW_ABOVE(cls) -> CombiningCharType:
        '''"⃗" Unicode: u20d7
    ...
    @classmethod
    @property
    def LEFT_RIGHT_ARROW_ABOVE(cls) -> CombiningCharType:
        '''"⃡" Unicode: u20e1
    ...
    @classmethod
    @property
    def LEFT_HARPOON_ABOVE(cls) -> CombiningCharType:
        '''"⃐" Unicode: u20d0
    ...
    @classmethod
    @property
    def RIGHT_HARPOON_ABOVE(cls) -> CombiningCharType:
        '''"⃑" Unicode: u20d1
    ...
    @classmethod
    @property
    def LEFTWARDS_ARROW(cls) -> CombiningCharType:
        '''"←" Unicode: u2190
        Leftwards Arrow'''
        ...
    ...
    @classmethod
    @property
    def RIGHTWARDS_ARROW(cls) -> CombiningCharType:
        '''"→" Unicode: u2192
        Rightwards Arrow'''
        ...
    ...
    @classmethod
    @property
    def LEFT_RIGHT_ARROW(cls) -> CombiningCharType:
        '''"↔" Unicode: u2194
        Left Right Arrow'''
        ...
    ...
    @classmethod
    @property
    def LEFTWARDS_DOUBLE_ARROW(cls) -> CombiningCharType:
        '''"⇐" Unicode: u21d0
    ...
    @classmethod
    @property
    def RIGHTWARDS_DOUBLE_ARROW(cls) -> CombiningCharType:
        '''"⇒" Unicode: u21d2
    ...
    @classmethod
    @property
    def LEFT_RIGHT_DOUBLE_ARROW(cls) -> CombiningCharType:
        '''"⇔" Unicode: u21d4
...
class EquationNodeType:
    ...
    @classmethod
    @property
    def MATH_EQUATION(cls) -> EquationNodeType:
    ...
    @classmethod
    @property
    def GROUP_CHR_EQUATION(cls) -> EquationNodeType:
...
class JustificationType:
    '''This specifies the alignment.'''
    
    @classmethod
    @property
    def CENTER(cls) -> JustificationType:
        '''Centered'''
        ...
    
    @classmethod
    @property
    def CENTER_GROUP(cls) -> JustificationType:
        '''Centered as Group'''
        ...
    
    @classmethod
    @property
    def LEFT(cls) -> JustificationType:
        '''Left Justified'''
        ...
    
    @classmethod
    @property
    def RIGHT(cls) -> JustificationType:
        '''Right Justified'''
        ...
...
class LimitLocationType:
    ...
    @classmethod
    @property
    def UND_OVR(cls) -> LimitLocationType:
        '''Specifies that the limit is centered above or below the operator.'''
        ...
    
    @classmethod
    @property
    def SUB_SUP(cls) -> LimitLocationType:
...
class MathOptType:
    ...
    @classmethod
    @property
    def UNKNOWN(cls) -> MathOptType:
        '''Use unknown type when not found in existing type.'''
        ...
    
    @classmethod
    @property
    def FOR_ALL(cls) -> MathOptType:
        '''"∀" Unicode:\u2200'''
        ...
    
    @classmethod
    @property
    def COMPLEMENT(cls) -> MathOptType:
        '''"∁" Unicode:\u2201'''
        ...
    
    @classmethod
    @property
    def PARTIAL_DIFFERENTIAL(cls) -> MathOptType:
        '''"∂" Unicode:\u2202'''
        ...
    
    @classmethod
    @property
    def EXISTS(cls) -> MathOptType:
        '''"∃" Unicode:\u2203'''
        ...
    
    @classmethod
    @property
    def NOT_EXISTS(cls) -> MathOptType:
        '''"∄" Unicode:\u2204'''
        ...
    
    @classmethod
    @property
    def EMPTY_SET(cls) -> MathOptType:
        '''"∅" Unicode:\u2205'''
        ...
    
    @classmethod
    @property
    def INCREMENT(cls) -> MathOptType:
        '''"∆" Unicode:\u2206'''
        ...
    
    @classmethod
    @property
    def NABLA(cls) -> MathOptType:
        '''"∇" Unicode:\u2207'''
        ...
    
    @classmethod
    @property
    def ELEMENT_OF(cls) -> MathOptType:
        '''"∈" Unicode:\u2208'''
        ...
    
    @classmethod
    @property
    def NOT_AN_ELEMENT_OF(cls) -> MathOptType:
        '''"∉" Unicode:\u2209'''
        ...
    
    @classmethod
    @property
    def SMALL_ELEMENT_OF(cls) -> MathOptType:
        '''"∊" Unicode:\u220a'''
        ...
    
    @classmethod
    @property
    def CONTAIN(cls) -> MathOptType:
        '''"∋" Unicode:\u220b'''
        ...
    
    @classmethod
    @property
    def NOT_CONTAIN(cls) -> MathOptType:
        '''"∌" Unicode:\u220c'''
        ...
    
    @classmethod
    @property
    def SMALL_CONTAIN(cls) -> MathOptType:
        '''"∍" Unicode:\u220d'''
        ...
    
    @classmethod
    @property
    def END_OF_PROOF(cls) -> MathOptType:
        '''"∎" Unicode:\u220e'''
        ...
    
    @classmethod
    @property
    def NARY_PRODUCT(cls) -> MathOptType:
        '''"∏" Unicode:\u220f'''
        ...
    
    @classmethod
    @property
    def NARY_COPRODUCT(cls) -> MathOptType:
        '''"∐" Unicode:\u2210'''
        ...
    
    @classmethod
    @property
    def NARY_SUMMATION(cls) -> MathOptType:
        '''"∑" Unicode:\u2211'''
        ...
    
    @classmethod
    @property
    def LOGICAL_AND(cls) -> MathOptType:
        '''"∧" Unicode:\u2227'''
        ...
    
    @classmethod
    @property
    def LOGICAL_OR(cls) -> MathOptType:
        '''"∨" Unicode:\u2228'''
        ...
    
    @classmethod
    @property
    def INTERSECTION(cls) -> MathOptType:
        '''"∩" Unicode:\u2229'''
        ...
    
    @classmethod
    @property
    def UNION(cls) -> MathOptType:
        '''"∪" Unicode:\u222a'''
        ...
    
    @classmethod
    @property
    def INTEGRAL(cls) -> MathOptType:
        '''"∫" Unicode:\u222b'''
        ...
    
    @classmethod
    @property
    def DOUBLE_INTEGRAL(cls) -> MathOptType:
        '''"∬" Unicode:\u222c'''
        ...
    
    @classmethod
    @property
    def TRIPLE_INTEGRAL(cls) -> MathOptType:
        '''"∭" Unicode:\u222d'''
        ...
    
    @classmethod
    @property
    def CONTOUR_INTEGRAL(cls) -> MathOptType:
        '''"∮" Unicode:\u222e'''
        ...
    
    @classmethod
    @property
    def SURFACE_INTEGRAL(cls) -> MathOptType:
        '''"∯" Unicode:\u222f'''
        ...
    
    @classmethod
    @property
    def VOLUME_INTEGRAL(cls) -> MathOptType:
        '''"∰" Unicode:\u2230'''
        ...
    
    @classmethod
    @property
    def CLOCKWISE(cls) -> MathOptType:
        '''"∱" Unicode:\u2231'''
        ...
    
    @classmethod
    @property
    def CLOCKWISE_CONTOUR_INTEGRAL(cls) -> MathOptType:
        '''"∲" Unicode:\u2232'''
        ...
    
    @classmethod
    @property
    def ANTICLOCKWISE_CONTOUR_INTEGRAL(cls) -> MathOptType:
        '''"∳" Unicode:\u2233'''
        ...
    
    @classmethod
    @property
    def NARY_LOGICAL_AND(cls) -> MathOptType:
        '''"⋀" Unicode:\u22c0'''
        ...
    
    @classmethod
    @property
    def NARY_LOGICAL_OR(cls) -> MathOptType:
        '''"⋁" Unicode:\u22c1'''
        ...
    
    @classmethod
    @property
    def NARY_INTERSECTION(cls) -> MathOptType:
        '''"⋂" Unicode:\u22c2'''
        ...
    
    @classmethod
    @property
    def NARY_UNION(cls) -> MathOptType:
        '''"⋃" Unicode:\u22c3'''
        ...
...
class PositionType:
    ...
    @classmethod
    @property
    def TOP(cls) -> PositionType:
        '''At the top of the parent object'''
        ...
    
    @classmethod
    @property
    def BOTTOM(cls) -> PositionType:
