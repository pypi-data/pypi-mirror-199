...
def aaaapp(multiMedia, url, cursor, page):
    ...
    if len(res.content) > 0:
        ...
        if data["code"] == 200:
            ...
            print("=== error aaaapp, eixt now!")
            logging.info("=== error aaaapp, eixt now!")
            exit(-1)
    else:
        print("=== error aaaapp, eixt now!")
        logging.info("=== error aaaapp, eixt now!")
...
def main():    
    ...
    while(os.path.exists(os.path.join(thisFileDir, "stop.now")) == False):
        try:
            ...
            # print(f"=== begin {curGroupId}")
            # link_url_list = [
            #     "https://www.instagram.com/digi_doveri/;" ,
            #     "https://www.instagram.com/imaginativecharacter/;",
            #     " https://www.instagram.com/ai__pixelart/;" ,
            #     "https://www.instagram.com/5me95ai/;",
            #     "https://www.instagram.com/eldwarfvader/;" ,
            #     "https://www.instagram.com/werners_ai_art/"
            # ]
            # multiMedia = True
            # for s in link_url_list:
            #     right_s = s.replace("\n", "").replace(";", "").replace(",", "").strip()
