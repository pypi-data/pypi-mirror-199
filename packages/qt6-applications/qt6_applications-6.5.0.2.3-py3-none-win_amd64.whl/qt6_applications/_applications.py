...
application_paths = {
    ...
    'androiddeployqt6': 'androiddeployqt6.exe',
    'androidtestrunner': 'androidtestrunner.exe',
    'assistant': 'assistant.exe',
    'cmake_automoc_parser': 'cmake_automoc_parser.exe',
    ...
    'qtdiag6': 'qtdiag6.exe',
    'qtpaths': 'qtpaths.exe',
    'qtpaths6': 'qtpaths6.exe',
    'qtplugininfo': 'qtplugininfo.exe',
    'qvkgen': 'qvkgen.exe',
    'rcc': 'rcc.exe',
    'syncqt': 'syncqt.exe',
    'tracegen': 'tracegen.exe',
    'tracepointgen': 'tracepointgen.exe',
    'uic': 'uic.exe',
    'windeployqt': 'windeployqt.exe',
    'windeployqt6': 'windeployqt6.exe',
}
