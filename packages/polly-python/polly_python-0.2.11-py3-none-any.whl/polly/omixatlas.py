...
class OmixAtlas:
    ...
    def download_data(self, repo_name, _id: str, internal_call=False):
        ...
        if not internal_call:
            ...
            warnings.warn(
                "This method will soon be deprecated. Please use new function download_datasets for downloading"
    ...
    def get_metadata(
        ...
        self.download_data(repo_key, dataset_id, internal_call=True)
