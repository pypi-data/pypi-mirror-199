from usbmonitor.constants import ID_MODEL_ID, ID_VENDOR, ID_MODEL, ID_VENDOR_FROM_DATABASE, ID_MODEL_FROM_DATABASE, \
...
DEVICE_ATTRIBUTES = tuple(_LINUX_TO_WINDOWS_ATTRIBUTES.keys())