...
from usbmonitor._usb_detector_base import _USBDetectorBase
from usbmonitor.constants import ID_MODEL_ID, ID_VENDOR, DEVTYPE
from usbmonitor._constants import _DEVICE_ID, _PNP_DEVICE_ID, _LINUX_TO_WINDOWS_ATTRIBUTES, _SECONDS_BETWEEN_CHECKS
