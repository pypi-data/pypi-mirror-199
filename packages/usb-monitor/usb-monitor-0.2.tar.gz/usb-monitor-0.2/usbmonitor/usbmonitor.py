...
from usbmonitor._platform_specific_detectors._linux_usb_detector import _LinuxUSBDetector
from usbmonitor._platform_specific_detectors._windows_usb_detector import _WindowsUSBDetector
