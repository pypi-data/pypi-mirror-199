...
def helpInfo_run(parser):
    ...
    parser.add_argument(
        '--cDNAfastq1', 
        metavar='FASTQ',
        help='Path to the raw R1 fastq files of cDNA library.', 
        required=True
        )
    parser.add_argument(
        '--cDNAfastq2', 
        metavar='FASTQ',
        help='Path to the raw R2 fastq files of cDNA library.', 
        required=True
        )
    parser.add_argument(
        '--oligofastq1', 
        metavar='FASTQ',
        help='Path to the raw R1 fastq files of oligo library.',
        required=True
        )
    parser.add_argument(
        '--oligofastq2', 
        metavar='FASTQ',
        help='Path to the raw R2 fastq files of oligo library.',
        required=True
        )
    parser.add_argument(
        '--genomeDir',
    ...
    parser.add_argument(
        '--no_introns', 
        action='store_true',
        help='Intron reads is not included in the expression matrix.'
        )
    return parser