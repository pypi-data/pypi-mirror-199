...
def write_param_to_template(htmlTemplate,samplename,path,intron,species):
    ...
    report=html.safe_substitute(sample_info=samplename, samplename=stat['samplename'],\
            species=stat['species'], median_UMI_per_c=stat['median_UMI_per_c'],\
            estm_Num_cell=stat['estm_Num_cell'],sample_id=stat['estm_Num_cell'],\
            total_gene=stat['total_gene'], saturation=stat['saturation'],\
            cDNA_num_frag=stat['cDNA_num_frag'],intron_boolean=stat['intron_boolean'],\
            cDNA_frag_pass_QC=stat['cDNA_frag_pass_QC_ratio'],cDNA_frag_exact_bar=stat['cDNA_frag_exact_bar'],\
            cDNA_frag_fail_bar=stat['cDNA_frag_fail_bar'],cDNA_frag_low_qual=stat['cDNA_frag_low_qual'],\
            cDNA_Q30_c_bar=stat['cDNA_Q30_c_bar'],cDNA_Q30_s_bar=stat['cDNA_Q30_s_bar'],\
            cDNA_Q30_UMI=stat['cDNA_Q30_UMI'],cDNA_Q30_r=stat['cDNA_Q30_r'],\
            index_num_frag=stat['index_num_frag'],Fraction=stat['Fraction'],\
            index_frag_pass_QC=stat['index_frag_pass_QC_ratio'],index_frag_exact_bar=stat['index_frag_exact_bar'],\
            index_frag_fail_bar=stat['index_frag_fail_bar'],index_frag_low_qual=stat['index_frag_low_qual'],\
            index_Q30_c_bar=stat['index_Q30_c_bar'],index_Q30_s_bar=stat['index_Q30_s_bar'],\
            index_Q30_UMI=stat['index_Q30_UMI'],index_Q30_r=stat['index_Q30_r'],\
            raw_r=stat['cDNA_frag_pass_QC'],map_r=stat['raw_r'],plus_strd=stat['plus_strd'],\
            minus_strd=stat['minus_strd'],mito_ratio = stat['mito_ratio'],\
            ...
            plot6=plot_dict['plot6'],plot7=plot_dict['plot7'],plot8= plot8_content,\
            r_m_ex=stat['r_m_ex'],r_m_intro=stat['r_m_intro'],pipeversion = stat['version'],\
            r_m_ex_intro=stat['r_m_ex_intro'],r_m_anti=stat['r_m_anti'],\
            r_m_inter=stat['r_m_inter'],r_m_gene_fail=stat['r_m_gene_fail'],ID=samplename,\
            mean_r_per_c=stat['mean_r_per_c'],mean_UMI_per_c=stat['mean_UMI_per_c'],\
            mean_genes_per_c=stat['mean_genes_per_c'],median_genes_per_c=stat['median_genes_per_c'])
