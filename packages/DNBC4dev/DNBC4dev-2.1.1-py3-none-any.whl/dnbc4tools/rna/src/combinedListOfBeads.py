...
def similarity_droplet_file(SIMI_DROPLET_FNAME,BEADS_LIST_FNAME,COMB_LIST_FNAME,simi_thres=0.2,max_merge_thres=1,COUNT_MTX_FNAME=None,BEADS_BARCODE_FNAME=None):
