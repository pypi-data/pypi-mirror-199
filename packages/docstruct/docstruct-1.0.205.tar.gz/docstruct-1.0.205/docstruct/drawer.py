...
from .text_block import TextBlock, Character, Line, Page, Paragraph, Word, Table, Cell
...
class Drawer:
    ...
    def _draw_text_block_text(self, word: Word):
        """
    ...
    def draw_text_block_text(self, block: TextBlock):
        """
        Draws the text of the block on the image.
        """
        for word in block.get_all(Line):
            self._draw_text_block_text(word)
    ...
    def draw_cell_index(self, cell: Cell):
        """
        Draws the index of the block on the right top corner of the block.
        """
