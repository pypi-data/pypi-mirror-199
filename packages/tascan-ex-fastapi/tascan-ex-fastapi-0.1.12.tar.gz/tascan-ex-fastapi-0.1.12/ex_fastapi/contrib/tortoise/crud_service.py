...
from ex_fastapi.routers.base_crud_service import BaseCRUDService, ModelPrefix, PK, \
    CreateHandler, EditHandler, QsRelatedFunc, QsAnnotateFunc, QsDefaultFiltersFunc, FKGetInstance
...
class TortoiseCRUDService(BaseCRUDService[PK, TORTOISE_MODEL]):
    ...
    def __init__(
            ...
            *,
            ...
            create_handlers: dict[str, CreateHandler[TORTOISE_MODEL]] = None,
            edit_handlers: dict[str, EditHandler[TORTOISE_MODEL]] = None,
    ...
    async def create(
        ...
        async def get_new_instance():
            ...
            if errors:
                raise errors
            try:
                instance: TORTOISE_MODEL = await self.handle_create(prefix, model=model)(
                    data=data, should_exclude={*exclude_dict['__root__'], *fk_fields},
    ...
    async def edit(
        ...
        async def get_changed_instance() -> TORTOISE_MODEL:
            ...
            await self.handle_edit(prefix, model=model)(
                ...
                should_exclude={*exclude_dict['__root__'], *fk_fields},
    ...
    def handle_create(self, prefix: ModelPrefix, model: Type[TORTOISE_MODEL]) -> CreateHandler[TORTOISE_MODEL]:
    ...
    def handle_edit(self, prefix: ModelPrefix, model: Type[TORTOISE_MODEL]) -> EditHandler[TORTOISE_MODEL]:
