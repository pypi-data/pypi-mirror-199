...
from pyPrairieView.bruker_meta_objects import BrukerElementFactory
from pyPrairieView.mark_points import PhotostimulationMeta
from pyPrairieView.configuration_values import DEFAULT_PRAIRIEVIEW_VERSION


"""
Library of functions that extract useful information from PrarieView XML files
"""
...
def read_mark_points_xml(path: str, version: str = DEFAULT_PRAIRIEVIEW_VERSION) -> PhotostimulationMeta:
    """
...
if __name__ == "__main__":
    path = "C:\\Users\\YUSTE\\PycharmProjects\\pyPrairieView\\scratchpad\\1000ms_50spirals_meta\\EM0275_03_13_23-002_Cycle00001_MarkPoints.xml"
