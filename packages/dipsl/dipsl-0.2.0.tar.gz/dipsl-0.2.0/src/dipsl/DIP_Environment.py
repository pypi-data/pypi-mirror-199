...
class Environment(BaseModel):
    ...
    nodes: List    = []   # nodes
    units: Dict    = {}   # custom units
    sources: Dict  = {}   # custom reference sources
    functions: Dict = {}  # custom native functions
    ...
    def add_unit(self, name:str, unit:Unit, num:float, expr:str):
        """ Add a new source
        ...
        self.units[name] = EnvUnit(unit=unit, num=num, expr=expr)
