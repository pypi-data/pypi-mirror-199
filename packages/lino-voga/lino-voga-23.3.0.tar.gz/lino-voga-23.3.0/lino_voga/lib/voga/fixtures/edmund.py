...
class Loader1(object):
    ...
    def objects(self):
        ...
        course_fees = Category(**dd.str2kw('name', _("Participation fees")))
        yield course_fees

        trips = Category(**dd.str2kw('name', _("Trips")))
        ...
        product = Instantiator(
            'products.Product', "sales_price category name").build
        ...
        self.PRICES = Cycler(Product.objects.filter(category=course_fees))
