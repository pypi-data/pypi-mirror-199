...
VERSION = "0.0.1.dev17"
install_requires = ['Flask==2.2.2', 'Flask-WTF~=1.0.0', 'Jinja2==3.1.2', 'MarkupSafe~=2.1.1', 'croniter==1.3.5', 'redis==4.3.4', 'pottery', 'PyYAML~=6.0', 'WTForms~=3.0.1', 'Werkzeug==2.2.2', 'setuptools==65.2.0', 'Flask-Caching']
