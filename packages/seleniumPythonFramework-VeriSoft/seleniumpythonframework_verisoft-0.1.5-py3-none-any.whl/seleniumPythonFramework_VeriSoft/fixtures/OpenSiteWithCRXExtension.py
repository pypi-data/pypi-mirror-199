...
from seleniumPythonFramework_VeriSoft.utils.enum.Wallets import Wallet
...
def before_test(request):
    ...
    if pytest.data_driven.get("wallet_type") == Wallet.metamask:
        chrome_options.add_extension(pytest.user_dir + pytest.properties.get("metamask.extension.crx"))
    elif pytest.data_driven.get("wallet_type") == Wallet.coinbase:
