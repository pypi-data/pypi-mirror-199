...
class Selectel_api():
    ...
    @make_request
    def domain_delete(self, domain_id: str) -> Tuple[str, int, str]:
        '''
        Удалить домен
        '''
        pass
    ...
    @make_request
    def domain_get_by_id(self, domain_id: str) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def domain_update(self, domain_id: str, tags) -> Tuple[str, int, str]:
        '''
        Обновить домен
        '''
        pass
    ...
    @make_request
    def domain_export(self, domain_id: str) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def records_list_by_domain_id(self, domain_id: str, limit: int = 1000, offset: int = 0) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def records_create(self, domain_id: str, content: str, email: str, name: str, port: int, priority: int, target: str, ttl: int, type: str, weight: int) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def records_delete(self, domain_id: str, record_id: str) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def records_get(self, domain_id: str, record_id: str) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def records_update(self, domain_id: str, content: str, email: str, name: str, port: int, priority: int, target: str, ttl: int, type: str, weight: int) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def ptr_delete(self, ptr_id: str) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def ptr_get(self, ptr_id: str) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def ptr_update(self, ptr_id: str, content: str, ip: str) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def tags_delete(self, tag_id: str) -> Tuple[str, int, str]:
        '''
        Удалить тэг
        '''
        pass
    ...
    @make_request
    def tags_get(self, tag_id: str) -> Tuple[str, int, str]:
        '''
    ...
    @make_request
    def tags_update(self, tag_id: str, name: str, domains) -> Tuple[str, int, str]:
        '''
        Обновить тэг
        '''
        pass
