...
@overload
def before_all(fn: None = None, /, environment: Environments = None) -> Callable[[HookFn], Hook]:
    ...


def before_all(
    fn: Optional[HookFn] = None, /, environment: Environments = None
...
@overload
def after_all(fn: HookFn, /, environment: Environments = None) -> Hook:
    ...


@overload
def after_all(fn: None = None, /, environment: Environments = None) -> Callable[[HookFn], Hook]:
    ...
