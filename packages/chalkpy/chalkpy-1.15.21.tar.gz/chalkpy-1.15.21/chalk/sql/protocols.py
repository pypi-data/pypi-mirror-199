...
class BaseSQLSourceProtocol(Protocol):
    ...
    def get_engine(self, additional_engine_args: Optional[Dict[str, Any]] = None) -> sqlalchemy.engine.Engine:
        """Get an SQLAlchemy Engine. The engine will be created and cached on the first call of this method.

        Parameters
        ----------
        additional_engine_args
            Optional additional engine arguments, merged with the default arguments.
