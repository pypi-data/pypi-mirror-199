...
{':python_version < "3.8"': ['backports.cached-property>=1.0.2,<2.0.0'],
 ...
 'asgi': ['starlette>=0.18.0', 'python-multipart>=0.0.5,<0.0.7'],
 ...
 'debug-server': ['starlette>=0.18.0',
                  'click>=7.0,<9.0',
                  'pygments>=2.3,<3.0',
                  'uvicorn>=0.11.6,<0.22.0',
                  'python-multipart>=0.0.5,<0.0.7',
                  'libcst>=0.4.7',
                  'rich>=12.0.0'],
 'django': ['Django>=3.2', 'asgiref>=3.2,<4.0'],
 'fastapi': ['python-multipart>=0.0.5,<0.0.7', 'fastapi>=0.65.2'],
 'flask': ['flask>=1.1'],
 'opentelemetry': ['opentelemetry-api<2', 'opentelemetry-sdk<2'],
 'pydantic': ['pydantic<2'],
 'sanic': ['sanic>=20.12.2'],
 'starlite:python_version >= "3.8"': ['starlite>=1.48.0']}
