...
def new_session(model_name: str = "u2net") -> BaseSession:
    ...
    url = "https://github.com\
        /pchchv/iremover/releases/download/v0.0.0/u2net.onnx"
    ...
    if model_name == "u2netp":
        ...
        url = (
            "https://github.com\
                /pchchv/iremover/releases/download/v0.0.0/u2netp.onnx"
        )
        session_class = SimpleSession
    elif model_name == "u2net_human_seg":
        md5 = "c09ddc2e0104f800e3e1bb4652583d1f"
        url = "https://github.com\
            /pchchv/iremover/releases/download/v0.0.0/u2net_human_seg.onnx"
        session_class = SimpleSession
    elif model_name == "u2net_cloth_seg":
        md5 = "2434d1f3cb744e0e49386c906e5a08bb"
        url = "https://github.com\
            /pchchv/iremover/releases/download/v0.0.0/u2net_cloth_seg.onnx"
        session_class = ClothSession
    elif model_name == "silueta":
        md5 = "55e59e0d8062d2f5d013f4725ee84782"
        url = (
            "https://github.com\
                /pchchv/iremover/releases/download/v0.0.0/silueta.onnx"
        )
        session_class = SimpleSession
