...
class cloud_vertices(Element_To_Draw):
    ...
    def __init__(self, fname: str = '', fromxls: str = '', header: bool = False, toload=True, idx='', plotted=False, parentgui=None) -> None:
    ...
    def import_from_dxf(self,fn=''):
        ...
        try :
            wx.LogMessage(_('Number of imported points : ')+str(k))    
        except:
            pass        
