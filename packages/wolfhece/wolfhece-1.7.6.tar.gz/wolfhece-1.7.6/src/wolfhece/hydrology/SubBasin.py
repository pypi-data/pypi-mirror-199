...
class SubBasin:
    ...
    def get_flood(self, path='', check_coherence=False):
        ...
        paramFile = Wolf_Param(to_read=False,toShow=False, initwx=False)
    ...
    def compute_runnoff_Ct_coeffs(self, method=-1):
        ...
        wolf_If = Wolf_Param(to_read=False,toShow=False, initwx=False)
    ...
    # ## This function is reading the string of the landuse in the avrg_charact file
    # def read_landuse(self, filename:str="", onlySub:bool=True) -> list:
    #     # Determine the filename according to expectencies
    #     if filename=="":
    #         if onlySub:
    #             fileExtn = "simul_subbasin.avrg_caractSubBasin"
    #         else:
    #             fileExtn = "simul_subbasin.avrg_caractWholeHydroSubBasin"

    #         filename = os.path.join(self.fileNameRead, fileExtn)
