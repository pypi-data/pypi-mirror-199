...
class Dike(Triangulation,Zones):
    ...
    def __init__(self, trace:vector, width:float, slopeup:float, slopedown:float, fn='', idx='', plotted=True, parentgui=None, pts=[], tri=[]) -> None:
        
        Triangulation.__init__(self,fn, idx, plotted, parentgui, pts, tri)
        Zones.__init__(self)
