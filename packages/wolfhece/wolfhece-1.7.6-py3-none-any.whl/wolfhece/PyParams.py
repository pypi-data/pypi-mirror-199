...
class Wolf_Param(wx.Frame):
    ...
    #Initialisation
    def __init__(self, parent=None, title="Default Title", w=500,h=800,ontop=False,to_read=True,filename='',withbuttons=True,DestroyAtClosing=True, toShow=True, initwx=True):
        ...
        if (initwx):
            ...
            if to_read:
                ...
                wx.LogWarning("No usage specified in WolfParam init : check what you want to do!")
    ...
    def ReadFile(self,*args):
        ...
        if os.path.isfile(self.filename):
            ...
            print("ERROR : cannot find the following file :")
            print(self.filename)
