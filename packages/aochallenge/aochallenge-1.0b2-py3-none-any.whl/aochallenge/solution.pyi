...
class Solution:
    ...
    def load(self, splitlines: bool = ..., splitrecords: Union[str, None] = ..., recordtype: Union[list, tuple, type, None] = ..., *, lut: Union[dict[Union[str, None], Any], None] = ...) -> list[Union[str, int, list]]: ...
