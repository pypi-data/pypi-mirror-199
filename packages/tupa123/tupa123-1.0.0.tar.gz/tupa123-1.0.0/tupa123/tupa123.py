...
def Statistics(Calculated, Targeted):
    ...
    for j in range(0,numevar):
        ...
        print('')
        print ('Mean difference, variable ' + str(j+1) +' = ' + str(np.mean(erroari)) + ' ')
        print('')
        print ('Standard deviation, variable ' + str(j+1) +' = ' + str(np.std(erroari)) + '')
        print('------------------------')
...
#Plot two variables comparatively in a sequential series
...
class nnet4:
    ...
    #global variables-------------------------------------------------------------------------
    def __init__ (self, norma=2, coef=0, nn1c=1, nn2c=5, nn3c=5, nn4c=1, rate=0.01, epochs=1000, fa2c=5, fa3c=5, fa4c=0):
    ...
    def Normalize(self, data, maxiname, mininame):         
    ...
    def Normalize2(self, data, maxiname, mininame):         
    ...
    def DesNormalize(self, normalized, maxiname, mininame):         
    ...
    def Fit_ADAM(self, matX, matY):
        ...
        matX = self.Normalize(matX,"vmax_in.txt","vmin_in.txt")        
        matY = self.Normalize(matY,"vmax_out.txt","vmin_out.txt")
        ...
        monit=0
        for ite in range(0,self.epochs):
            Tempo = ite+1
            ...
            for caso in range (0, NumdataEstudo):
    ...
    def Predict(self, matX):
        ...
        matX = self.Normalize2(matX,"vmax_in.txt","vmin_in.txt")
        ...
        Calculated = self.DesNormalize(Calculated, "vmax_out.txt", "vmin_out.txt")
