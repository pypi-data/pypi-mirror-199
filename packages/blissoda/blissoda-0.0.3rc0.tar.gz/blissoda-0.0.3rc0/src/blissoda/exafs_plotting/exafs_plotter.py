...
class ExafsPlotter(
    ...
    def __init__(self) -> None:
        ...
        # Configurable parameters (stored in Redis)
        self._set_parameter_default("refresh_period", 2)  # seconds
        self._set_parameter_default("max_scans", 3)
        self._set_parameter_default("enabled", True)
        self._set_parameter_default("_counters", dict())
        self._set_parameter_default("_color_index", 0)
