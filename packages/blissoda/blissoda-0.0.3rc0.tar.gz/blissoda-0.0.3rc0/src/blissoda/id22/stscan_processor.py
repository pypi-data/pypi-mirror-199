...
class StScanProcessor(
    ...
    def __init__(
        self,
        convert_workflow="/data/id22/inhouse/ewoks/convert.json",
        rebinsum_workflow="/data/id22/inhouse/ewoks/rebinsum.json",
        extract_workflow="/data/id22/inhouse/ewoks/extract.json",
    ) -> None:
        super().__init__()
        self._set_parameter_default("_convert_workflow", convert_workflow)
        self._set_parameter_default("_rebinsum_workflow", rebinsum_workflow)
        self._set_parameter_default("_extract_workflow", extract_workflow)
        self._set_parameter_default("session_in_outprefix", False)
