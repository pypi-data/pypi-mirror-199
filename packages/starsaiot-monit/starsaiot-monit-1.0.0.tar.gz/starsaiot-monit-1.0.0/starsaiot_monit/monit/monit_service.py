        ...
        while True:
            ...
            if sys == "linux":
                ...
                if "eth0" in def_route or "eth1" in def_route:
                    ...
                    msg_body_list.append(netType)
                    pingDelay = {
                        "telemetryKey": "pingDelay",
                        "telemetryDisplayName": "网络延时",
            ...
            if sim_info.getPingDelay() != "超时" and self._mqtt_connect._connected:
