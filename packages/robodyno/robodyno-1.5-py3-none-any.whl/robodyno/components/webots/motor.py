...
class Motor(WebotsDevice):
    ...
    def __init__(self, iface, id = 0x10, type = 'ROBODYNO_PRO_44'):
        ...
        """
        super().__init__(iface, id, type, auto_register=False)
        valid_motor_types = [
            self.DeviceType.ROBODYNO_PRO_44,
            self.DeviceType.ROBODYNO_PRO_12,
            self.DeviceType.ROBODYNO_PRO_50 ,
            self.DeviceType.ROBODYNO_PRO_100,
            self.DeviceType.ROBODYNO_PRO_DIRECT,
            self.DeviceType.ROBODYNO_PLUS_50 ,
            self.DeviceType.ROBODYNO_PLUS_100,
            self.DeviceType.ROBODYNO_PLUS_12 ,
            self.DeviceType.ROBODYNO_PLUS_DIRECT,
        ]
