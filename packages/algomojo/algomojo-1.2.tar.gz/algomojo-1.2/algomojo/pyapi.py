...
class api:
    ...
    def OpenPositions(self,broker: str,symbol: str="",product: str="",api_key: str="default", api_secret: str="default"):
    ...
    def AllPositions(self,broker: str,symbol: str="",product: str="",api_key: str="default", api_secret: str="default"):
        """This function display's the open positions of the specified broker .
