...
if TYPE_CHECKING:
    from .engine import RqStrategyEngine
...
class StrategyTemplate(ABC):
    ...
    def __init__(
        self,
        strategy_engine: "RqStrategyEngine",
        strategy_name: str,
        vt_symbols: List[str],
        setting: dict,
    ) -> None:
        """"""
        self.strategy_engine: "RqStrategyEngine" = strategy_engine
    ...
    def add_symbols(self, vt_symbols: List[str]):
        self.vt_symbols.extend(vt_symbols)
