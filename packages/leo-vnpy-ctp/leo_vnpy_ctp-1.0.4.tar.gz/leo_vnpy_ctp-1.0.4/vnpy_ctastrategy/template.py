...
class CtaTemplate(ABC):
    ...
    def update_symbols(self, vt_symbol):
        self.vt_symbol = vt_symbol

    def query_datafeed(self):
        print(f'从cta_engine里获取datafeed')
        # req: SubscribeRequest = SubscribeRequest(
        #     symbol="AU2304", exchange=Exchange("SHFE")
        # )
        # # RqsdkRpcEngine
        # self.main_engine.query_rqsdk(req, "RPC")

        return self.cta_engine.query_datafeed()
