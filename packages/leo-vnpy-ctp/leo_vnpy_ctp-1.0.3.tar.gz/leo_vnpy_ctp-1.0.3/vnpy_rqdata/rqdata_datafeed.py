...
from rqdatac.services.basic import all_instruments, instruments, get_contracts
from rqdatac.share.errors import AuthenticationFailed
from rqdatac.services.options import *
...
class RqdataDatafeed(BaseDatafeed):
    ...
    import rqdatac.services.options as option

    def rq_options_method(self, method, params):
        return getattr(self.option, method)(*params)

    # def get_contract_property(self):
    #     from rqdatac.services.options import get_contract_property
    ...
    #     return get_previous_trading_date
    #
    # def get_trading_dates(self):
    #     from rqdatac.services.calendar import get_trading_dates
    #     return get_trading_dates
    #
    ...
    #     # from rqdatac.services.basic import get_contracts
