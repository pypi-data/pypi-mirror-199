...
from client_server.rq_sdk_request import RqSdkRequest
...
from vnpy.trader.object import BarData, TradeData, OrderData, SubscribeRequest
from vnpy.trader.ui import QtCore, QtWidgets, QtGui
from vnpy.trader.ui.widget import BaseMonitor, BaseCell, DirectionCell, EnumCell
from vnpy.trader.utility import load_json, save_json
from vnpy_ctastrategy.backtesting import DailyResult
from ..backtesting import PortfolioDailyResult
from ..base_define import APP_rqsdk
from ..engine import (
    APP_NAME,
...
class RqBacktesterManager(QtWidgets.QWidget):
    """"""
    ...
    def init_ui(self) -> None:
        ...
        self.start_date: QtWidgets.QLineEdit = QtWidgets.QLineEdit("20210115")

        rq_button: QtWidgets.QPushButton = QtWidgets.QPushButton("测试请求")
        rq_button.clicked.connect(self.rq_request)
        ...
        form.addRow("下载合约", self.symbol_line)
        ...
        form.addRow("测试开始事件", self.start_date)
    ...
    #         symbol="AU2304", exchange=Exchange("SHFE")
    #     )
    #     # RqsdkRpcEngine
    #     self.event_engine.query_rqsdk(req, "RPC")
    ...
    def show_daily_results(self) -> None:
        ...
        if not self.daily_dialog.is_updated():
            results: List[PortfolioDailyResult] = self.backtester_engine.get_all_daily_results()
    ...
    def rq_request(self) -> None:

        self.rpc_engine: RqsdkRpcEngine = self.main_engine.get_engine(APP_rqsdk)
        dd = self.rpc_engine.get_contract_property(order_book_ids=['10002752'], start_date=self.start_date.text(),
                                                   end_date='20210118')
        print(f'finally {dd}')
        # req: RqSdkRequest = RqSdkRequest(
        #     method="get_contract_property", param=(['10002752'], '20210115', '20210118')
        # )
        # # RqsdkRpcEngine 客户端发起的
        # self.event_engine.query_rqsdk(req, "RPC")
