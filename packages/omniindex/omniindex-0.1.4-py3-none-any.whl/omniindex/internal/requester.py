...
# from omniindex.errors import VitalError
from omniindex.version import __version__
...
def _requests_http_request(
    ...
    headers.update({"User-Agent": "OmniIndex Python v{}".format(__version__)})
...
def _http_request(
    ...
    if is_json or response.headers["Content-Type"] == "application/json":
        try:
            ...
            raise ValueError.from_response(
                {
