...
from ..model.param import SkuNameParam


class StaplesCatalogService(BaseService):

    def predict_catalog1(self, task_params: SkuNameParam = None, callback: Callback = None, **kwargs):
        return self.celery_client.apply(task_name='catalog.staples1', task_params=task_params.dict(), callback=callback,
                                        **kwargs)

    def predict_catalog4(self, task_params: SkuNameParam = None, callback: Callback = None, **kwargs):
        return self.celery_client.apply(task_name='catalog.staples4', task_params=task_params.dict(), callback=callback,
                                        **kwargs)

    def predict_catalog6(self, task_params: SkuNameParam = None, callback: Callback = None, **kwargs):
