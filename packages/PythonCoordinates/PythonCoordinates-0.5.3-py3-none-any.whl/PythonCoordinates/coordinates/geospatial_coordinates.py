...
class CoordinateConversion:
    ...
    @staticmethod
    def ll_to_utm_x(lat, lon, utm_northing=None, utm_easting=None, zone_number=-1):
        ...
        # print('easting/northing: {}/{}'.format(utm_easting, utm_northing))
        if lat < 0:
    ...
    @staticmethod
    def ll_to_utm(latitude, longitude, utm_northing=None, utm_easting=None, zone_number=-1):
        # from .Constants import Constants
...
class CLAWSCoordinate(CartesianCoordinate):
    """CLAWSCoordinate Constructor

    If using 1 variable, it must be of type CLAWSCoordinate or CartesianCoordinate.
    If using 2 variables, they must be of type CLAWSCoordinate, or latitude + longitude (IN THAT ORDER)
    If using 3 variables, they must latitude + longitude + aboveGroundLevel IN THAT ORDER"""

    def __init__(self, a=None, b=None, c=None):
        super().__init__()
        if isinstance(a, CLAWSCoordinate) and b is None and c is None:
            super().__init__(a)
            ...
            super().__init__(a)
        elif (isinstance(a, CLAWSCoordinate) or isinstance(a, CartesianCoordinate)) and \
                (isinstance(b, CLAWSCoordinate) or isinstance(b, CartesianCoordinate)) and c is None:
            super().__init__(a, b)
            ...
            easting, northing = CLAWSCoordinate.ll_to_utm(a, b)
    ...
    @staticmethod
    def conex_location():
        return CLAWSCoordinate(33.5649870, -106.6706207, Length())

    @staticmethod
    def conex_wx():
        return CLAWSCoordinate(33.5649870, -106.6706207, Length(3.0))

    @staticmethod
    def east_tower_location():
        return CLAWSCoordinate(33.55232639, -106.6783867, Length())

    @staticmethod
    def east_tower_wx_35ft():
        return CLAWSCoordinate(33.55232639, -106.6783867, Length(10.7))

    @staticmethod
    def east_tower_wx_54ft():
        return CLAWSCoordinate(33.55232639, -106.6783867, Length(16.5))

    @staticmethod
    def east_tower_wx_137ft():
        return CLAWSCoordinate(33.55232639, -106.6783867, Length(41.8))

    @staticmethod
    def east_tower_wx_165ft():
        return CLAWSCoordinate(33.55232639, -106.6783867, Length(50.3))

    @staticmethod
    def east_tower_wx_270ft():
        return CLAWSCoordinate(33.55232639, -106.6783867, Length(82.3))

    @staticmethod
    def east_tower_wx_285ft():
        return CLAWSCoordinate(33.55232639, -106.6783867, Length(86.9))

    @staticmethod
    def west_tower_location():
        return CLAWSCoordinate(33.55231583, -106.6810122, Length())

    @staticmethod
    def west_tower_wx_35ft():
        return CLAWSCoordinate(33.55231583, -106.6810122, Length(10.7))

    @staticmethod
    def west_tower_wx_93ft():
        return CLAWSCoordinate(33.55231583, -106.6810122, Length(28.3))

    @staticmethod
    def west_tower_wx_137ft():
        return CLAWSCoordinate(33.55231583, -106.6810122, Length(41.8))

    @staticmethod
    def west_tower_wx_200ft():
        return CLAWSCoordinate(33.55231583, -106.6810122, Length(61))

    @staticmethod
    def west_tower_wx_285ft():
        return CLAWSCoordinate(33.55231583, -106.6810122, Length(86.9))

    @staticmethod
    def array_center():
        return CLAWSCoordinate(33.55232361, -106.6797006, Length(0.0))

    @staticmethod
    def harriet_location():
        return CLAWSCoordinate(33.56251596, -106.6443884, Length.average_listener_height())

    @staticmethod
    def cain_location():
        return CLAWSCoordinate(33.57582656, -106.70375776, Length.average_listener_height())

    @staticmethod
    def gap_location():
        return CLAWSCoordinate(33.530860, -106.422960, Length.average_listener_height())

    # NOTE: The C# version of the following method was missing the final entry - gap_location. Added here.
    @staticmethod
    def known_locations():
        output = [CLAWSCoordinate.conex_location(), CLAWSCoordinate.conex_wx(), CLAWSCoordinate.east_tower_location(),
                  CLAWSCoordinate.east_tower_wx_35ft(), CLAWSCoordinate.east_tower_wx_54ft(),
                  CLAWSCoordinate.east_tower_wx_137ft(), CLAWSCoordinate.east_tower_wx_165ft(),
                  CLAWSCoordinate.east_tower_wx_270ft(), CLAWSCoordinate.east_tower_wx_285ft(),
                  CLAWSCoordinate.west_tower_location(), CLAWSCoordinate.west_tower_wx_35ft(),
                  CLAWSCoordinate.west_tower_wx_93ft(), CLAWSCoordinate.west_tower_wx_137ft(),
                  CLAWSCoordinate.west_tower_wx_200ft(), CLAWSCoordinate.west_tower_wx_285ft(),
                  CLAWSCoordinate.array_center(), CLAWSCoordinate.harriet_location(), CLAWSCoordinate.cain_location(),
                  CLAWSCoordinate.gap_location()]
        return output

    @staticmethod
    def utm_to_coordinate(easting, northing, zone_num, zone_l):
        """
        Revision History
        ----------------
        ...
        k07 = k01 * k06
        k08 = k01 * k07
        north = CLAWSCoordinate.in_north(zone_l)
        if not north:
            northing -= 10000000.0
        k1 = northing.meters
        ...
        tan5 = tan1 * tan4
        tan6 = tan1 * tan5
        p = a * (1.0 - e2) / np.pow((1.0 - e2 * sin2), 1.5)
        q1 = p * (1.0 + ep2 * cos2)
        q2 = q1 * q1
        q3 = q1 * q2
        q4 = q1 * q3
        ...
        # print('com: {}'.format(-de2 * t10 + de4 * t11 - de6 * t12 + de8 * t13))
    ...
    def ll_to_utm(lat, lon):
        ...
        B = 6356752.3142
        E2 = 0.00669438
        latValid = (-80.0 <= lat) and (lat <= +84.0)
        lonValid = (-180.0 <= lon) and (lon <= +180.0)
        ok = latValid and lonValid
        ...
        if ok:
            ...
            # print('lat, lon: {}, {}'.format(lat, lon))
            # print('easting, northing: {}, {}'.format(_easting, _northing))
    ...
    def move(self, distance, bearing):
        ...
        if isinstance(distance, Length) and isinstance(bearing, Angle):
            ...
            new_lat, new_lon = CLAWSCoordinate.utm_to_ll(easting=new_easting, northing=new_northing,
...
class SourcePoint(CLAWSCoordinate):
    """
    ...
    @property
    def wsmr_arc_msl_adjustment(self):
        return Length(30.48, Length.Units.Meters)
