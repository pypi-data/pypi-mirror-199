...
class Resensys():
    ...
    def connect(self):
        ...
        self.encoded_password = self.password_encoding_generator(self.password)
        # config = {  
        #     'user': self.username,
        ...
        self.conn = pymysql.connect(user=self.username,password=self.encoded_password,host="resensys.net",port=3306)
        return self.conn
