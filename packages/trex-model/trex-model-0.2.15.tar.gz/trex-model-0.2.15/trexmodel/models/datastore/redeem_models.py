    ...
    def create(customer, reward_format, redeemed_outlet, transaction_id=None, 
        ...
        if reward_format == program_conf.REWARD_FORMAT_POINT:
            ...
            while total_redeemed_amount>0:
                (total_redeemed_amount, cursor, __redeemed_details_list) = __start_redeem(customer, total_redeemed_amount, cursor, 
                                                                                        CustomerPointReward)
                logger.debug('total_redeemed_amount after __start_redeem = %s', total_redeemed_amount)
                redeemed_reward_details_list.extend(__redeemed_details_list)
