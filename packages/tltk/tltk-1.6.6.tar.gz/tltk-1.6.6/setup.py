...
#    packages=find_packages(exclude=['contrib', 'docs', 'tests']),
  ...
  #  },
    ...
    package_data={
        'tltk': ['sylrule.lts', 'thaisyl.dict', 'PhSTrigram.sts', 'sylseg.3g', 'sylform_var.pklz', 'thdict', 'BEST.dict', 'pos_tagger.pklz', 'sent_segment.pklz', 'ner_tagger.pklz','word.pklz','thamalt.mco'],
    },
