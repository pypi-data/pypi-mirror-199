...
def index(package_type: str, id: str) -> str:
    try:
        ...
        feedbacks = tk.get_action("flakes_feedback_feedback_list")({}, {"package_id": id})
    except (tk.ObjectNotFound, tk.NotAuthorized):
        return tk.abort(404)
...
bp.add_url_rule("/dataset/<id>/feedback/post", defaults={"package_type": "dataset"}, view_func=post_view)
bp.add_url_rule("/<package_type>/<id>/feedback/post", view_func=post_view)
bp.add_url_rule("/dataset/<id>/feedback/delete/<feedback_id>", defaults={"package_type": "dataset"}, view_func=delete_view)
bp.add_url_rule("/<package_type>/<id>/feedback/delete/<feedback_id>", view_func=delete_view)
