...
Then create a searx search instance like this:
    ...
    .. code-block:: python
        ...
        from lib.utilities import SearxSearchWrapper
...
For example the following query:
    ...
    .. code-block:: python
        ...
        s = SearxSearchWrapper("lib library", engines=['github'])

        # can also be written as:
        s = SearxSearchWrapper("lib library !github")
        # or even:
        s = SearxSearchWrapper("lib library !gh")


In some situations you might want to pass an extra string to the search query.
For example when the `run()` method is called by an bot. The search suffix can
...
engines.
    ...
    .. code-block:: python
        ...
        s = SearchWrapper("lib library", query_suffix="!gh")


        s = SearchWrapper("lib library")
