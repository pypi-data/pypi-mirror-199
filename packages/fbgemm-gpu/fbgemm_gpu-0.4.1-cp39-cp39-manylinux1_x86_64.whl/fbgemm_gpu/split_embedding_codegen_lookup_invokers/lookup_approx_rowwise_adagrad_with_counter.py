...
def invoke(
    ...
    if (common_args.host_weights.numel() > 0):
        return torch.ops.fbgemm.split_embedding_codegen_lookup_approx_rowwise_adagrad_with_counter_function_cpu(
            # common_args
        ...
        return torch.ops.fbgemm.split_embedding_codegen_lookup_approx_rowwise_adagrad_with_counter_function(
            # common_args
