...
from owl_builder.autotaxo.svc import ExtractKeytermsOpenAI
...
from owl_builder.autotaxo.svc import GenerateIntentNames
from owl_builder.autotaxo.svc import GenerateQAPairs
...
class AutoTaxoOrchestrator(BaseObject):
    ...
    def __init__(self):
        ...
        self._keyterms_openai = ExtractKeytermsOpenAI().process
        self._generate_intent_name = GenerateIntentNames().process
        self._generate_qa_pairs = GenerateQAPairs().process
    ...
    def keyterms_openai(self,
                        input_text: str) -> Optional[List[str]]:
        """ Extract Keyterms using OpenAI
        ...
        """
        return self._keyterms_openai(input_text)
    ...
    def generate_qa_pairs(self,
        ...
        """
        return self._generate_qa_pairs(
            question=question,
            answer=answer)
    ...
    def generate_intent_name(self,
        ...
        Returns:
            Optional[List[str]]: list of keyterms
        """
        return self._generate_intent_name(input_text)
