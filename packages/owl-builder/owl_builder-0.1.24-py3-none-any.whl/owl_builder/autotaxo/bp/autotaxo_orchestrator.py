...
class AutoTaxoOrchestrator(BaseObject):
    ...
    def __init__(self):
        ...
        self._openai_keyterm_generator = ExtractKeytermsOpenAI().process
        self._intent_name_generator = GenerateIntentNames().process
        self._qapair_generator = GenerateQAPairs().process
    ...
    def keyterms_openai(self,
        ...
        """
        return self._openai_keyterm_generator(input_text)
