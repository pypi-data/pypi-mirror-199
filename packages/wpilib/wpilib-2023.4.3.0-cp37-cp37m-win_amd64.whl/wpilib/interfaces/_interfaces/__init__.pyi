...
class GenericHID():
    ...
    class RumbleType():
        ...
        def value(self) -> int:
            ...
            :type: int
            """
        __members__: dict # value = {'kLeftRumble': <RumbleType.kLeftRumble: 0>, 'kRightRumble': <RumbleType.kRightRumble: 1>, 'kBothRumble': <RumbleType.kBothRumble: 2>}
        kBothRumble: wpilib.interfaces._interfaces.GenericHID.RumbleType # value = <RumbleType.kBothRumble: 2>
