...
class ADIS16448_IMUSim():
    ...
    def __init__(self, imu: wpilib._wpilib.ADIS16448_IMU) -> None: 
        ...
        """
    def setAccelX(self, accel: meters_per_second_squared) -> None: 
        """
        Sets the X axis acceleration.

        :param accel: The acceleration.
        """
    def setAccelY(self, accel: meters_per_second_squared) -> None: 
        """
        Sets the Y axis acceleration.

        :param accel: The acceleration.
        """
    def setAccelZ(self, accel: meters_per_second_squared) -> None: 
        """
        Sets the Z axis acceleration.

        :param accel: The acceleration.
        """
    def setGyroAngleX(self, angle: degrees) -> None: 
        """
        Sets the X axis angle (CCW positive).

        :param angle: The angle.
        """
    def setGyroAngleY(self, angle: degrees) -> None: 
        """
        Sets the Y axis angle (CCW positive).

        :param angle: The angle.
        """
    def setGyroAngleZ(self, angle: degrees) -> None: 
        """
        Sets the Z axis angle (CCW positive).

        :param angle: The angle.
        """
    def setGyroRateX(self, angularRate: degrees_per_second) -> None: 
        """
        Sets the X axis angular rate (CCW positive).

        :param angularRate: The angular rate.
        """
    def setGyroRateY(self, angularRate: degrees_per_second) -> None: 
        """
        Sets the Y axis angular rate (CCW positive).

        :param angularRate: The angular rate.
        """
    def setGyroRateZ(self, angularRate: degrees_per_second) -> None: 
        """
...
class BatterySim():
    ...
    @staticmethod
    @typing.overload
    def calculate(currents: typing.List[amperes]) -> volts: 
        """
    ...
    @staticmethod
    @typing.overload
    def calculate(nominalVoltage: volts, resistance: ohms, currents: typing.List[amperes]) -> volts: ...
    pass
...
class PneumaticsBaseSim():
    ...
    def registerCompressorCurrentCallback(self, callback: typing.Callable[[str, HAL_Value], None], initialNotify: bool) -> CallbackStore: 
        ...
        :returns: the {@link CallbackStore} object associated with this callback.
...
class DifferentialDrivetrainSim():
    ...
    class KitbotMotor():
        ...
        DualFalcon500PerSide: wpimath._controls._controls.plant.DCMotor
        DualMiniCIMPerSide: wpimath._controls._controls.plant.DCMotor
        DualNEOPerSide: wpimath._controls._controls.plant.DCMotor
        SingleCIMPerSide: wpimath._controls._controls.plant.DCMotor
        SingleFalcon500PerSide: wpimath._controls._controls.plant.DCMotor
        SingleMiniCIMPerSide: wpimath._controls._controls.plant.DCMotor
        SingleNEOPerSide: wpimath._controls._controls.plant.DCMotor
        pass
...
class ElevatorSim(LinearSystemSim_2_1_1):
    ...
    """
    @typing.overload
    def __init__(self, gearbox: wpimath._controls._controls.plant.DCMotor, gearing: float, carriageMass: kilograms, drumRadius: meters, minHeight: meters, maxHeight: meters, simulateGravity: bool, measurementStdDevs: typing.List[float[1]] = [0.0]) -> None: 
        """
        ...
        """
    @typing.overload
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_2_1_1, gearbox: wpimath._controls._controls.plant.DCMotor, gearing: float, drumRadius: meters, minHeight: meters, maxHeight: meters, simulateGravity: bool, measurementStdDevs: typing.List[float[1]] = [0.0]) -> None: ...
    def _updateX(self, currentXhat: numpy.ndarray[numpy.float64, _Shape[2, 1]], u: numpy.ndarray[numpy.float64, _Shape[1, 1]], dt: seconds) -> numpy.ndarray[numpy.float64, _Shape[2, 1]]: 
        """
...
class DCMotorSim(LinearSystemSim_2_1_2):
    ...
    """
    @typing.overload
    def __init__(self, gearbox: wpimath._controls._controls.plant.DCMotor, gearing: float, moi: kilogram_square_meters, measurementStdDevs: typing.List[float[2]] = [0.0, 0.0]) -> None: 
        """
        ...
        """
    @typing.overload
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_2_1_2, gearbox: wpimath._controls._controls.plant.DCMotor, gearing: float, measurementStdDevs: typing.List[float[2]] = [0.0, 0.0]) -> None: ...
    def getAngularPosition(self) -> radians: 
        """
...
class SingleJointedArmSim(LinearSystemSim_2_1_1):
    ...
    """
    @typing.overload
    def __init__(self, gearbox: wpimath._controls._controls.plant.DCMotor, gearing: float, moi: kilogram_square_meters, armLength: meters, minAngle: radians, maxAngle: radians, simulateGravity: bool, measurementStdDevs: typing.List[float[1]] = [0.0]) -> None: 
        """
        ...
        """
    @typing.overload
    def __init__(self, system: wpimath._controls._controls.system.LinearSystem_2_1_1, gearbox: wpimath._controls._controls.plant.DCMotor, gearing: float, armLength: meters, minAngle: radians, maxAngle: radians, simulateGravity: bool, measurementStdDevs: typing.List[float[1]] = [0.0]) -> None: ...
    def _updateX(self, currentXhat: numpy.ndarray[numpy.float64, _Shape[2, 1]], u: numpy.ndarray[numpy.float64, _Shape[1, 1]], dt: seconds) -> numpy.ndarray[numpy.float64, _Shape[2, 1]]: 
        """
...
class UltrasonicSim():
    ...
    def setRange(self, range: inches) -> None: 
        """
