...
class BuiltInWidgets():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    __members__: dict # value = {'kTextView': <BuiltInWidgets.kTextView: 0>, 'kNumberSlider': <BuiltInWidgets.kNumberSlider: 1>, 'kNumberBar': <BuiltInWidgets.kNumberBar: 2>, 'kDial': <BuiltInWidgets.kDial: 3>, 'kGraph': <BuiltInWidgets.kGraph: 4>, 'kBooleanBox': <BuiltInWidgets.kBooleanBox: 5>, 'kToggleButton': <BuiltInWidgets.kToggleButton: 6>, 'kToggleSwitch': <BuiltInWidgets.kToggleSwitch: 7>, 'kVoltageView': <BuiltInWidgets.kVoltageView: 8>, 'kPowerDistribution': <BuiltInWidgets.kPowerDistribution: 9>, 'kComboBoxChooser': <BuiltInWidgets.kComboBoxChooser: 10>, 'kSplitButtonChooser': <BuiltInWidgets.kSplitButtonChooser: 11>, 'kEncoder': <BuiltInWidgets.kEncoder: 12>, 'kMotorController': <BuiltInWidgets.kMotorController: 13>, 'kCommand': <BuiltInWidgets.kCommand: 14>, 'kPIDCommand': <BuiltInWidgets.kPIDCommand: 15>, 'kPIDController': <BuiltInWidgets.kPIDController: 16>, 'kAccelerometer': <BuiltInWidgets.kAccelerometer: 17>, 'k3AxisAccelerometer': <BuiltInWidgets.k3AxisAccelerometer: 18>, 'kGyro': <BuiltInWidgets.kGyro: 19>, 'kRelay': <BuiltInWidgets.kRelay: 20>, 'kDifferentialDrive': <BuiltInWidgets.kDifferentialDrive: 21>, 'kMecanumDrive': <BuiltInWidgets.kMecanumDrive: 22>, 'kCameraStream': <BuiltInWidgets.kCameraStream: 23>, 'kField': <BuiltInWidgets.kField: 24>}
    k3AxisAccelerometer: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.k3AxisAccelerometer: 18>
    kAccelerometer: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kAccelerometer: 17>
    kBooleanBox: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kBooleanBox: 5>
    kCameraStream: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kCameraStream: 23>
    kComboBoxChooser: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kComboBoxChooser: 10>
    kCommand: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kCommand: 14>
    kDial: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kDial: 3>
    kDifferentialDrive: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kDifferentialDrive: 21>
    kEncoder: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kEncoder: 12>
    kField: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kField: 24>
    kGraph: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kGraph: 4>
    kGyro: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kGyro: 19>
    kMecanumDrive: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kMecanumDrive: 22>
    kMotorController: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kMotorController: 13>
    kNumberBar: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kNumberBar: 2>
    kNumberSlider: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kNumberSlider: 1>
    kPIDCommand: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kPIDCommand: 15>
    kPIDController: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kPIDController: 16>
    kPowerDistribution: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kPowerDistribution: 9>
    kRelay: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kRelay: 20>
    kSplitButtonChooser: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kSplitButtonChooser: 11>
    kTextView: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kTextView: 0>
    kToggleButton: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kToggleButton: 6>
    kToggleSwitch: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kToggleSwitch: 7>
    kVoltageView: wpilib.shuffleboard._shuffleboard.BuiltInWidgets # value = <BuiltInWidgets.kVoltageView: 8>
    pass
...
class ShuffleboardContainer(ShuffleboardValue):
    ...
    @typing.overload
    def add(self, title: str, defaultValue: typing.List[bool]) -> SimpleWidget: ...
    @typing.overload
    def add(self, title: str, defaultValue: typing.List[float]) -> SimpleWidget: ...
    @typing.overload
    def add(self, title: str, defaultValue: typing.List[int]) -> SimpleWidget: ...
    @typing.overload
    def add(self, title: str, defaultValue: typing.List[str]) -> SimpleWidget: ...
    @typing.overload
    ...
    def addBoolean(self, title: str, supplier: typing.Callable[[], bool]) -> SuppliedBoolValueWidget: 
        ...
        """
    def addBooleanArray(self, title: str, supplier: typing.Callable[[], typing.List[int]]) -> SuppliedBoolListValueWidget: 
        """
        Adds a widget to this container. The widget will display the data provided
        by the value supplier. Changes made on the dashboard will not propagate to
        the widget object, and will be overridden by values from the value
    ...
    def addDouble(self, title: str, supplier: typing.Callable[[], float]) -> SuppliedDoubleValueWidget: 
        ...
        :returns: a widget to display data
        """
    def addDoubleArray(self, title: str, supplier: typing.Callable[[], typing.List[float]]) -> SuppliedDoubleListValueWidget: 
        """
        Adds a widget to this container. The widget will display the data provided
        by the value supplier. Changes made on the dashboard will not propagate to
        the widget object, and will be overridden by values from the value
    ...
    def addFloat(self, title: str, supplier: typing.Callable[[], float]) -> SuppliedFloatValueWidget: 
        ...
        :returns: a widget to display data
        """
    def addFloatArray(self, title: str, supplier: typing.Callable[[], typing.List[float]]) -> SuppliedFloatListValueWidget: 
        """
        Adds a widget to this container. The widget will display the data provided
        by the value supplier. Changes made on the dashboard will not propagate to
        the widget object, and will be overridden by values from the value
    ...
    def addInteger(self, title: str, supplier: typing.Callable[[], int]) -> SuppliedIntegerValueWidget: 
        ...
        :returns: a widget to display data
        """
    def addIntegerArray(self, title: str, supplier: typing.Callable[[], typing.List[int]]) -> SuppliedIntListValueWidget: 
        """
        Adds a widget to this container. The widget will display the data provided
        by the value supplier. Changes made on the dashboard will not propagate to
        the widget object, and will be overridden by values from the value
    ...
    def addNumber(self, title: str, supplier: typing.Callable[[], float]) -> SuppliedDoubleValueWidget: 
        ...
        :returns: a widget to display data
        """
    def addNumberArray(self, title: str, supplier: typing.Callable[[], typing.List[float]]) -> SuppliedDoubleListValueWidget: 
        """
        Adds a widget to this container. The widget will display the data provided
        by the value supplier. Changes made on the dashboard will not propagate to
        the widget object, and will be overridden by values from the value
    ...
    @typing.overload
    def addPersistent(self, title: str, defaultValue: typing.List[bool]) -> SimpleWidget: ...
    @typing.overload
    def addPersistent(self, title: str, defaultValue: typing.List[float]) -> SimpleWidget: ...
    @typing.overload
    def addPersistent(self, title: str, defaultValue: typing.List[int]) -> SimpleWidget: ...
    @typing.overload
    def addPersistent(self, title: str, defaultValue: typing.List[str]) -> SimpleWidget: ...
    @typing.overload
    def addRaw(self, title: str, supplier: typing.Callable[[], typing.List[int]]) -> SuppliedRawValueWidget: 
        """
        Adds a widget to this container. The widget will display the data provided
        by the value supplier. Changes made on the dashboard will not propagate to
        the widget object, and will be overridden by values from the value
        ...
        """
    @typing.overload
    def addRaw(self, title: str, typeString: str, supplier: typing.Callable[[], typing.List[int]]) -> SuppliedRawValueWidget: ...
    def addString(self, title: str, supplier: typing.Callable[[], str]) -> SuppliedStringValueWidget: 
        ...
        :returns: a widget to display data
        """
    def addStringArray(self, title: str, supplier: typing.Callable[[], typing.List[str]]) -> SuppliedStringListValueWidget: 
        """
        Adds a widget to this container. The widget will display the data provided
        by the value supplier. Changes made on the dashboard will not propagate to
        the widget object, and will be overridden by values from the value
    ...
    def disableIfActuator(self) -> None: ...
    def enableIfActuator(self) -> None: ...
    def getComponents(self) -> typing.List[ShuffleboardComponentBase]: 
        """
...
class ShuffleboardEventImportance():
    ...
    def value(self) -> int:
        ...
        :type: int
        """
    __members__: dict # value = {'kTrivial': <ShuffleboardEventImportance.kTrivial: 0>, 'kLow': <ShuffleboardEventImportance.kLow: 1>, 'kNormal': <ShuffleboardEventImportance.kNormal: 2>, 'kHigh': <ShuffleboardEventImportance.kHigh: 3>, 'kCritical': <ShuffleboardEventImportance.kCritical: 4>}
    kCritical: wpilib.shuffleboard._shuffleboard.ShuffleboardEventImportance # value = <ShuffleboardEventImportance.kCritical: 4>
    kHigh: wpilib.shuffleboard._shuffleboard.ShuffleboardEventImportance # value = <ShuffleboardEventImportance.kHigh: 3>
    kLow: wpilib.shuffleboard._shuffleboard.ShuffleboardEventImportance # value = <ShuffleboardEventImportance.kLow: 1>
    kNormal: wpilib.shuffleboard._shuffleboard.ShuffleboardEventImportance # value = <ShuffleboardEventImportance.kNormal: 2>
    kTrivial: wpilib.shuffleboard._shuffleboard.ShuffleboardEventImportance # value = <ShuffleboardEventImportance.kTrivial: 0>
    pass
class _LayoutComponent(ShuffleboardComponentBase, ShuffleboardValue):
    """
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> ShuffleboardLayout: 
        ...
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> ShuffleboardLayout: 
        """
    ...
    def withSize(self, width: int, height: int) -> ShuffleboardLayout: 
        ...
        """
    pass
class ShuffleboardTab(ShuffleboardContainer, ShuffleboardValue):
    """
    ...
    pass
class _ComplexComponent(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> ComplexWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> ComplexWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> ComplexWidget: 
        ...
        """
    pass
class _SimpleComponent(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SimpleWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SimpleWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SimpleWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_vector_bool(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedBoolListValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedBoolListValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedBoolListValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_bool(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedBoolValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedBoolValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedBoolValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_vector_double(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedDoubleListValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedDoubleListValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedDoubleListValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_double(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedDoubleValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedDoubleValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedDoubleValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_vector_float(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedFloatListValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedFloatListValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedFloatListValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_float(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedFloatValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedFloatValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedFloatValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_vector_int(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedIntListValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedIntListValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedIntListValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_integer(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedIntegerValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedIntegerValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedIntegerValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_vector_raw(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedRawValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedRawValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedRawValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_vector_string(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedStringListValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedStringListValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
    ...
    def withSize(self, width: int, height: int) -> SuppliedStringListValueWidget: 
        ...
        """
    pass
class _SuppliedValueComponent_string(ShuffleboardComponentBase, ShuffleboardValue):
    """
    A generic component in Shuffleboard.
    ...
    def withPosition(self, columnIndex: int, rowIndex: int) -> SuppliedStringValueWidget: 
        ...
        :returns: this component
        """
    def withProperties(self, properties: typing.Dict[str, ntcore._ntcore.Value]) -> SuppliedStringValueWidget: 
        """
        Sets custom properties for this component. Property names are
        case-sensitive and whitespace-insensitive (capitalization and spaces do not
        matter).
...
class WidgetType():
    ...
    def getWidgetName(self) -> str: 
        ...
        """
    pass
class _ComplexWidget(_ComplexComponent, ShuffleboardComponentBase, ShuffleboardValue):
    """
    ...
    pass
class ComplexWidget(_ComplexWidget, _ComplexComponent, ShuffleboardComponentBase, ShuffleboardValue):
    """
    ...
    def enableIfActuator(self) -> None: ...
    pass
class ShuffleboardLayout(_LayoutComponent, ShuffleboardComponentBase, ShuffleboardContainer, ShuffleboardValue):
    """
...
class _ShuffleboardInstance(_ShuffleboardRoot):
    ...
    def update(self) -> None: ...
    pass
class _SimpleWidget(_SimpleComponent, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class SimpleWidget(_SimpleWidget, _SimpleComponent, ShuffleboardComponentBase, ShuffleboardValue):
    """
    ...
    pass
class _SuppliedValueWidget_bool(_SuppliedValueComponent_bool, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_double(_SuppliedValueComponent_double, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_float(_SuppliedValueComponent_float, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_integer(_SuppliedValueComponent_integer, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_string(_SuppliedValueComponent_string, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_vector_bool(_SuppliedValueComponent_vector_bool, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_vector_double(_SuppliedValueComponent_vector_double, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_vector_float(_SuppliedValueComponent_vector_float, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_vector_int(_SuppliedValueComponent_vector_int, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_vector_raw(_SuppliedValueComponent_vector_raw, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class _SuppliedValueWidget_vector_string(_SuppliedValueComponent_vector_string, ShuffleboardComponentBase, ShuffleboardValue):
    """
    Abstract superclass for widgets.
    ...
    pass
class SuppliedBoolValueWidget(_SuppliedValueWidget_bool, _SuppliedValueComponent_bool, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedDoubleValueWidget(_SuppliedValueWidget_double, _SuppliedValueComponent_double, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedFloatValueWidget(_SuppliedValueWidget_float, _SuppliedValueComponent_float, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedIntegerValueWidget(_SuppliedValueWidget_integer, _SuppliedValueComponent_integer, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedStringValueWidget(_SuppliedValueWidget_string, _SuppliedValueComponent_string, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedBoolListValueWidget(_SuppliedValueWidget_vector_bool, _SuppliedValueComponent_vector_bool, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedDoubleListValueWidget(_SuppliedValueWidget_vector_double, _SuppliedValueComponent_vector_double, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedFloatListValueWidget(_SuppliedValueWidget_vector_float, _SuppliedValueComponent_vector_float, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedIntListValueWidget(_SuppliedValueWidget_vector_int, _SuppliedValueComponent_vector_int, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedRawValueWidget(_SuppliedValueWidget_vector_raw, _SuppliedValueComponent_vector_raw, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
class SuppliedStringListValueWidget(_SuppliedValueWidget_vector_string, _SuppliedValueComponent_vector_string, ShuffleboardComponentBase, ShuffleboardValue):
    def buildInto(self, parentTable: ntcore._ntcore.NetworkTable, metaTable: ntcore._ntcore.NetworkTable) -> None: ...
    pass
...
def shuffleboardEventImportanceName(importance: ShuffleboardEventImportance) -> str:
    pass
_sbd_cleanup: typing.Any  # PyCapsule()
