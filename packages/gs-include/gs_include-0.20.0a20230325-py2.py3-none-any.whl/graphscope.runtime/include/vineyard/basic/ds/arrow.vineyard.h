...
class SchemaProxyBaseBuilder: public ObjectBuilder {
  ...
  protected:
    vineyard::json schema_textual_;
    vineyard::json schema_binary_;

    void set_schema_textual_(vineyard::json const &schema_textual__) {
        this->schema_textual_ = schema_textual__;
    }

    void set_schema_binary_(vineyard::json const &schema_binary__) {
