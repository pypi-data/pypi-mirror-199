...
my_libraries = ['time', 'openpyxl', 'codecs', 'json', 'zipfile', 'pathlib', 'openai', 'os', 'tkinter', 'shutil']
        ...
        if 'measures' in t:
            ...
            for i in list_measures:
                ...
                if "\"" not in exp and (len(exp) > 1):
                    ...
                    diff1 = set(exp_1) - set(exp_2)
                    diff2 = set(exp_2) - set(exp_1)
                    if (len(diff1) == 0) and (len(diff2) == 0):
                        i['expression'] = exp
                ws.append([i['name'], "".join(i['expression'][0:]),
