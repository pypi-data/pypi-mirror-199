...
class PriceBookExtractor(ExtractorBase):
    def __init__(
        self, 
        owner: str, 
        domain_url: str, 
        ...
        super().__init__('salesforce', owner, 'pricebooks', domain_url, auth, dest)
    ...
    def extract(self):
        ...
        if len(self.pricebooks):
            self.dest.sink(self.pricebooks)
