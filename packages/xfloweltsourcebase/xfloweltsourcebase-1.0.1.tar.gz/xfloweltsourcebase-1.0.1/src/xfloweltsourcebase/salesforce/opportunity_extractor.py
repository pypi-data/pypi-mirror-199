...
class OpportunityExtractor(ExtractorBase):
    def __init__(
        self, 
        owner: str, 
        domain_url: str, 
        ...
        super().__init__('salesforce', owner, 'opportunities', domain_url, auth, dest)
    ...
    def extract(self):
        ...
        if len(self.opportunities):
            self.dest.sink(self.opportunities)
