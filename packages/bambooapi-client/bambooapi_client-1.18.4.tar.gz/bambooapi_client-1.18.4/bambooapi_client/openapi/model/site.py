...
class Site(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_name, flexumer_id, microgrid, site_id, available, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_name, flexumer_id, microgrid, site_id, available, *args, **kwargs):  # noqa: E501
        """Site - a model defined in OpenAPI
