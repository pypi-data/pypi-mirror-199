        ...
        self.get_client_baseline_forecast_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'legacy_meter_calculation': 'legacy_meter_calculation',
                },
                'location_map': {
                    'client_id': 'path',
                    'start_time': 'query',
                    ...
                    'frequency': 'query',
                    'based_on_load': 'query',
                    'legacy_meter_calculation': 'query',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_client_baseline_forecast(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            legacy_meter_calculation (bool): [optional] if omitted the server will use the default value of False
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
