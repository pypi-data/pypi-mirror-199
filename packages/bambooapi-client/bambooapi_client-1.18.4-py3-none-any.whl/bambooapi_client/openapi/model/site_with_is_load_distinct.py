...
class SiteWithIsLoadDistinct(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_name, flexumer_id, microgrid, site_id, available, is_load_distinct, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            timezone (str): Name of the timezone of the site, from the IANA tz database (for example \"Europe/Madrid\"). A list of names can be found at https://en.wikipedia.org/wiki/List_of_tz_database_time_zones.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_name, flexumer_id, microgrid, site_id, available, is_load_distinct, *args, **kwargs):  # noqa: E501
        """SiteWithIsLoadDistinct - a model defined in OpenAPI
