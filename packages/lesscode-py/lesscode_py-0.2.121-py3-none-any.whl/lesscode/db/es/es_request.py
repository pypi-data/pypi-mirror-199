...
class EsRequest:
    ...
    def format_es_field_mapping_url(self, field, host=None, port=None, route_key=None):
        return self.replace_url_kwargs("http://{host}{port}/{route_key}/_mapping/field/{field}",
                                       {"host": host, "port": port, "route_key": route_key, "field": field})
