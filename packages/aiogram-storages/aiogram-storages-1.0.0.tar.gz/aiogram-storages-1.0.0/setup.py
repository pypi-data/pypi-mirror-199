...
setup(
    ...
    url="https://github.com/DIMFLIX-OFFICIAL/aiogram-storages",
    download_url="https://github.com/DIMFLIX-OFFICIAL/aiogram-storages/archive/refs/heads/main.zip",
    license="MIT License",
    packages=['aiogram-storages'],
