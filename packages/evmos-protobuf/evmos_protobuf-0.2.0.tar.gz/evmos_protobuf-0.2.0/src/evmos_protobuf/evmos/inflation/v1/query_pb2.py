...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYINFLATIONRATERESPONSE.fields_by_name['inflation_rate']._serialized_options = b'\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Dec\xc8\xde\x1f\x00'
