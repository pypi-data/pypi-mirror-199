...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYCLAIMSRECORDRESPONSE.fields_by_name['initial_claimable_amount']._serialized_options = b'\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Int\xc8\xde\x1f\x00'
