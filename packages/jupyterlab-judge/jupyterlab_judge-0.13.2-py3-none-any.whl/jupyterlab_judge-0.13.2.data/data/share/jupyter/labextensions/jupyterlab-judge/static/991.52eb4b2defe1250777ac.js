"use strict";(self.webpackChunkjupyterlab_judge=self.webpackChunkjupyterlab_judge||[]).push([[991],{4991:(e,t,s)=>{s.r(t),s.d(t,{IJudgePanelFactoryRegistry:()=>he,IJudgeSignal:()=>ge,IProblemProviderRegistry:()=>me,default:()=>xe,openOrCreateFromId:()=>re});var n=s(9239),o=s(2884),i=s(8604),r=s(3215),a=s(5257),l=s(4221),d=s(4003),u=s(9713),c=s(3849),m=s(6271),h=s.n(m);const g="jupyterlab-judge",p="judgedrive",b=".jce-judge",_="jupyterlab-judge";var C;!function(e){function t(e,t){const s=t.load(g);function n(){if(e.context.model.readOnly)return(0,o.showDialog)({title:s.__("Cannot Save"),body:s.__("Document is read-only"),buttons:[o.Dialog.okButton({label:s.__("Ok")})]});e.context.save().then((()=>{if(!e.isDisposed)return e.context.createCheckpoint()}))}return(0,o.addToolbarButtonClass)(o.ReactWidget.create(m.createElement(o.UseSignal,{signal:e.context.fileChanged},(()=>m.createElement(o.ToolbarButtonComponent,{icon:r.saveIcon,onClick:n,tooltip:s.__("Save the judge contents and create checkpoint"),enabled:!!(e&&e.context&&e.context.contentsModel&&e.context.contentsModel.writable)})))))}e.createSaveButton=t,e.getDefaultItems=function(e,s,n){return[{name:"save",widget:t(e,s)}]}}(C||(C={}));var y=s(1431);const f="jp-OutputArea-output";class w extends c.OutputArea{constructor(e){super(e),this.addClass("jp-JudgeOutputArea");const t=e.translator.load(g),s=document.createElement("div");s.className="jp-JudgeOutputArea-placeholder",s.textContent=t.__("Execution result will be shown here"),this.node.appendChild(s)}createOutputItem(e){const t=this.createRenderedMimetype(e);return t&&t.addClass(f),t}onInputRequest(e,t){const s=this.contentFactory,n=e.content.prompt,o=e.content.password,i=new y.Panel;i.addClass("jp-OutputArea-child"),i.addClass("jp-OutputArea-stdin-item");const r=s.createStdin({prompt:n,password:o,future:t});r.addClass(f),i.addWidget(r),this.layout.addWidget(i),r.value.then((e=>{this.model.add({output_type:"stream",name:"stdin",text:e+"\n"}),i.dispose()}))}}class x extends y.Panel{constructor(e){super(),this.addClass("jp-JudgeTerminal");const t=e.translator.load(g),s=new y.Widget;s.addClass("jp-JudgeTerminal-toolbar");const n=document.createElement("button");n.className="jp-JudgeTerminal-executeButton",r.runIcon.element({container:n});const o=document.createElement("span");o.className="jp-JudgeTerminal-executeButtonLabel",o.textContent=t.__("Execute"),n.addEventListener("click",(async()=>{n.disabled=!0;try{await e.panel.execute()}catch(e){throw n.disabled=!1,e}n.disabled=!1})),n.appendChild(o);const i=document.createElement("div");i.className="jp-JudgeTerminal-seperator";const a=document.createElement("button");a.className="jp-JudgeTerminal-stopButton",r.stopIcon.element({container:a});const l=document.createElement("span");l.className="jp-JudgeTerminal-stopButtonLabel",l.textContent=t.__("Stop"),a.addEventListener("click",(async()=>{var t,s;await(null===(s=null===(t=e.panel.session.session)||void 0===t?void 0:t.kernel)||void 0===s?void 0:s.interrupt())})),a.appendChild(l),s.node.appendChild(n),s.node.appendChild(i),s.node.appendChild(a),this.addWidget(s),this._outputArea=new w(e),this.addWidget(this._outputArea)}get outputArea(){return this._outputArea}}var v=s(3848),S=s(8149),j=s.n(S);const P=j().div`
...
`;var k=s(6848);const E=j().span``,M=j().li`
  display: flex;
  padding: 5px 12px;
  height: 16px;
  ...
  font-size: 12px;
  line-height: 16px;
`,T=j()((function(e){const t=(0,m.useContext)(Q);let s="",n="";switch(e.status){case"AC":s=`👍 ${t.__("Accepted")}`;break;case"WA":s=`❌ ${t.__("Wrong")}`,n=`(${e.acceptedCount}/${e.totalCount})`;break;case"RE":s=`🚫 ${t.__("Error")}`;break;case"TLE":s=`🕓 ${t.__("Time Limit")}`;break;case"OLE":s=`👀 ${t.__("Output Limit")}`;break;case"IE":s=`☠ ${t.__("Please Try Again")}`}return h().createElement(E,{className:e.className,title:n},s)}))`
  height: 16px;
  flex-grow: 0;
  flex-shrink: 0;
...
`,A=j().span``,F=j().li`
  ...
  font-size: 12px;
  line-height: 16px;
`,J=j()((function(e){const{status:t}=e,s=(0,m.useContext)(Q);return t.inProgress?h().createElement(A,{className:e.className},`⌛ ${s.__("In Progress")} (${t.runCount}/${t.totalCount})`):h().createElement(h().Fragment,null)}))`
  height: 16px;
  flex-grow: 0;
  flex-shrink: 0;
  ...
  width: 101px;
  margin-right: 8px;
`;function R(e){const t=(0,m.useContext)(Q);if(null===e.problemId)return h().createElement(L,{className:e.className},"⌛ ",t.__("Loading History"));const{data:s,isLoading:n}=(0,v.useQuery)(["submissions",e.problemId],e.getSubmissions);if(n)return h().createElement(L,{className:e.className},"⌛ ",t.__("Loading History"));if(void 0===s)return h().createElement(L,{className:e.className},"🚫 ",t.__("History Not Available"));const o=e.submissionStatus&&e.submissionStatus.inProgress;return 0!==s.length||o?h().createElement(D,{className:e.className},e.submissionStatus&&e.submissionStatus.inProgress&&h().createElement(W,{status:e.submissionStatus}),s.map((t=>h().createElement($,{submission:t,key:t.id,setCode:e.setCode})))):h().createElement(B,{className:e.className},t.__("Submit your code to get results here."))}const D=j().ul`
...
`,$=j()((function(e){const t=(0,m.useContext)(Q);let s=k.Time.formatHuman(new Date(e.submission.createdAt)),n=k.Time.format(new Date(e.submission.createdAt),"lll");return h().createElement(M,{className:e.className},h().createElement(T,{status:e.submission.status,acceptedCount:e.submission.acceptedCount,totalCount:e.submission.totalCount}),h().createElement(N,{onClick:()=>{e.setCode(e.submission.code)},title:e.submission.code.substring(0,1e3)},t.__("Load this submission")),h().createElement(O,{title:n},s))}))``,W=j()((function(e){return h().createElement(F,{className:e.className},h().createElement(J,{status:e.status}))}))``,L=j().div`
  text-align: center;
  padding: 5px;
