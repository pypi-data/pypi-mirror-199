...
from typing import List, Type, Union, NewType, Sequence
...
from nlpipes.data.data_types import Corpus, Token


class VocabAugmentor():
    """Find new tokens to add to the :obj:`tokenizer`'s vocabulary.
    A new vocabulary is learnt from the training corpus using the
    same tokenization model. The most common tokens of this new 
    vocabulary that do not exist in the existing vocabulary are 
    selected
    """
    ...
    def __init__(self,
        ...
        Raises:
            ValueError: If :obj:`target_vocab_size` is larger or equal to the
                        existing vocabulary of :obj:`tokenizer`
    ...
    def get_new_tokens(
        ...
        New tokens contains the most common tokens that do not exist in 
        the :obj:`tokenizer`'s vocabulary.
        Args:
