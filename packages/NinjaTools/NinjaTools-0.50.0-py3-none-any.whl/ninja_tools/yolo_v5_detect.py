...
class Detect:
    def __init__(self, torch, weights, threshold, iou: float = 0.7, force_reload: bool = False, use_sort: bool = True):
    ...
    def detect(self, img) -> list:
        ...
        for track in tracked_objects:
            ...
            detected_rectangles.append({
                'track_id': track_id,  # Object's unique track ID (if SORT is enabled) or None
