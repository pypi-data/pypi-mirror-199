...
class RotationTransform:
    """Rotates the sharp and blur image in a sample by one of the given
    angles.
    ...
    def __call__(self, sample):
        """Rotates that sharp and blur image in a sample by one of the given 
        angles. 
...
class RandomHorizontalFlip:
    """Flips the sharp and blur image in a sample horizontally with a specified
    probability.
    ...
    def __call__(self, sample):
        """Flips the sharp and blur image in a sample horizontally with a 
...
class RandomVerticalFlip:
    """Flips the sharp and blur image in a sample vertically with a specified
    probability.
    ...
    def __call__(self, sample):
        """Flips the sharp and blur image in a sample vertically with a 
        specified probability.
...
class RandomSwapColorChannels:
    """Randomly swaps the color channels of the sharp and blur image in a 
    sample.
    """
...
class RandomSaturation:
    """Randomly adjust saturation of the sharp and blur image in sample with a 
    specified probability.
...
class RandomCutout:
    """Randomly masks out a number of square regions from the sharp and blur 
    image in a sample.
...
class RandomBlend:
    """ Adds one of the given pixel values to the sharp and blur image in a 
    sample with a specified probability.
...
class RandomBrightness:
    """Randomly adjust brightness of the sharp and blur image in sample with a 
    specified probability. 
    ...
    def __call__(self, sample):
        """Randomly adjust saturation of the sharp and blur image in sample with 
...
class RandomContrast:
    """Randomly adjust contrast of the sharp and blur image in sample with a 
    specified probability.
    ...
    def __call__(self, sample):
        """Randomly adjust constrast of the sharp and blur image in sample with 
        a specified probability.
...
class RandomHue:
    """Randomly adjust chue of the sharp and blur image in sample with a 
    specified probability.
    ...
    def __call__(self, sample):
        """Randomly adjust hue of the sharp and blur image in sample with 
        a specified probability.
