from trainers.srn import SRNTrainer
from testers.srn import SRNTester


def default_train(checkpoint_save_name, train_img_dir, val_img_dir=None, batch_size=16, epochs=2000,
...
def default_test(model_path, test_img_dir, is_checkpoint=True, batch_size=16):
