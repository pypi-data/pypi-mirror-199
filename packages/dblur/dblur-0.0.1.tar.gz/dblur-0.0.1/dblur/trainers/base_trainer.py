...
from data.augment import RandomCrop
...
class BaseTrainer:
    ...
    def train(
        ...
        """Trains model and performs validation on model at a given frequency 
        given all the arguments listed below.
    ...
    def get_train_dataloader(self, dataset_path, transform=RandomCrop(256), batch_size=8):
        """Returns an instance of torch.utils.data.DataLoader used for training
        given the arguments specified below.
    ...
    def get_val_dataloader(self, dataset_path, transform=RandomCrop(256), batch_size=8):
        """Returns an instance of torch.utils.data.DataLoader used for 
        validation given the arguments specified below.
