...
from data.augment import RandomCrop, RandomHorizontalFlip, RotationTransform, RandomVerticalFlip
from trainers.base_trainer import BaseTrainer
from models.fnafnet import FNAFNet
from losses.fnafnet import FNAFNetLoss
...
class FNAFNetTrainer(BaseTrainer):
    ...
    def get_model(self, projected_in_channels=32, enc_num=[1, 1, 1, 28], middle_num=1, dec_num=[1, 1, 1, 1],
        ...
        """Returns an instance of the FNAFNet model based on the arguments
      specified below:
