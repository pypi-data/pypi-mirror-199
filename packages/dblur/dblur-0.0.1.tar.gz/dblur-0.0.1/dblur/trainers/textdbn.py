...
from data.augment import RandomCrop, RandomHorizontalFlip, RotationTransform
from trainers.base_trainer import BaseTrainer
from models.textdbn import TextDBN
from schedulers.textdbn import TextDBNScheduler
...
class TextDBNTrainer(BaseTrainer):
    ...
    def get_lr_scheduler(self, optimizer):
        """Returns learning rate scheduler specified in paper used for training 
        TextDBN"""
