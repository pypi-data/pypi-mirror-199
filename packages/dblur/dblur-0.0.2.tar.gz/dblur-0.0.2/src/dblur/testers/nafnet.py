...
from losses.psnr_loss import PSNRLoss
import torch
...
class NAFNetTester(BaseTester):
    ...
    def get_model(self, projected_in_channels=32, enc_num=[1, 1, 1, 28], middle_num=1, dec_num=[1, 1, 1, 1],
        ...
        """Returns an instance of the NAFNet model based on the arguments 
        specified below:
    ...
    def get_loss(self, psnr=False):
        """Returns PSNR Loss which is used for training NAFNet. Alternatively, 
        returns MSE Loss if argument psnr = False."""
