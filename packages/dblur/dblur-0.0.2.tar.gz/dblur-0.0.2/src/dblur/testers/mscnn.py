...
from losses.mscnn import MSCNNLoss
import torch
...
class MSCNNTester(BaseTester):
    ...
    def deblur_imgs(self, model, model_path, blur_img_dir, sharp_img_dir, batch_size=2, is_checkpoint=False,
                    mscnn=False, window_slicing=False, window_size=256, overlap_size=0):
        """See base class"""
    ...
    def deblur_single_img(self, model, model_path, blur_img_path, sharp_img_path, is_checkpoint=False, mscnn=True,
