...
from losses.srn import SRNLoss
...
class SRNTrainer(BaseTrainer):
    ...
    def get_optimizer(self, params, learning_rate=1e-4, betas=(0.9, 0.999), weight_decay=0, eps=1e-08):
        ...
        return torch.optim.Adam(params, lr=learning_rate, betas=betas, eps=eps, weight_decay=weight_decay)
