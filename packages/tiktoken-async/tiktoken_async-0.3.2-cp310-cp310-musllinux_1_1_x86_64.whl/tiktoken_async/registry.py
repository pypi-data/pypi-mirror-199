...
import tiktoken_async_ext

from tiktoken_async.core import Encoding

_lock = threading.RLock()
ENCODINGS: dict[str, Encoding] = {}
ENCODING_CONSTRUCTORS: Optional[
...
def _find_constructors() -> None:
    ...
    with _lock:
        ...
        plugin_mods = pkgutil.iter_modules(
            tiktoken_async_ext.__path__, tiktoken_async_ext.__name__ + "."
        )
...
async def get_encoding(encoding_name: str) -> Encoding:
