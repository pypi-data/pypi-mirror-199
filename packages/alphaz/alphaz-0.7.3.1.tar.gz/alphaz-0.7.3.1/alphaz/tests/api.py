...
class TAPI(AlphaTest):
    ...
    def test_status_none_description_none(self):
        ...
        answer = self.get_api_answer(route="/test/status", method="GET", params=params)
    ...
    def alpha_exception_no_name(self):
        ...
        self.assert_equal(answer.error, True)
        self.assert_equal(answer.warning, False)
    ...
    def alpha_exception(self):
        ...
        self.assert_equal(answer.status_description, params["description"])
        self.assert_equal(answer.status, params["name"])
        self.assert_equal(answer.error, True)
        self.assert_equal(answer.warning, False)
    ...
    def alpha_exception_warning(self):
        ...
        self.assert_equal(answer.status_description, params["description"])
        self.assert_equal(answer.status, params["name"])
        self.assert_equal(answer.error, False)
        self.assert_equal(answer.warning, True)
    ...
    def auth_su_auto_user_name(self):
        answer = self.get_api_answer(route="user/infos")
