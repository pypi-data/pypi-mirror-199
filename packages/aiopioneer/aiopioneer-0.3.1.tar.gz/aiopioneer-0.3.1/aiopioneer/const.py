...
LISTENING_MODES = {
    ...
    "0023": ["PRO LOGIC2x MOVIE", False, True],
    "0024": ["PRO LOGIC2x MUSIC", False, True],
    ...
    "0034": ["PRO LOGIC2z HEIGHT", False, True],
    "0035": ["WIDE SURROUND MOVIE", False, True],
    "0036": ["WIDE SURROUND MUSIC", False, True],
    ...
    "0043": ["Neo:X CINEMA ", False, True],
    "0044": ["Neo:X MUSIC", False, True],
    "0045": ["Neo:X GAME", False, True],
    ...
    "0058": ["PL2x MOVIE + THX CINEMA", False, True],
    ...
    "0064": ["THX SELECT2 GAMES", False, True],
    "0065": ["THX ULTRA2 CINEMA", False, True],
    "0066": ["THX ULTRA2 MUSIC", False, True],
    "0067": ["ES 8ch DISCRETE + THX CINEMA", False, True],
    "0068": ["THX CINEMA", True, False],
    "0069": ["THX MUSIC", True, False],
    "0070": ["THX GAMES", True, False],
    ...
    "0079": ["THX ULTRA2 GAMES", False, True],
    "0080": ["THX MUSIC", False, True],
    "0081": ["THX GAMES", False, True],
    "0082": ["PL2x MUSIC + THX MUSIC", False, True],
    ...
    "0095": ["PL2z HEIGHT + THX CINEMA", False, True],
    "0096": ["PL2z HEIGHT + THX MUSIC", False, True],
    "0097": ["PL2z HEIGHT + THX GAMES", False, True],
    ...
    "0204": ["Neo:X CINEMA + THX CINEMA", False, True],
    "0205": ["Neo:X MUSIC + THX MUSIC", False, True],
    "0206": ["Neo:X GAME + THX GAMES", False, True],
