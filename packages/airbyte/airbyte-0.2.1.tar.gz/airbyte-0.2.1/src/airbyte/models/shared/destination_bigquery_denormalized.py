...
class DestinationBigqueryDenormalized:
    ...
    airbyte_destination_name: DestinationBigqueryDenormalizedBigqueryDenormalizedEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('airbyte-destination-name') }})  
