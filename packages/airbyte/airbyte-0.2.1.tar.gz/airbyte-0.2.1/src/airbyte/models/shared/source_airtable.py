...
class SourceAirtableCredentialsAPIKey:
    ...
    r"""The API Key or PAT for the Airtable account. See the <a href=\"https://airtable.com/developers/web/guides/personal-access-tokens\">Support Guide</a> for more information on how to obtain this key."""  
