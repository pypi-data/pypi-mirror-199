...
class DestinationOracle:
    ...
    airbyte_destination_name: DestinationOracleOracleEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('airbyte-destination-name') }})  
