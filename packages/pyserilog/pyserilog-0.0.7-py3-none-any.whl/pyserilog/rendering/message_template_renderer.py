...
class MessageTemplateRenderer:
    ...
    @staticmethod
    def render(message_template: message_template, properties: dict[str, LogEventPropertyValue], output: StringIO,
    ...
    @staticmethod
    def render_value(property_value: LogEventPropertyValue, is_literal: bool, is_json: bool, output: StringIO,
