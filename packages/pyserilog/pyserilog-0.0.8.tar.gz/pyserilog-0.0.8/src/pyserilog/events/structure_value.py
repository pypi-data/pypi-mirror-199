...
class StructureValue(LogEventPropertyValue):
    ...
    def render(self, output: StringIOWritable, text_format: str | None = None, formatter: Callable[[object], str] = None):
    ...
    @staticmethod
    def _render(prop: LogEventProperty, output: StringIOWritable, text_format: str | None = None,
