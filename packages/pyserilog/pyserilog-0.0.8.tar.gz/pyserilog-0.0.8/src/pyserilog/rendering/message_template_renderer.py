...
class MessageTemplateRenderer:
    ...
    @staticmethod
    def render(message_template: message_template, properties: dict[str, LogEventPropertyValue], output: StringIOWritable,
    ...
    @staticmethod
    def render_text_token(token: TextToken, output: StringIOWritable):
        output.write(token.text)

    @staticmethod
    def render_property_token(pt: PropertyToken, properties: dict[str, LogEventPropertyValue],
                              output: StringIOWritable, is_literal: bool, is_json: bool):
    ...
    @staticmethod
    def render_value(property_value: LogEventPropertyValue, is_literal: bool, is_json: bool, output: StringIOWritable,
