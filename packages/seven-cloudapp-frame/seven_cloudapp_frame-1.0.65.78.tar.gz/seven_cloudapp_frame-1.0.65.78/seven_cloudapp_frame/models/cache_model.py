...
@LastEditTime: 2023-03-28 14:50:47
...
class CacheModel(BaseModel):
    ...
    def get_dependency_cache(self, dependency_key, cache_key):
        ...
        if not cache_data:
            ...
            self.log_cache(dependency_key, cache_key, cache_data)
            return cache_data
        else:
    ...
    def log_cache(self, dependency_key, cache_key, cache_data):
        """
        ...
        if hasattr(self, "db"):
            if hasattr(self.db, "context"):
                if hasattr(self.db.context, "logging_link_info"):
                    log_info = {"dependency_key":dependency_key, "cache_key":cache_key, "cache_data":cache_data}
