...
class MongoQueue(BaseQueue):
    ...
    async def ensure_indexes(self):
        ...
        coll = await self.tasks_collection()
    ...
    async def tasks_collection(self) -> AsyncIOMotorCollection:
        _db = await db()
        return _db.meta.conn[self._cfg.tasks_collection]
