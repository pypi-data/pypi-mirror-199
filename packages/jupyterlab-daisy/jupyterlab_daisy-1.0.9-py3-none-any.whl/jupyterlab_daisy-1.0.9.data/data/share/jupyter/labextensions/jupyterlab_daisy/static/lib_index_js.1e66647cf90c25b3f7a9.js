...
async function requestAPI(endPoint = '', init = {}) {
    ...
    if (data.length > 0) {
        ...
        throw new _jupyterlab_services__WEBPACK_IMPORTED_MODULE_1__.ServerConnection.ResponseError(response, "The response was empty (API should throw 404 though...)");
    }
    if (!response.ok) {
    ...
    populateListRelated(source_asset_name, target_asset_names, list) {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)(`get-related?source_asset_id=${source_asset_name}&target_asset_ids=${target_asset_names.join(',')}`)
            ...
            if (reason.message.includes('400')) {
                ...
                notFound.textContent = "Make sure the source is different from the related tables...";
            }
...
//# sourceMappingURL=lib_index_js.1e66647cf90c25b3f7a9.js.map