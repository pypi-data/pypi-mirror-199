    ...
    populateListRelated(source_asset_name, target_asset_names, list) {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)(`get-related?source_asset_id=${source_asset_name}&target_asset_ids=${target_asset_names.join(',')}`)
            ...
            (_a = json['RelatedTables']) === null || _a === void 0 ? void 0 : _a.forEach((entry) => {
                ...
                const itemName = `${splitLinks[0][splitLinks[0].length - 2]}/${splitLinks[0][splitLinks[0].length - 1]} -> ${splitLinks[splitLinks.length - 1][0]}/${splitLinks[splitLinks.length - 1][splitLinks[splitLinks.length - 1].length - 1]}`;
...
//# sourceMappingURL=lib_index_js.0af77d5efd50ee3947e2.js.map