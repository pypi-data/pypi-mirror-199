...
from foalorm import orm
from foalorm.utils import cached_property
from foalorm.orm.tests.testutils import raises_exception
from foalorm.orm.tests import db_params, setup_database, teardown_database
...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        foalorm.options.INNER_JOIN_SYNTAX = True
