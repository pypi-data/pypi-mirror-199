...
import foalorm
from foalorm.utils import is_utf8, decorator, throw, localbase, deprecated
from foalorm.converting import str2date, str2time, str2datetime, str2timedelta
from foalorm.orm.ormtypes import LongStr, LongUnicode, RawSQLType, TrackedValue, TrackedArray, Json, QueryType, Array
...
class DBAPIProvider(object):
    ...
    def __init__(provider, _database, *args, **kwargs):
        ...
        pool_mockup = kwargs.pop('foalorm_pool_mockup', None)
        call_on_connect = kwargs.pop('foalorm_call_on_connect', None)
