...
from foalorm.orm.tests import db_params, teardown_database
...
class TestIndexes(unittest.TestCase):
    ...
    def test_1(self):
        ...
        table_name = 'Person' if db.provider.dialect == 'SQLite' and foalorm.__version__ < '0.9' else 'person'
