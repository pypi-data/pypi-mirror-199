...
from foalorm.orm.core import Attribute
from foalorm.orm.tests.testutils import *
from foalorm.orm.tests import db_params, only_for, setup_database, teardown_database
...
class TestAttribute(unittest.TestCase):
    ...
    def test_attribute24(self):
        ...
        table_name = 'Entity1' if db.provider.dialect == 'SQLite' and foalorm.__version__ < '0.9' else 'entity1'
