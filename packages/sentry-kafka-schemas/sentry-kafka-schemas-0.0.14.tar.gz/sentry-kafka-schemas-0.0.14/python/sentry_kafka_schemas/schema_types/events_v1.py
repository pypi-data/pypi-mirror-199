from typing import TypedDict, Tuple, Dict, Union, Literal, Any, List
...
class _BaseGen498031(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
