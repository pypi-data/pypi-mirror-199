from typing import Any, Literal, Dict, Union, Tuple, TypedDict, List
...
class _BaseGen604293(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
