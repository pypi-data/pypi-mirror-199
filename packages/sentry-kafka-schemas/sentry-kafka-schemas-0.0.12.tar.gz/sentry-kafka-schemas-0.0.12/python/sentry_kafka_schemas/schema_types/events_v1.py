from typing import TypedDict, Tuple, Any, Union, Dict, List, Literal
...
class _BaseGen735015(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
