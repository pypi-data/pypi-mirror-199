from typing import TypedDict, Union, Literal, Tuple, Any, List, Dict
...
class _BaseGen894590(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
