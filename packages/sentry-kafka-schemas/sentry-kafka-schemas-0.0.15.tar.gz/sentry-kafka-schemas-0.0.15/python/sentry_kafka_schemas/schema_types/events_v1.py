from typing import Literal, Any, List, Dict, Union, TypedDict, Tuple
...
class _BaseGen628878(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
