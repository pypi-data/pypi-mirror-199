from typing import Any, Union, TypedDict, Literal, Dict, Tuple, List
...
class _BaseGen58336(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
