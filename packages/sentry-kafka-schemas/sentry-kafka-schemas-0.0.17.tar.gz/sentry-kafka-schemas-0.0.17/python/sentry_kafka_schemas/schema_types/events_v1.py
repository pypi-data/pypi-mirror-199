from typing import Any, Tuple, Dict, TypedDict, Union, Literal, List
...
class _BaseGen417138(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
