...
__version__ = importlib.metadata.version("pymedquery")
...
class PyMedQuery:
    ...
    def _check_version(self):
        ...
        try:
            ...
            if str(__version__) != str(latest_version):
                self.log.warning(
                    f"A new version is available! Current version: {__version__} and the latest version is {latest_version}"
                )
