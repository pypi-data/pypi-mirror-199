...
def show_dbs():
    ...
    dbs = mc.list_database_names() # ', 'list_databasesdatabase_names
    for d in dbs:
        dbc = mc[d]
        
        collections = dbc.list_collection_names()
...
def create_mongo_db(database_name, collection_name, initial_document):
    ...
    try:
        ...
        collection.insert_one(d, bypass_document_validation=False)
