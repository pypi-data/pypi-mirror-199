from FeSeEL import FeatureAnalysis
from FeSeEL.utils import get_categorical_features
from FeSeEL.elimination.shap_rfe import Shap_RFE_full
import warnings
import pandas as pd
...
class FeatureElimination(FeatureAnalysis):
    ...
    def extract_features(self, selection_rule="decrease_perf", number_feat_rep=None):
        ...
        Args:
            ...
            number_feat_rep (_type_, optional): valid only for the selection_rule "num_feat", determines the number of features to be extracted according to the report. Defaults to None.
