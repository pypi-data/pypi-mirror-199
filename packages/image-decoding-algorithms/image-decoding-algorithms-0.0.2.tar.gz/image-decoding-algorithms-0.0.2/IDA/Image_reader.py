...
class Image(object):
    ...
    def __init__(self, ImageWidth: int, ImageHeight: int, ImageBitDepth: int,
                                                        ImageChannelsAmount: int, ImageData: List[List[List[int]]]):
        self.width = ImageWidth
        self.height = ImageHeight
        self.bit_depth = ImageBitDepth
        self.channels_amount = ImageChannelsAmount
        self.data = ImageData