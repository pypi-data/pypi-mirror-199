...
async def youtube(
    ...
    if from_date:
        ...
        comments = [comment for comment in comments if comment.published_at > from_date]
    ...
    if send_to == "slack":
        ...
        await asyncio.gather(
            *[
                slack_service.send_message(message=comment_to_message(comment=comment))
...
def get_last_execution(filename: str) -> datetime | None:
    try:
