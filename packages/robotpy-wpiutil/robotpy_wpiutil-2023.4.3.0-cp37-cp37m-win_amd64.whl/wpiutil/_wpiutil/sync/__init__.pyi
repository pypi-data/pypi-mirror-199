...
def destroySignalObject(handle: int) -> None:
    ...
    :param handle: handle
    """
def releaseSemaphore(handle: int, releaseCount: int = 1) -> typing.Tuple[bool, int]:
    """
...
def waitForObject(handle: int) -> bool:
    ...
    """
@typing.overload
def waitForObject(handle: int, timeout: float) -> typing.Tuple[bool, bool]:
    pass
@typing.overload
def waitForObjects(handles: typing.List[int]) -> typing.List[int]:
    """
    ...
    """
@typing.overload
def waitForObjects(handles: typing.List[int], timeout: float) -> typing.Tuple[typing.List[int], bool]:
    pass
