...
class RoomCompensationProperties(object):
    ...
    def __init__(
        self,
        value: Optional["RoomCompensationProperties.LTypeValue"] = None,
        ...
        """RoomCompensationProperties - a model defined in OpenAPI"""  # noqa: E501
    ...
    LTypeValue = Literal["simple", "advanced"]

    @property
    def value(self):
        # type: () -> 'RoomCompensationProperties.LTypeValue'
        """Gets the value of this RoomCompensationProperties.  # noqa: E501

        The type of roomcompensation used / to use. simple:   For speakers without external speakers. advanced:   For products with external speakers or other advanced multichannel capabilities.   This requries that at least action in the other properties of RoomCompensationProperties is set.   # noqa: E501

        :return: The value of this RoomCompensationProperties.  # noqa: E501
        :rtype: 'RoomCompensationProperties.LTypeValue'
        """
        return self._value

    @value.setter
    def value(self, value):
        # type: ('RoomCompensationProperties.LTypeValue') -> None
        """Sets the value of this RoomCompensationProperties.

        The type of roomcompensation used / to use. simple:   For speakers without external speakers. advanced:   For products with external speakers or other advanced multichannel capabilities.   This requries that at least action in the other properties of RoomCompensationProperties is set.   # noqa: E501

        :param value: The value of this RoomCompensationProperties.  # noqa: E501
        :type value: 'RoomCompensationProperties.LTypeValue'
        :rtype: None
        """
        allowed_values = ["simple", "advanced"]  # noqa: E501
        if (
    ...
    def action(self):
        # type: () -> str
        """Gets the action of this RoomCompensationProperties.  # noqa: E501
        ...
        :return: The action of this RoomCompensationProperties.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        # type: (str) -> None
        """Sets the action of this RoomCompensationProperties.

        Must be set if room compensation type is advanced. runAll:   Do measurements on all connected speakers. continue:   Continue from and including the speaker where last interrupted (stopped or failed). useSpeakerList:   Do measurements on the speakers in the list property.   # noqa: E501

        :param action: The action of this RoomCompensationProperties.  # noqa: E501
        :type action: str
        :rtype: None
        """
    ...
    def continue_on_error(self):
        # type: () -> bool
        """Gets the continue_on_error of this RoomCompensationProperties.  # noqa: E501
        ...
        :return: The continue_on_error of this RoomCompensationProperties.  # noqa: E501
        :rtype: bool
        """
    ...
    def continue_on_error(self, continue_on_error):
        # type: (bool) -> None
        """Sets the continue_on_error of this RoomCompensationProperties.

        On failing measurement on a speaker, default behavior is to stop measurement and skip the remaining speakers. Setting continueOnError to true will make the measuremnt process continue and finish measurement on all speakers, even though an error ocurred on one of the speakers.   # noqa: E501

        :param continue_on_error: The continue_on_error of this RoomCompensationProperties.  # noqa: E501
    ...
    def skip_automatic_role_assignment(self):
        # type: () -> bool
        """Gets the skip_automatic_role_assignment of this RoomCompensationProperties.  # noqa: E501

        Skip calculation of automatic role assignment.  # noqa: E501

        :return: The skip_automatic_role_assignment of this RoomCompensationProperties.  # noqa: E501
        :rtype: bool
        """
    ...
    def skip_automatic_role_assignment(self, skip_automatic_role_assignment):
        # type: (bool) -> None
        """Sets the skip_automatic_role_assignment of this RoomCompensationProperties.

        Skip calculation of automatic role assignment.  # noqa: E501

        :param skip_automatic_role_assignment: The skip_automatic_role_assignment of this RoomCompensationProperties.  # noqa: E501
    ...
    def speaker_list(self):
        # type: () -> List[str]
        """Gets the speaker_list of this RoomCompensationProperties.  # noqa: E501
        ...
        :return: The speaker_list of this RoomCompensationProperties.  # noqa: E501
        :rtype: List[str]
        """
    ...
    def speaker_list(self, speaker_list):
        # type: (list[str]) -> None
        """Sets the speaker_list of this RoomCompensationProperties.

        List of speaker IDs to include in room compensation / automatic role assignment measurement. Relevant e.g. if you want to create a speaker group without the external speakers included. This can not be used for doing measurements on a partial speaker group, only on all speakers in an existing group or for all speakers in a new group.   # noqa: E501

        :param speaker_list: The speaker_list of this RoomCompensationProperties.  # noqa: E501
    ...
    def speaker_preset(self):
        # type: () -> int
        """Gets the speaker_preset of this RoomCompensationProperties.  # noqa: E501

        The Powerlink preset to use for the external PL/WPL speakers.  # noqa: E501

        :return: The speaker_preset of this RoomCompensationProperties.  # noqa: E501
        :rtype: int
        """
    ...
    def speaker_preset(self, speaker_preset):
        # type: (int) -> None
        """Sets the speaker_preset of this RoomCompensationProperties.

        The Powerlink preset to use for the external PL/WPL speakers.  # noqa: E501

        :param speaker_preset: The speaker_preset of this RoomCompensationProperties.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RoomCompensationProperties):
            return False
