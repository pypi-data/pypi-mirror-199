...
def quick_explode(style: str = 'EXPLODE', amount: int = 100, frame_duration: int = 50, frame_start: int = 1, frame_end: int = 10, velocity: float = 1.0, fade: bool = True) -> None:
  ...
  :file:`startup/bl_operators/object_quick_effects.py\:229 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object_quick_effects.py#L229>`_
...
def quick_liquid(show_flows: bool = False) -> None:
  ...
  :file:`startup/bl_operators/object_quick_effects.py\:510 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object_quick_effects.py#L510>`_
...
def quick_smoke(style: str = 'SMOKE', show_flows: bool = False) -> None:
  ...
  :file:`startup/bl_operators/object_quick_effects.py\:405 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/object_quick_effects.py#L405>`_
