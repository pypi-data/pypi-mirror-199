...
class Run:
    ...
    def get_artifact(self, name: str, type: str, tag: str = "", team_name: str = "", exp_name: str = "") -> Tuple[
        int, ArtifactRecord]:
    ...
    def alert(self, title: str, level:str, message: str):
        return interface.send_alert(run_id=self.run_id, team_name=self.team_name, exp_name=self.exp_name, run_name=self.run_name, title=title, msssage=message, level=level)
