...
class Elementtemplate(object):
    ...
    def setNumberOfNodes(self, numberOfNodes):
    ...
    def defineFieldElementConstant(self, field, componentNumber):
        return _element.Elementtemplate_defineFieldElementConstant(self, field, componentNumber)

    def defineFieldSimpleNodal(self, field, componentNumber, basis, nodeIndexesCount):
        return _element.Elementtemplate_defineFieldSimpleNodal(self, field, componentNumber, basis, nodeIndexesCount)

    def setMapNodeValueLabel(self, field, componentNumber, basisNodeIndex, nodeFunctionIndex, nodeValueLabel):
    ...
    def setMapNodeVersion(self, field, componentNumber, basisNodeIndex, nodeFunctionIndex, versionNumber):
    ...
    def getNode(self, localNodeIndex):
        return _element.Elementtemplate_getNode(self, localNodeIndex)

    def setNode(self, localNodeIndex, node):
