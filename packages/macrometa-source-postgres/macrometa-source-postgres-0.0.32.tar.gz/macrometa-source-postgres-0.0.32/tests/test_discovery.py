...
from macrometa_source_postgres.discovery_utils import BASE_RECURSIVE_SCHEMAS
    ...
    def test_escaping_values(self):
        ...
        with get_test_connection() as conn:
            with conn.cursor() as cur:
                query = macrometa_source_postgres.sync_strategies.logical_replication.create_hstore_elem_query(elem)
