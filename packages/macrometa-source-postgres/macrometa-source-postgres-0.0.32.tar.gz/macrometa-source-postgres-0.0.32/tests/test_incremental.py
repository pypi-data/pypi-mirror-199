...
class TestIncremental(TestCase):
    ...
    @patch('macrometa_source_postgres.sync_strategies.incremental.post_db.hstore_available')
    @patch('psycopg2.extras.register_hstore')
    ...
    @patch("macrometa_source_postgres.sync_strategies.incremental.singer.write_message")
    @patch("psycopg2.extras.register_hstore")
