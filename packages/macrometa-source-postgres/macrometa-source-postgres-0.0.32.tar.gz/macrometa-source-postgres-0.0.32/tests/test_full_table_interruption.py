...
import macrometa_source_postgres.sync_strategies.common as pg_common
import macrometa_source_postgres.sync_strategies.full_table as full_table
...
@pytest.mark.skip(reason="With the change of commit "
                         "cd875142df52897a9c44f2ba6af3ba4925fc5f04 "
...
class TestLogicalInterruption:
    ...
    def test_catalog(self, mock_connect, use_secondary):
        ...
        try:
            macrometa_source_postgres.do_sync(get_test_connection_config(use_secondary=use_secondary), {'streams': streams},
                                              None, state)
        except Exception:
            blew_up_on_cow = True
        ...
        COW_RECORD_COUNT = 0
        CAUGHT_MESSAGES.clear()
        macrometa_source_postgres.do_sync(get_test_connection_config(use_secondary=use_secondary), {'streams': streams}, None,
                                          old_state)
