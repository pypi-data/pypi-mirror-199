...
from xj_finance.services.finance_transact_service import FinanceTransactService, DateEncoder
    ...
    def finance_standing_book(params):
        ...
        for i in enroll_id_list:
            ...
            invoice_set = transact_obj.filter(
                sand_box__sand_box_name__in=["BID_SPECIAL_INVOICE", "BID_PLAIN_INVOICE"], ).order_by("-id").values(
                "goods_info")
            if not invoice_set:
                continue
