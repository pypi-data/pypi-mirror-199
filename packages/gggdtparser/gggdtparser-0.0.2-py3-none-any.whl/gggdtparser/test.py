...
has_test_string_datetime = {
    ...
    '前天': {
        ...
        'un_accurately': datetime.datetime(
            ...
            minute=now.minute, second=now.second) - datetime.timedelta(days=2),
    },
    '前天02:02:02': {
        'accurately': datetime.datetime(
            year=now.year, month=now.month, day=now.day, hour=2,
    ...
    '2月前': {
        ...
        'un_accurately': (datetime.datetime(
            year=now.year, month=now.month, day=now.day, hour=now.hour,
            minute=now.minute, second=now.second) -
                          datetime.timedelta(days=30 * 3), datetime.datetime(
            year=now.year, month=now.month, day=now.day, hour=now.hour,
            minute=now.minute, second=now.second) -
                          datetime.timedelta(days=30 * 2)),
    },
    ...
    '2月内': {
        ...
        'un_accurately': (datetime.datetime(
            year=now.year, month=now.month, day=now.day, hour=now.hour,
            minute=now.minute, second=now.second) -
                          datetime.timedelta(days=30 * 2), datetime.datetime(
            year=now.year, month=now.month, day=now.day, hour=now.hour,
            minute=now.minute, second=now.second) -
