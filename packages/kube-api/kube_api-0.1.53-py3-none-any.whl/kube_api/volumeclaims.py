...
class VolumeClaim:
    ...
    """
    def __init__(self, claim_name, disk_space, namespace='default', storage_class="standard-fc", access_modes=['ReadWriteOnce']):
        """ Initialize a VolumeClaim object
        """
        self.name = claim_name
        self.namespace = namespace
        self.vc_spec = dict(access_modes=access_modes, storage_class_name=storage_class)
