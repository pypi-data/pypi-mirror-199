...
def multcompCatplot(**kwargs):
    ...
    if "addPoints" in kwargs:
        ...
        coloredObject = "box"
        addPoints = False
    if "coloredObject" in kwargs:
        coloredObject = kwargs["coloredObject"]
        del kwargs["coloredObject"]
    if "pointArgs" in kwargs:
        pointArgs = kwargs["pointArgs"]
        del kwargs["pointArgs"]
    elif "pointSize" in kwargs:
        pointArgs = {"size": kwargs["pointSize"], "linewidth":1}
