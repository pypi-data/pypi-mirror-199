...
<https://docs.djangoproject.com/en/4.1/ref/models/querysets/#order-by>`__
method in order to sort the rows of the queryset.
    ...
    `filter
    <https://docs.djangoproject.com/en/4.1/ref/models/querysets/#filter>`__
    method.
    ...
    <https://docs.djangoproject.com/en/4.1/topics/db/queries/#field-lookups>`_
    ...
    `exclude
    <https://docs.djangoproject.com/en/4.1/ref/models/querysets/#exclude>`__
