...
from operbot.generic import format
from operbot.objects import Object, keys, update
from operbot.message import Message
from operbot.storage import Storage, find, last, save
from operbot.threads import launch
from operbot.utility import elapsed, fntime, locked
...
class Config(Default):
    ...
    password = ''
    port = 6667
    realname = 'program your own command'
    sasl = False
    server = 'localhost'
    servermodes = ''
    sleep = 60
