...
# aspyright: reportMissingModuleSource=false

from __future__ import annotations

try:
    from svg_ultralight import new_element, new_sub_element, new_svg_root, write_svg
...
from snap_pslg.bounding_boxes import get_pixel_bbox, get_segment_bbox
from snap_pslg.helpers import get_unique_items
from snap_pslg.type_hints import IntPoint, IntSegment, Vec2, Vecs2

POINT_ATTRIB = dict(fill="red", opacity=0.5)
EDGE_ATTRIB = dict(
    stroke="gray", stroke_linecap="round", stroke_width=0.25, opacity=0.5
)
TEXT_ATTRIB = dict(font_size=0.35, fill="black", font_family="monospace")
