...
class TMOP_Metric_328(TMOP_Combo_QualityMetric):
    ...
    def __init__(self, gamma):
        r"""__init__(TMOP_Metric_328 self, double gamma) -> TMOP_Metric_328"""
        _tmop.TMOP_Metric_328_swiginit(self, _tmop.new_TMOP_Metric_328(gamma))
...
class TMOP_Integrator(mfem._ser.nonlininteg.NonlinearFormIntegrator):
    ...
    def EnableSurfaceFitting(self, s0, smarker, coeff, ae):
        r"""EnableSurfaceFitting(TMOP_Integrator self, GridFunction s0, boolArray smarker, Coefficient coeff, AdaptivityEvaluator ae)"""
        return _tmop.TMOP_Integrator_EnableSurfaceFitting(self, s0, smarker, coeff, ae)
