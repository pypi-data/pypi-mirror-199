                            ...
                            for te in self.temp[symbol]:
                                if bartype==BarType.DK:
                                    ...
                                    if te["DateTime"]<=bar[-1]['DateTime']:
                                        ...
                                        ktemp={}
                                        if (bar[-1]['DateTime']-te["DateTime"]).total_seconds()<interval*60:
                                            ...
                                            ktemp["DateTime"]=opentime+math.ceil((te["DateTime"]-opentime).total_seconds()/(interval*60))*interval*60
                                        ktemp["Symbol"]=symbol
                                        ktemp["Open"]=te["Close"]
                                        ktemp["High"]=te["Close"]
                                        ktemp["Low"]=te["Close"]
                            ...
                            for te in self.linetemp[symbol]:
                                if te["DateTime"]<=line[-1]['DateTime']:
                                    ...
                                    if linetype==9 or linetype==820:
                                        if (te['DateTime']-line[-1]['DateTime']).total_seconds()>interval*60:
                                            te['DateTime']=opentime+math.ceil((te["DateTime"]-opentime).total_seconds()/(interval*60))*interval*60
                                        else:
                                            te['DateTime']=line[-1]['DateTime']+timedelta(minutes=interval)
                                    if linetype==10 or linetype==800:
                                        if (te['DateTime']-line[-1]['DateTime']).total_seconds()>interval:
