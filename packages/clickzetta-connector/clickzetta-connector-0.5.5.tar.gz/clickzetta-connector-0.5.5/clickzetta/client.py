...
class Client(object):
    ...
    def __init__(self, login_params: LoginParams, workspace: str, instance_name: str,
                 vc_name: str, cz_url: str = None, base_url: str = None):
    ...
    def create_bulkload_stream(self, schema_name: string, table_name: string,
        ...
        if options.record_keys is not None:
            for key in options.record_keys:
                create_bulk_load_request.record_keys.extend(key)
    ...
    def _gate_way_call(self, request, method: ingestion_pb2.MethodEnum):
        ...
        try:
            ...
            logging.error('gate_way_request error, reqeust body:' + MessageToJson(gate_way_request))
            raise
