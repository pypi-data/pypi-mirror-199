...
# Path params
CardImageIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'card_image_id': typing.Union[CardImageIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_card_image_id = api_client.PathParameter(
    name="card_image_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CardImageIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = UpdateCardImageRequest


request_body_update_card_image_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CardImageDetails
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_card_image_details_oapg(
        self,
    ...
    def _update_card_image_details_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_card_image_request.serialize(body, content_type)
...
class UpdateCardImageDetails(BaseApi):
    ...
    def update_card_image_details(
        ...
        return self._update_card_image_details_oapg(
            body=body,
