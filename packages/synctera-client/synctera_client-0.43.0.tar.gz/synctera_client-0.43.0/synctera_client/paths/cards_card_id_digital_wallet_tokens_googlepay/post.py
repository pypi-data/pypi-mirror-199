...
# body param
SchemaForRequestBodyApplicationJson = GoogleDigitalWalletProvisionRequest


request_body_google_digital_wallet_provision_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = GoogleDigitalWalletProvisionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_digital_wallet_google_oapg(
        self,
    ...
    def _create_digital_wallet_google_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_google_digital_wallet_provision_request.serialize(body, content_type)
...
class CreateDigitalWalletGoogle(BaseApi):
    ...
    def create_digital_wallet_google(
        ...
        return self._create_digital_wallet_google_oapg(
            body=body,
