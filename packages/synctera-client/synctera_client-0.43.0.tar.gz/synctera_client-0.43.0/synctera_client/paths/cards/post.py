...
# body param
SchemaForRequestBodyApplicationJson = CardIssuanceRequest


request_body_card_issuance_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CardResponse
...
class BaseApi(api_client.Api):
    ...
    def _issue_card_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_card_issuance_request.serialize(body, content_type)
