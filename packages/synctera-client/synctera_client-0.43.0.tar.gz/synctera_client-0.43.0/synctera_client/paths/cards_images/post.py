...
# body param
SchemaForRequestBodyApplicationJson = CreateCardImageRequest


request_body_create_card_image_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CardImageDetails
...
class BaseApi(api_client.Api):
    ...
    def _create_card_image_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_card_image_request.serialize(body, content_type)
...
class CreateCardImage(BaseApi):
    ...
    def create_card_image(
        ...
        return self._create_card_image_oapg(
            body=body,
