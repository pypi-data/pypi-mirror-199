...
# body param
SchemaForRequestBodyApplicationJson = ExternalCardRequest


request_body_external_card_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ExternalCardResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_external_card_from_token_oapg(
        self,
    ...
    def _create_external_card_from_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_external_card_request.serialize(body, content_type)
...
class CreateExternalCardFromToken(BaseApi):
    ...
    def create_external_card_from_token(
        ...
        return self._create_external_card_from_token_oapg(
            body=body,
