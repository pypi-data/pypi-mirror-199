...
# Path params
DigitalWalletTokenIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'digital_wallet_token_id': typing.Union[DigitalWalletTokenIdSchema, str, ],
    }
)
...
request_path_digital_wallet_token_id = api_client.PathParameter(
    name="digital_wallet_token_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DigitalWalletTokenIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = DigitalWalletTokenEditRequest


request_body_digital_wallet_token_edit_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = DigitalWalletTokenResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_digital_wallet_token_status_oapg(
        self,
    ...
    def _update_digital_wallet_token_status_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_digital_wallet_token_id,
        ):
        ...
        _fields = None
        _body = None
        serialized_data = request_body_digital_wallet_token_edit_request.serialize(body, content_type)
...
class UpdateDigitalWalletTokenStatus(BaseApi):
    ...
    def update_digital_wallet_token_status(
        ...
        return self._update_digital_wallet_token_status_oapg(
            body=body,
