...
# body param
SchemaForRequestBodyApplicationJson = CardActivationRequest


request_body_card_activation_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CardResponse
...
class BaseApi(api_client.Api):
    ...
    def _activate_card_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_card_activation_request.serialize(body, content_type)
...
class ActivateCard(BaseApi):
    ...
    def activate_card(
        ...
        return self._activate_card_oapg(
            body=body,
