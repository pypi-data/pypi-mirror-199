...
# body param
SchemaForRequestBodyApplicationJson = CreateGatewayRequest


request_body_create_gateway_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = GatewayResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_gateway_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_gateway_request.serialize(body, content_type)
...
class CreateGateway(BaseApi):
    ...
    def create_gateway(
        ...
        return self._create_gateway_oapg(
            body=body,
