...
# body param
SchemaForRequestBodyApplicationJson = AppleDigitalWalletProvisionRequest


request_body_apple_digital_wallet_provision_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AppleDigitalWalletProvisionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_digital_wallet_apple_oapg(
        self,
    ...
    def _create_digital_wallet_apple_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_apple_digital_wallet_provision_request.serialize(body, content_type)
...
class CreateDigitalWalletApple(BaseApi):
    ...
    def create_digital_wallet_apple(
        ...
        return self._create_digital_wallet_apple_oapg(
            body=body,
