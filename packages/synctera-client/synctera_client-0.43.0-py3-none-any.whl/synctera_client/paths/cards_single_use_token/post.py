...
# body param
SchemaForRequestBodyApplicationJson = SingleUseTokenRequest


request_body_single_use_token_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = SingleUseTokenResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_client_single_use_token_oapg(
        self,
    ...
    def _get_client_single_use_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_single_use_token_request.serialize(body, content_type)
...
class GetClientSingleUseToken(BaseApi):
    ...
    def get_client_single_use_token(
        ...
        return self._get_client_single_use_token_oapg(
            body=body,
