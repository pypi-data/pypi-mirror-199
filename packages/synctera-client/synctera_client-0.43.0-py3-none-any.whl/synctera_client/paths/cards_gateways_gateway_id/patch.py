...
# Path params
GatewayIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'gateway_id': typing.Union[GatewayIdSchema, str, ],
    }
)
...
request_path_gateway_id = api_client.PathParameter(
    name="gateway_id",
...
# body param
SchemaForRequestBodyApplicationJson = UpdateGatewayRequest


request_body_update_gateway_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GatewayResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_gateway_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_gateway_request.serialize(body, content_type)
...
class UpdateGateway(BaseApi):
    ...
    def update_gateway(
        ...
        return self._update_gateway_oapg(
            body=body,
