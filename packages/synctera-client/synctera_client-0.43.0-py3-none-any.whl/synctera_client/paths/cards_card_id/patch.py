...
# body param
SchemaForRequestBodyApplicationJson = CardEditRequest


request_body_card_edit_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_card_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_card_edit_request.serialize(body, content_type)
