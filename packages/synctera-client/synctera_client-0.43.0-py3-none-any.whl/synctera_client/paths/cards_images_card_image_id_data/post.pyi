...
class BaseApi(api_client.Api):
    @typing.overload
    def _upload_card_image_data_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyImageJpeg,bytes, io.FileIO, io.BufferedReader, ],
...
class UploadCardImageData(BaseApi):
    ...
    def upload_card_image_data(
        ...
        return self._upload_card_image_data_oapg(
            body=body,
