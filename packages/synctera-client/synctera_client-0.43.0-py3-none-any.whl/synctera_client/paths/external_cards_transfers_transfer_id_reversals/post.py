...
# Path params
TransferIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'transfer_id': typing.Union[TransferIdSchema, str, uuid.UUID, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = TransferReversalRequest


request_body_transfer_reversal_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TransferResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_external_card_transfer_reversal_oapg(
        self,
    ...
    def _create_external_card_transfer_reversal_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transfer_reversal_request.serialize(body, content_type)
...
class CreateExternalCardTransferReversal(BaseApi):
    ...
    def create_external_card_transfer_reversal(
        ...
        return self._create_external_card_transfer_reversal_oapg(
            body=body,
