...
FPortsTypeDef = TypedDict(
    "FPortsTypeDef",
    {
        ...
        "Applications": Sequence[ApplicationConfigTypeDef],
    },
    total=False,
)
...
CellTowersTypeDef = TypedDict(
    "CellTowersTypeDef",
    {
        "Gsm": Sequence[GsmObjTypeDef],
        "Wcdma": Sequence[WcdmaObjTypeDef],
        "Tdscdma": Sequence[TdscdmaObjTypeDef],
        "Lte": Sequence[LteObjTypeDef],
        "Cdma": Sequence[CdmaObjTypeDef],
    },
    total=False,
)
