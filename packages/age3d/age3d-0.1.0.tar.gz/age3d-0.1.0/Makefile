...
lint:  ## run static analysis with flake8
	python -m black --check age3d setup.py
	python -m flake8 age3d setup.py

# Alias
lints: lint

format:  ## run autoformatting with black
	python -m black age3d/ setup.py
...
test: ## clean and run unit tests
	python -m pytest -v age3d/tests

coverage:  ## clean and run unit tests with coverage
	python -m pytest -v age3d/tests --cov=age3d --cov-branch --cov-fail-under=75 --cov-report term-missing
