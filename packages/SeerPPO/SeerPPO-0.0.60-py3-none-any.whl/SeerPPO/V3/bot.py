...
from SeerPPO.V3 import SeerNetworkV3, SeerGameConditionV3, SeerObsV3, SeerActionV3
...
class SeerV3Template(BaseAgent):
    def __init__(self, name, team, index, filename):
        super().__init__(name, team, index)

        self.condition = SeerGameConditionV3()
        self.obs_builder = SeerObsV3(1, self.condition)
        self.act_parser = SeerActionV3()
