...
from simba.third_party_label_appenders_test.BORIS_appender import BorisAppender
class ThirdPartyAnnotatorAppenderPopUp(PopUpMixin):
    def __init__(self, config_path: str):
        ...
        self.error_dropdown_dict = self.create_dropdown_frame(main_frm=self.main_frm, drop_down_titles=warnings_lst, drop_down_options=['None', 'WARNING', 'ERROR'], frm_title='WARNINGS AND ERRORS')
    ...
    def run(self):
        ...
        if app_choice == Methods.BORIS.value:
            boris_appender = BorisAppender(config_path=self.config_path,
