...
class Options(Enum):
    ...
    THIRD_PARTY_ANNOTATION_ERROR_OPTIONS = ['ADDITIONAL third-party behavior detected',
                                            'ZERO third-party video annotations found',
                                            'Annotations and pose FRAME COUNT conflict',
                                            'Annotations EVENT COUNT inconsistency',
                                            'Annotations OVERLAP inaccuracy',
                                            'Annotations data NOT FOUND',
