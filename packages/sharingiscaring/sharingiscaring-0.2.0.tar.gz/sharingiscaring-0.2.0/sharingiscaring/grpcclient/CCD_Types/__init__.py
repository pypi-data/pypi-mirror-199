...
class CCD_AccountTransactionEffects(BaseModel):
    ...
    baker_keys_updated: CCD_BakerKeysEvent = None
    encrypted_amount_transferred: CCD_AccountTransactionEffects_EncryptedAmountTransferred = None
...
class CCD_TimeParametersCpv1(BaseModel):
    reward_period_length: CCD_RewardPeriodLength
