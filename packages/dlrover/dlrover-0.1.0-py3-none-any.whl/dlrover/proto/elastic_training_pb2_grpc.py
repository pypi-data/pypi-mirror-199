...
class MasterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_rdzv_state = channel.unary_unary(
                '/elastic.Master/get_rdzv_state',
                request_serializer=dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.SerializeToString,
                response_deserializer=dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.FromString,
                )
        self.set_rdzv_state = channel.unary_unary(
                '/elastic.Master/set_rdzv_state',
                request_serializer=dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.SerializeToString,
                response_deserializer=dlrover_dot_proto_dot_elastic__training__pb2.Response.FromString,
                )
        ...
        self.update_node_addr = channel.unary_unary(
                '/elastic.Master/update_node_addr',
...
class MasterServicer(object):
    ...
    def get_rdzv_state(self, request, context):
    ...
    def set_rdzv_state(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def update_node_addr(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MasterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'get_rdzv_state': grpc.unary_unary_rpc_method_handler(
                    servicer.get_rdzv_state,
                    request_deserializer=dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.FromString,
                    response_serializer=dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.SerializeToString,
            ),
            'set_rdzv_state': grpc.unary_unary_rpc_method_handler(
                    servicer.set_rdzv_state,
                    request_deserializer=dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.FromString,
                    response_serializer=dlrover_dot_proto_dot_elastic__training__pb2.Response.SerializeToString,
            ),
            ...
            'update_node_addr': grpc.unary_unary_rpc_method_handler(
                    servicer.update_node_addr,
...
class Master(object):
    ...
    def get_rdzv_state(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/elastic.Master/get_rdzv_state',
            dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.SerializeToString,
            dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def set_rdzv_state(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/elastic.Master/set_rdzv_state',
            dlrover_dot_proto_dot_elastic__training__pb2.RendezvousState.SerializeToString,
            dlrover_dot_proto_dot_elastic__training__pb2.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def update_node_addr(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/elastic.Master/update_node_addr',
