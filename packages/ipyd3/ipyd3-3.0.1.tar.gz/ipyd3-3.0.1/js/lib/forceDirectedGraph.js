...
var ForceDirectedGraphView = widgets.DOMWidgetView.extend({
    ...
    **/
    ...
    create_style: function(){
      ...
      if(lab){
        this.drop_button.setAttribute("data-bs-toggle","dropdown");
      }
      else{
      ...
      function search_box(){
        ...
        this.button_layer.setAttribute("style","float: right; font-size: 14px;");
      ...
      search_button.style = "margin-bottom:10px;font-size: 14px;"
