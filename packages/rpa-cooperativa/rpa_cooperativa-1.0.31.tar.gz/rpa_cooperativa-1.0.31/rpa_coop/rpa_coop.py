...
class Dados:
    ...
    def __init__(self):
        self.ip_planning = str(gerador_pwd('planning', 'ip_host'))
        self.user_planning = str(gerador_pwd('planning', 'usuario'))
        self.pw_bd_planning = str(urllib.parse.quote_plus(gerador_pwd('planning', 'senha')))
...
class Fluid:
    ...
    def __init__(self):
        ...
        self.ip_planning = str(gerador_pwd('planning', 'ip_host'))
        self.user_planning = str(gerador_pwd('planning', 'usuario'))
        self.pwd_planning = str(gerador_pwd('planning', 'senha'))
