...
class ResourcesContext:
    def __init__(self) -> None:
        self._resource_breadcrumbs = dict()

    # TODO - this needs to be moved to a separate object, directly linked to the RestResourceGroup
    def record_resource_id(self, key, value):
        """Records a REST resource id, against a key (usually the name of the resource type)"""
        self._resource_breadcrumbs[key] = value

    def extract_resource_id(self, key: Optional[str] = None, *, pos: int = -1):
        """Returns resource identifier by the name of the command, or the deepest one recorded
        ...
        Args:
            ...
            pos (int, optional): The position of the resource in the breadcrumbs.
                Supports negative numbers for position from the back, eg. -1 for the last resource in the hierarchy.
        ...
        Raises:
            UnknownResourceError: Any error, such as there being no corresponding resource to the request
        """
