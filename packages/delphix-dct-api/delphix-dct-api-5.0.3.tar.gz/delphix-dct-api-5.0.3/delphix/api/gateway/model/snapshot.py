...
class Snapshot(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'appdata_metadata': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            retention (int): Retention policy, in days. A value of -1 indicates the snapshot should be kept forever.. [optional]  # noqa: E501
            ...
            appdata_metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The JSON payload conforming to the DraftV4 schema based on the type of application data being manipulated.. [optional]  # noqa: E501
