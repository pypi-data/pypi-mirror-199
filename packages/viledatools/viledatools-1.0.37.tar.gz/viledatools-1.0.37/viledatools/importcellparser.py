...
class ImportCellParser:
    ...
    def IQF029TASKTIMEDAYSHIFT(self, cellobject: openpyxl.cell.cell.Cell) -> Union[int, None]:
        """
        ...
        try:
            ...
            raise ImportCellParserException(f"IQF029TASKTIMEDAYSHIFT: Wrong value in the cell: "
                                            f"{_value}, must be integer")
        if _value_int < 0:
            raise ImportCellParserException((f"IQF029TASKTIMEDAYSHIFT: Value in the cell: {_value} out of range, "
