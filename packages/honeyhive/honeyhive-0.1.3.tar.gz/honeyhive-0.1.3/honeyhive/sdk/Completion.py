...
from honeyhive.api.models.generations import GenerationResponse, GenerationLoggingQuery
...
def create(
    ...
    args_for_openai = {k: v for k, v in args_for_openai.items() if v is not None}
