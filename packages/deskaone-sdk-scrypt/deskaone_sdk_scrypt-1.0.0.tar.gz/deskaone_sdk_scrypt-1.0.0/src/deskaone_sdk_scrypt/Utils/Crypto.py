...
class Crypto:
    ...
    class AES:
        ...
        def encrypt_to_base64(self): return base64.b64encode(AES.new(self.Key, self.Mode, self.Iv).encrypt(self.Data)).decode()
        def encrypt_to_base58(self): return base58.b58encode(AES.new(self.Key, self.Mode, self.Iv).encrypt(self.Data)).decode()
        def encrypt_to_hex(self): return AES.new(self.Key, self.Mode, self.Iv).encrypt(self.Data).hex()
        def encrypt_to_bytes(self): return AES.new(self.Key, self.Mode, self.Iv).encrypt(self.Data)
        
        def decrypt_to_string(self): return self.__unpad__V1(AES.new(self.Key, self.Mode, self.Iv).decrypt(self.Data)).decode("utf-8")
        def decrypt_to_dict(self): return dict(json.loads(self.__unpad__V1(AES.new(self.Key, self.Mode, self.Iv).decrypt(self.Data)).decode("utf-8")))
        def decrypt_to_list(self): return list(json.loads(self.__unpad__V1(AES.new(self.Key, self.Mode, self.Iv).decrypt(self.Data)).decode("utf-8")))
        def decrypt_to_bytes(self): return self.__unpad__V1(AES.new(self.Key, self.Mode, self.Iv).decrypt(self.Data))
        
        def decrypt_to_string__unpad_V2(self): return self.__unpad__V2(AES.new(self.Key, self.Mode, self.Iv).decrypt(self.Data))
        def decrypt_to_dict__unpad_V2(self): return dict(json.loads(self.__unpad__V2(AES.new(self.Key, self.Mode, self.Iv).decrypt(self.Data))))
        def decrypt_to_list__unpad_V2(self): return list(json.loads(self.__unpad__V2(AES.new(self.Key, self.Mode, self.Iv).decrypt(self.Data))))
        def decrypt_to_bytes__unpad_V2(self): return self.__unpad__V2(AES.new(self.Key, self.Mode, self.Iv).decrypt(self.Data)).encode()
