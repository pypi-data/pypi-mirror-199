...
setup(name='DLStudio',
      ...
      url='https://engineering.purdue.edu/kak/distDLS/DLStudio-2.2.4.html',
      download_url='https://engineering.purdue.edu/kak/distDLS/DLStudio-2.2.4.tar.gz',
      description='A PyTorch based software platform for teaching the Deep Learning class at Purdue University',
      long_description='''

Consult the module API page at

      https://engineering.purdue.edu/kak/distDLS/DLStudio-2.2.4.html
