...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'is', 'fy', 'cv', 'ckb', 'tl', 'an', 'pa', 'wuu', 'diq', 'io', 'sco',
        'vo', 'yo', 'ne', 'gu', 'kn', 'als', 'ia', 'avk', 'bar', 'scn', 'bpy',
        'crh', 'qu', 'ha', 'mn', 'nv', 'xmf', 'si', 'ban', 'ps', 'bat-smg',
        'frr', 'os', 'or', 'sah', 'gd', 'cdo', 'bug', 'yi', 'ilo', 'sd', 'am',
        'nap', 'li', 'gor', 'fo', 'hsb', 'map-bms', 'mai', 'mzn', 'ig', 'bcl',
        'eml', 'ace', 'shn', 'zh-classical', 'sa', 'wa', 'ie', 'as', 'lij',
        'zu', 'mhr', 'hyw', 'hif', 'mrj', 'sn', 'bjn', 'mni', 'hak', 'km',
        'tum', 'roa-tara', 'so', 'pam', 'rue', 'nso', 'bh', 'sat', 'se', 'myv',
        'mi', 'vls', 'nds-nl', 'nah', 'sc', 'kw', 'glk', 'vep', 'kab', 'tk',
        'gan', 'ary', 'co', 'dag', 'fiu-vro', 'bo', 'ab', 'gv', 'skr', 'zea',
        'frp', 'ug', 'udm', 'pcd', 'kv', 'csb', 'mt', 'rw', 'gn', 'smn', 'ay',
        ...
        'tet', 'jbo', 'roa-rup', 'xh', 'fj', 'lbe', 'kg', 'om', 'guw', 'ty',
