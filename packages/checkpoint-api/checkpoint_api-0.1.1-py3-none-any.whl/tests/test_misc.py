...
def test_discard_01():
    ...
    responses.add(
        responses.POST, "https://10.100.30.25/web_api/publish", json={"task-id":4711}, status=200
    )
    responses.add(
        responses.POST, "https://10.100.30.25/web_api/show-task", json={"tasks":[{"status":"succeeded"}]}, status=200
    )
    responses.add(
        responses.POST,
...
def test_paginate():
    ...
    responses.add(
        responses.POST, "https://10.100.30.25/web_api/show-hosts", json={}, status=200
    )
...
def test_publish_02():
    ...
    responses.add(
        responses.POST, "https://10.100.30.25/web_api/show-task", json={"tasks":[{"status":"in progress"}]}, status=200
    )
    responses.add(
        responses.POST,
        "https://10.100.30.25/web_api/add-host",
