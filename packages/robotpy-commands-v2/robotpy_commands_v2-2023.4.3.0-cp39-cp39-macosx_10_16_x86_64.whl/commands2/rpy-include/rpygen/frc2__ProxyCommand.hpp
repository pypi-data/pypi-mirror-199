...
#include <../src/include/frc2/command/ProxyCommand.h>
...
using PyTrampolineCfgBase_frc2__ProxyCommand =
    PyTrampolineCfg_frc2__CommandBase<
CfgBase
>;

template <typename CfgBase = EmptyTrampolineCfg>
struct PyTrampolineCfg_frc2__ProxyCommand :
    PyTrampolineCfgBase_frc2__ProxyCommand< CfgBase>
{
    using Base = frc2::ProxyCommand;

    using override_base_Initialize_v = frc2::ProxyCommand;
    using override_base_End_b = frc2::ProxyCommand;
    using override_base_Execute_v = frc2::ProxyCommand;
    using override_base_IsFinished_v = frc2::ProxyCommand;
    using override_base_InitSendable_RTSendableBuilder = frc2::ProxyCommand;
};


template <typename PyTrampolineBase, typename PyTrampolineCfg>
using PyTrampolineBase_frc2__ProxyCommand =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_frc2__ProxyCommand : PyTrampolineBase_frc2__ProxyCommand<PyTrampolineBase, PyTrampolineCfg> {
    using PyTrampolineBase_frc2__ProxyCommand<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_frc2__ProxyCommand;
