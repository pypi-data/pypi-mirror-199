...
class FeaturizationConfig:
    ...
    .. remarks::
        ...
        * Add or remove prediction transform type. With ``add_prediction_transform_type`` and
        ...
        https://github.com/Azure/azureml-examples/blob/main/v1/python-sdk/tutorials/automl-with-azureml/forecasting-orange-juice-sales/auto-ml-forecasting-orange-juice-sales.ipynb
        ...
        Full sample is available from
        https://github.com/Azure/azureml-examples/blob/main/v1/python-sdk/tutorials/automl-with-azureml/regression-explanation-featurization/auto-ml-regression-explanation-featurization.ipynb
    ...
    def __init__(
        ...
        self._fix_transform_params_maybe()
    ...
    def __repr__(self) -> str:
        ...
        if self._drop_columns is not None:
            params["drop_columns"] = self._drop_columns
    ...
    def _fix_transform_params_maybe(self) -> None:
        """Replace None in transformer parameters with an empty list."""
        if self.transformer_params is not None:
            for transformer in self.transformer_params.keys():
                if self.transformer_params[transformer] is None:
