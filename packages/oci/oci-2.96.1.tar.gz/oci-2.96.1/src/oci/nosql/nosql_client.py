...
class NosqlClient(object):
    ...
    def change_table_compartment(self, table_name_or_id, change_table_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/change_table_compartment.py.html>`__ to see an example of how to use change_table_compartment API.
        """
    ...
    def create_index(self, table_name_or_id, create_index_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/create_index.py.html>`__ to see an example of how to use create_index API.
        """
    ...
    def create_table(self, create_table_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/create_table.py.html>`__ to see an example of how to use create_table API.
        """
    ...
    def delete_index(self, table_name_or_id, index_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/delete_index.py.html>`__ to see an example of how to use delete_index API.
        """
    ...
    def delete_row(self, table_name_or_id, key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/delete_row.py.html>`__ to see an example of how to use delete_row API.
        """
    ...
    def delete_table(self, table_name_or_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/delete_table.py.html>`__ to see an example of how to use delete_table API.
        """
    ...
    def delete_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/delete_work_request.py.html>`__ to see an example of how to use delete_work_request API.
        """
    ...
    def get_index(self, table_name_or_id, index_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/get_index.py.html>`__ to see an example of how to use get_index API.
        """
        resource_path = "/tables/{tableNameOrId}/indexes/{indexName}"
        method = "GET"
    ...
    def get_row(self, table_name_or_id, key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/get_row.py.html>`__ to see an example of how to use get_row API.
        """
        resource_path = "/tables/{tableNameOrId}/rows"
        method = "GET"
    ...
    def get_table(self, table_name_or_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/get_table.py.html>`__ to see an example of how to use get_table API.
        """
        resource_path = "/tables/{tableNameOrId}"
        method = "GET"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        resource_path = "/workRequests/{workRequestId}"
        method = "GET"
    ...
    def list_indexes(self, table_name_or_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/list_indexes.py.html>`__ to see an example of how to use list_indexes API.
        """
        resource_path = "/tables/{tableNameOrId}/indexes"
        method = "GET"
    ...
    def list_table_usage(self, table_name_or_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/list_table_usage.py.html>`__ to see an example of how to use list_table_usage API.
        """
    ...
    def list_tables(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/list_tables.py.html>`__ to see an example of how to use list_tables API.
        """
        resource_path = "/tables"
        method = "GET"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
    ...
    def prepare_statement(self, compartment_id, statement, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/prepare_statement.py.html>`__ to see an example of how to use prepare_statement API.
        """
    ...
    def query(self, query_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/query.py.html>`__ to see an example of how to use query API.
        """
        resource_path = "/query"
        method = "POST"
    ...
    def summarize_statement(self, compartment_id, statement, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/summarize_statement.py.html>`__ to see an example of how to use summarize_statement API.
        """
    ...
    def update_row(self, table_name_or_id, update_row_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/update_row.py.html>`__ to see an example of how to use update_row API.
        """
        resource_path = "/tables/{tableNameOrId}/rows"
        method = "PUT"
    ...
    def update_table(self, table_name_or_id, update_table_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.96.1/nosql/update_table.py.html>`__ to see an example of how to use update_table API.
        """
        resource_path = "/tables/{tableNameOrId}"
        method = "PUT"
