...
class SNXHandler(snx.SNX):
    ...
    def hello_reply(self, rr):
        ...
        dns_suff = utils.make_dns_list(dns_suff)
        # VNA stuff
    ...
    with contextlib.ExitStack() as es:
        ...
        try:
            while True:
                ...
                loop.run_until_complete(evt_wait())
