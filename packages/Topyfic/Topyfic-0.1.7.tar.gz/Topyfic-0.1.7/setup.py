...
setup(
    ...
    download_url='https://github.com/mortazavilab/Topyfic/archive/refs/tags/V0.1.7.tar.gz',  # link to the tar.gz file associated with this release
