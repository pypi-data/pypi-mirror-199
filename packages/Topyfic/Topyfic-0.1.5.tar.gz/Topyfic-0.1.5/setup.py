...
setup(
    ...
    download_url='https://github.com/mortazavilab/Topyfic/archive/refs/tags/V0.1.5.tar.gz',  # link to the tar.gz file associated with this release
