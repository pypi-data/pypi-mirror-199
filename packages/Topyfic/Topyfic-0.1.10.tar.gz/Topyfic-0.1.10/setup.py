...
setup(
    ...
    version='v0.1.10',  # version number
    ...
    download_url='https://github.com/mortazavilab/Topyfic/archive/refs/tags/V0.1.10.tar.gz',  # link to the tar.gz file associated with this release
