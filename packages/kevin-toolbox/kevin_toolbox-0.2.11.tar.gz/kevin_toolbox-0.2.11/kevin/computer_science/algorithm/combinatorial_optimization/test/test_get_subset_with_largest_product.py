...
from kevin.computer_science.algorithm.combinatorial_optimization import get_subset_with_largest_product
from kevin.computer_science.algorithm.utils import get_subsets
