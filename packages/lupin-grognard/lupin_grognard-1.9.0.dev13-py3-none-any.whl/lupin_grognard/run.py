...
from lupin_grognard.core.check import check_commit, check_max_allowed_commits, check_max_allowed_special_commits
...
def check_commits(
    ...
    if all:  # --all option
        ...
        # ):
        if check_max_allowed_special_commits(commits_string=commit_range_list_to_check):
