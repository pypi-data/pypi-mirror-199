...
def main_goose():
    ...
    #root_dir_path = os.path.abspath('poetry_mth')
    #print(root_dir_path)
    ...
    BG_PATH = os.path.join(CURRENT_PATH, 'GameGooseKiller', 'image', 'background')
    #BG_PATH = 'poetry_mth\\GameGooseKiller\\image\\background'
