...
namespace CYLINDER
{
  ...
  class Scatterer: public ScatteringProperties
  {
      public:
          ...
          CVector get_a1n() { return a1n; };
          CVector get_b1n() { return b1n; };
          CVector get_a2n() { return a2n; };
          CVector get_b2n() { return b2n; };
      ...
      void compute_an_bn()
      {
        a1n = CVector(max_order);
        b1n = CVector(max_order);

        a2n = CVector(max_order);
        b2n = CVector(max_order);
