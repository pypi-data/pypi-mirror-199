...
Cndarray get_sphere_coefficient_material(CVector (SPHERE::Scatterer::*function)(void), size_t max_order=0)
{
  ...
  CVector output_array(array_full_size);
...
ndarray get_sphere_data_material(double (SPHERE::Scatterer::*function)(void), size_t max_order=0)
{
  ...
  DVector output_array(array_full_size);
                                  ...
                                  for (size_t p=0; p<array_full_shape[8]; ++p)
                                      for (size_t g=0; g<array_full_shape[9]; ++g)
                                          for (size_t f=0; f<array_full_shape[10]; ++f)
                                        {
                                          ...
                                          DETECTOR::State detector_state  = DETECTOR::State(detectorSet.ScalarField[s],
                                                                                            detectorSet.NA[na],
                                                                                            detectorSet.PhiOffset[p],
                                                                                            detectorSet.GammaOffset[g],
                                                                                            detectorSet.Filter[f],
                                                                                            detectorSet.Coherent,
                                                                                            detectorSet.PointCoupling);
                                  ...
                                  for (size_t p=0; p<array_full_shape[8]; ++p)
                                      for (size_t g=0; g<array_full_shape[9]; ++g)
                                          for (size_t f=0; f<array_full_shape[10]; ++f)
                                        {
                                          ...
                                          DETECTOR::State detector_state  = DETECTOR::State(detectorSet.ScalarField[s], detectorSet.NA[na], detectorSet.PhiOffset[p], detectorSet.GammaOffset[g], detectorSet.Filter[f], detectorSet.Coherent, detectorSet.PointCoupling);
                                          ...
                                          for (size_t p=0; p<array_full_shape[10]; ++p)
                                              for (size_t g=0; g<array_full_shape[11]; ++g)
                                                  for (size_t f=0; f<array_full_shape[12]; ++f)
                                                  {
                                                    ...
                                                    SOURCE::State    source_state     = SOURCE::State(sourceSet.wavelength[w], sourceSet.jones_vector[j], sourceSet.amplitude[a]);
                                                    CORESHELL::State scatterer_state  = CORESHELL::State(coreshellSet.core_diameter[Cd], coreshellSet.shell_diameter[Sd], coreshellSet.core_material[Ci][w], coreshellSet.shell_index[Si], coreshellSet.n_medium[n]);
                                                    DETECTOR::State  detector_state   = DETECTOR::State(detectorSet.ScalarField[0], detectorSet.NA[na], detectorSet.PhiOffset[p], detectorSet.GammaOffset[g], detectorSet.Filter[f], detectorSet.Coherent, detectorSet.PointCoupling);
