...
#define FIBONACCI_H
  ...
  class FibonacciMesh
  {
    ...
    public:
      ...
      double      MaxAngle, PhiOffset, GammaOffset, dOmega, Omega;
  ...
  void Rotations()
  {
    if (GammaOffset != 0.)
    {
      CCoord.mx_rot_x(GammaOffset);
      VVector.mx_rot_x(GammaOffset);
      HVector.mx_rot_x(GammaOffset);
    }

    if (PhiOffset   != 0.)
    {
      CCoord.mx_rot_y(PhiOffset);
      VVector.mx_rot_y(PhiOffset);
      HVector.mx_rot_y(PhiOffset);
    }
  }
