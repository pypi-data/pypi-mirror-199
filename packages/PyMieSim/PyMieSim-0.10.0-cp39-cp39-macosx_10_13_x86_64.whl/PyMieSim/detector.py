...
class GenericDetector():
    ...
    def _get_binding_(self):
        ...
        self.cpp_binding = BindedDetector(
            ...
            filter=numpy.deg2rad(self.polarization_filter),
...
class Photodiode(GenericDetector):
    ...
    def __init__(self, NA, sampling, gamma_offset, phi_offset, polarization_filter=None):
...
class IntegratingSphere(GenericDetector):
    ...
    def __init__(self, sampling, polarization_filter=None):
