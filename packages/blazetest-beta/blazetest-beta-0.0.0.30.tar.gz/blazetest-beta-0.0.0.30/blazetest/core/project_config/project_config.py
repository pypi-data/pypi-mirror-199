...
from blazetest.core.config import PROJECT_CONFIG_YAML
from blazetest.core.project_config.yaml_model import BlazetestConfig
...
class ProjectConfiguration:
    def validate(self):
        # TODO: validations of the config parameters from YAML file
        pass
