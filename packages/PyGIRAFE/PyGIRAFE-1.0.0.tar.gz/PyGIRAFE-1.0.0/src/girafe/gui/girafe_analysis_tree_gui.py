...
class AnalysisTreeApp(QWidget):
    ...
    def __init__(self, parent, config_handler, analyses_instances, to_parameters_button=None):
        ...
        # list of instances of GirafeAnalysis classe
    ...
    def create_tree_model(self):
        ...
        # with no family
        # dict values is a list containing either dict (new family) or instances of GirafeAnalysis
...
def fill_tree_item_with_dict(root_tree, instances_dict):
    ...
    for key, value in instances_dict.items():
        if key == "zzz":
            # value is a list of GirafeAnalysis instance
        ...
        # value is a list of dict or instance of GirafeAnalysis
        analysis_to_add = []
