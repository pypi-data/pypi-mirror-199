...
class MySelectButton(QPushButton):
...
class ListCheckboxWidget(MyQFrame, ParameterWidgetModel, metaclass=FinalMeta):
    ...
    def select_all(self, session_id):
        """
        select all items
    ...
    def unselect_all(self, session_id):
        """
        Unselect all items
        :return:
        """
...
class FloatLineEditWidget(MyQFrame, ParameterWidgetModel, metaclass=FinalMeta):
...
class AnalysisParametersApp(QWidget):
    ...
    def create_widgets(self, cicada_analysis):
        ...
        Args:
            cicada_analysis (GirafeAnalysis): Chosen analysis
...
class Worker(QtCore.QThread):
    ...
    def __init__(self, name, cicada_analysis, analysis_arguments_handler, parent):
        ...
        Args:
            ...
            cicada_analysis (GirafeAnalysis): the analysis run in the thread
