...
class CicadaSpotDisClustAnalysis(CicadaAnalysis):
    def __init__(self, config_handler=None):
        """
        """
        CicadaAnalysis.__init__(self, name="SPOTDisClust", family_id="Assemblies detection",
                                short_description="Grossberger et al. 2018 Plot Comp Bio",
    ...
    def copy(self):
        ...
        """
        analysis_copy = CicadaSpotDisClustAnalysis(config_handler=self.config_handler)
    ...
    def run_analysis(self, **kwargs):
        ...
        start_time = time()
        print("SPOTDisClust assemblies detection: coming soon...")
