...
class CicadaAssembliesCoreAnalysis(CicadaAnalysis):
    def __init__(self, config_handler=None):
        ...
        CicadaAnalysis.__init__(self, name="CORE", family_id="Assemblies detection",
                                short_description="Miller et al. 2014 Proc Natl Acad Sci USA",
                                config_handler=config_handler,
                                accepted_data_formats=["CI_DATA"]) # Proc Natl Acad Sci USA
    ...
    def copy(self):
        ...
        """
        analysis_copy = CicadaAssembliesCoreAnalysis(config_handler=self.config_handler)
