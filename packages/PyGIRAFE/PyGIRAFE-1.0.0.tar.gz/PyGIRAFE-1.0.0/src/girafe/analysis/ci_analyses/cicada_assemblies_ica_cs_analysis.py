...
class CicadaAssembliesIcaCsAnalysis(CicadaAnalysis):
    def __init__(self, config_handler=None):
        ...
        CicadaAnalysis.__init__(self, name="ICA Circular Shift", family_id="Assemblies detection",
                                short_description="Lopes-dos-Santos et al. 2013",
                                config_handler=config_handler,
                                accepted_data_formats=["CI_DATA"]) # J Neurosci Methods
    ...
    def copy(self):
        ...
        """
        analysis_copy = CicadaAssembliesIcaCsAnalysis(config_handler=self.config_handler)
