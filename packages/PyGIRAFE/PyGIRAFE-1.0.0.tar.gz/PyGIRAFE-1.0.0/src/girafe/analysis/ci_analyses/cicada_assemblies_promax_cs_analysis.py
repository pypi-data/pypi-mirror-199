...
class CicadaAssembliesPromaxCsAnalysis(CicadaAnalysis):
    def __init__(self, config_handler=None):
        ...
        CicadaAnalysis.__init__(self, name="Promax Circular Shift", family_id="Assemblies detection",
                                short_description="Romano et al. 2015 Neuron", config_handler=config_handler,
    ...
    def copy(self):
        ...
        """
        analysis_copy = CicadaAssembliesPromaxCsAnalysis(config_handler=self.config_handler)
