...
from diengine_connect import dbapi
from diengine_connect.cc_sqlalchemy.inspector import ChInspector
from diengine_connect.cc_sqlalchemy.sql import full_table
from diengine_connect.cc_sqlalchemy.sql.ddlcompiler import ChDDLCompiler
from diengine_connect.cc_sqlalchemy import ischema_names, dialect_name
from diengine_connect.cc_sqlalchemy.sql.preparer import ChIdentifierPreparer


# pylint: disable-msg=too-many-public-methods
class DiengineDialect(DefaultDialect):
    """
