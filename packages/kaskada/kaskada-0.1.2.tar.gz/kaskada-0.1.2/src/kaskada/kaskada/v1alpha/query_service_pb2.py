...
_CREATEQUERYRESPONSE_ANALYSIS = _CREATEQUERYRESPONSE.nested_types_by_name['Analysis']
_CREATEQUERYRESPONSE_CONFIG = _CREATEQUERYRESPONSE.nested_types_by_name['Config']
_CREATEQUERYRESPONSE_METRICS = _CREATEQUERYRESPONSE.nested_types_by_name['Metrics']
...
_CREATEQUERYRESPONSE_STATE = _CREATEQUERYRESPONSE.enum_types_by_name['State']
Query = _reflection.GeneratedProtocolMessageType('Query', (_message.Message,), {

  'Limits' : _reflection.GeneratedProtocolMessageType('Limits', (_message.Message,), {
    'DESCRIPTOR' : _QUERY_LIMITS,
    '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
    # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.Query.Limits)
    })
  ,
  ...
  'RedisBulkResponse' : _reflection.GeneratedProtocolMessageType('RedisBulkResponse', (_message.Message,), {
    ...
    '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
    # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.Query.RedisBulkResponse)
    })
  ,
  'DESCRIPTOR' : _QUERY,
  '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
  # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.Query)
  })
...
QueryOptions = _reflection.GeneratedProtocolMessageType('QueryOptions', (_message.Message,), {
  ...
  '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
  # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.QueryOptions)
  })
...
CreateQueryRequest = _reflection.GeneratedProtocolMessageType('CreateQueryRequest', (_message.Message,), {
  ...
  '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
  # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.CreateQueryRequest)
  })
...
CreateQueryResponse = _reflection.GeneratedProtocolMessageType('CreateQueryResponse', (_message.Message,), {
  ...
  'Analysis' : _reflection.GeneratedProtocolMessageType('Analysis', (_message.Message,), {
    'DESCRIPTOR' : _CREATEQUERYRESPONSE_ANALYSIS,
    '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
    # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.CreateQueryResponse.Analysis)
    })
  ,

  'Config' : _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
    'DESCRIPTOR' : _CREATEQUERYRESPONSE_CONFIG,
    '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
    # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.CreateQueryResponse.Config)
    })
  ,

  'Metrics' : _reflection.GeneratedProtocolMessageType('Metrics', (_message.Message,), {
    'DESCRIPTOR' : _CREATEQUERYRESPONSE_METRICS,
    '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
    # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.CreateQueryResponse.Metrics)
    })
  ,
  'DESCRIPTOR' : _CREATEQUERYRESPONSE,
  '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
  # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.CreateQueryResponse)
  })
_sym_db.RegisterMessage(CreateQueryResponse)
_sym_db.RegisterMessage(CreateQueryResponse.Analysis)
_sym_db.RegisterMessage(CreateQueryResponse.Config)
_sym_db.RegisterMessage(CreateQueryResponse.Metrics)

GetQueryRequest = _reflection.GeneratedProtocolMessageType('GetQueryRequest', (_message.Message,), {
  'DESCRIPTOR' : _GETQUERYREQUEST,
  '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
  # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.GetQueryRequest)
  })
...
GetQueryResponse = _reflection.GeneratedProtocolMessageType('GetQueryResponse', (_message.Message,), {
  ...
  '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
  # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.GetQueryResponse)
  })
...
ListQueriesRequest = _reflection.GeneratedProtocolMessageType('ListQueriesRequest', (_message.Message,), {
  ...
  '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
  # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.ListQueriesRequest)
  })
...
ListQueriesResponse = _reflection.GeneratedProtocolMessageType('ListQueriesResponse', (_message.Message,), {
  ...
  '__module__' : 'kaskada.kaskada.v1alpha.query_service_pb2'
  # @@protoc_insertion_point(class_scope:kaskada.kaskada.v1alpha.ListQueriesResponse)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _QUERY._serialized_start=470
  _QUERY._serialized_end=1431
  _QUERY_LIMITS._serialized_start=1164
  _QUERY_LIMITS._serialized_end=1207
  _QUERY_REDISBULKRESPONSE._serialized_start=1209
  _QUERY_REDISBULKRESPONSE._serialized_end=1250
  _QUERY_RESULTBEHAVIOR._serialized_start=1253
  _QUERY_RESULTBEHAVIOR._serialized_end=1413
  _QUERYOPTIONS._serialized_start=1434
  _QUERYOPTIONS._serialized_end=1606
  _CREATEQUERYREQUEST._serialized_start=1609
  _CREATEQUERYREQUEST._serialized_end=1759
  _CREATEQUERYRESPONSE._serialized_start=1762
  _CREATEQUERYRESPONSE._serialized_end=3051
  _CREATEQUERYRESPONSE_ANALYSIS._serialized_start=2357
  _CREATEQUERYRESPONSE_ANALYSIS._serialized_end=2457
  _CREATEQUERYRESPONSE_CONFIG._serialized_start=2459
  _CREATEQUERYRESPONSE_CONFIG._serialized_end=2579
  _CREATEQUERYRESPONSE_METRICS._serialized_start=2582
  _CREATEQUERYRESPONSE_METRICS._serialized_end=2900
  _CREATEQUERYRESPONSE_STATE._serialized_start=2903
  _CREATEQUERYRESPONSE_STATE._serialized_end=3033
  _GETQUERYREQUEST._serialized_start=3053
  _GETQUERYREQUEST._serialized_end=3106
  _GETQUERYRESPONSE._serialized_start=3108
  _GETQUERYRESPONSE._serialized_end=3185
  _LISTQUERIESREQUEST._serialized_start=3187
  _LISTQUERIESREQUEST._serialized_end=3303
  _LISTQUERIESRESPONSE._serialized_start=3306
  _LISTQUERIESRESPONSE._serialized_end=3507
  _QUERYSERVICE._serialized_start=3510
  _QUERYSERVICE._serialized_end=3936
