...
class X_API:
    ...
    def post_export(
        ...
        response = self._client.open_api_do("POST", "export", dataset_id, json=post_data).json()
    ...
    def post_export_multi(
        ...
        response = self._client.open_api_do("POST", "export/multi", dataset_id, json=post_data).json()
