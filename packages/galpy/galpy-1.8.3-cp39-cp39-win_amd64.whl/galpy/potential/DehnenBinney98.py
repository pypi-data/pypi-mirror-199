...
def define_dehnenbinney98_models(model=1):
    ...
    SigmaR0= Sigma0/(SigmaR0_ISM_over_SigmaR0\
                         /(2.*zd_ISM)
         /mwpot_helpers.expexp_dens_with_hole(1.,0.,Rd_ISM,Rm_ISM,zd_ISM,1.)
                 +SigmaR0_thin_over_SigmaR0\
         *mwpot_helpers.expexp_dens(0.,0.,Rd_thin,zd_thin,1.)\
         /mwpot_helpers.expexp_dens(1.,0.,Rd_thin,zd_thin,1.)
                 +SigmaR0_thick_over_SigmaR0\
         *mwpot_helpers.expexp_dens(0.,0.,Rd_thick,zd_thick,1.)\
         /mwpot_helpers.expexp_dens(1.,0.,Rd_thick,zd_thick,1.))
    Sigma0_ISM= SigmaR0_ISM_over_SigmaR0*SigmaR0/(2.*zd_ISM)\
        /mwpot_helpers.expexp_dens_with_hole(1.,0.,Rd_ISM,Rm_ISM,zd_ISM,1.)
    Sigma0_thin= SigmaR0_thin_over_SigmaR0*SigmaR0\
        *mwpot_helpers.expexp_dens(0.,0.,Rd_thin,zd_thin,1.)\
        /mwpot_helpers.expexp_dens(1.,0.,Rd_thin,zd_thin,1.)
    Sigma0_thick= SigmaR0_thick_over_SigmaR0*SigmaR0\
        *mwpot_helpers.expexp_dens(0.,0.,Rd_thick,zd_thick,1.)\
        /mwpot_helpers.expexp_dens(1.,0.,Rd_thick,zd_thick,1.)
    # now define gas and disk functions for DiskSCF
    gas_dens= lambda R,z: mwpot_helpers.expexp_dens_with_hole(R,z,Rd_ISM,
                                                              Rm_ISM,zd_ISM,
                                                              Sigma0_ISM)
    disk_dens= lambda R,z: mwpot_helpers.expexp_dens(R,z,Rd_thin,
                                                     zd_thin,Sigma0_thin)\
                      +mwpot_helpers.expexp_dens(R,z,Rd_thick,
                                                 zd_thick,Sigma0_thick)
    ...
    DB98_halo= TwoPowerTriaxialPotential(amp=rho0_halo*(4*numpy.pi*r0_halo**3),
