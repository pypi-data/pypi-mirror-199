...
def updateNewTempalte(rootDir):
    getOssResource(rootDir, "http://mecord-m.2tianxin.com/res/template_res_20230329.zip", "fe10958b4e280d5244e462532c5da541", "template_res.zip.py")
...
def listTemplate(searchPath):
    ...
    if len(searchPath) <= 0 or os.path.exists(searchPath) == False:
        ...
        tpDir = searchPath
    if len(tpDir) <= 0 or os.path.exists(searchPath) == False:
