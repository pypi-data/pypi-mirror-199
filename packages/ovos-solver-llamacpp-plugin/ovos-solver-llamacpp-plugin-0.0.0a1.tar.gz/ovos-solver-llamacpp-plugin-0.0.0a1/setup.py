...
def get_version():
    ...
    version = None
    version_file = os.path.join(BASEDIR, 'ovos_solver_llamacpp', 'version.py')
...
setup(
    ...
    url='https://github.com/OpenVoiceOS/ovos-solver-plugin-llamacpp',
    author='jarbasai',
    author_email='jarbasai@mailfence.com',
    license='MIT',
    packages=['ovos_solver_llamacpp'],
    zip_safe=True,
