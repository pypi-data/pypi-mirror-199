...
def generate_frequencies(inpath, outpath, *, frequency_cutoff=0, input_encoding='utf8', output_encoding='utf8'):
...
def generate_frequencies_cli():
    ...
    generate_frequencies(args.inpath, args.outpath, frequency_cutoff=args.frequency_cutoff,
