...
class dyagram:
    ...
    def __init__(self, inventory_file=None, verbose=False):
        ...
        self.pbar = tqdm(total=100, bar_format=Fore.BLUE+"{l_bar}{bar}|") if not verbose else tqdm(total=100, bar_format="{l_bar}{bar}|", disable=True)
    ...
    def _load_inventory(self):
        self.pbar_update_int = 100 / len(self.inventory_object[self.site])
