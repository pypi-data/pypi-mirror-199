...
class dyagram:
    ...
    def discover(self):
        ...
        self.pbar = tqdm(total=100,
                         bar_format=Fore.LIGHTBLUE_EX + "{l_bar}{bar:20}|", leave=True) if not self.verbose else tqdm(total=100,
    ...
    def _load_inventory(self):
        self.pbar_update_int = 100 / len(self.inventory_object[self.site]) / 3 # 3 is the number of jobs each device hits CURRENTLY
