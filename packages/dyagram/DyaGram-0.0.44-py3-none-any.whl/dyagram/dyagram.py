...
class dyagram:
    ...
    def __init__(self, inventory_file=None, verbose=False):
        ...
        self.pbar = tqdm(total=100, desc="DyaGram Discovery",bar_format=Fore.LIGHTBLUE_EX+"{l_bar}{bar}|") if not verbose else tqdm(total=100, bar_format="{l_bar}{bar}|", disable=True)
