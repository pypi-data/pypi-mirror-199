...
class AlphaPCA(BaseEstimator, ClassifierMixin):
    ...
    def compute_optimal_alpha(self, X, alphas=None, n_components=None, degree=3, reconstruction_loss="mae"):
        ...
        def minimize(degree, alphas, reconstruction_losses):
            ...
            if degree == 2:
                ...
                delta = 4 * b**2 - 12 * a * c 
                if delta < 0:
                    print("Failed to find the optimal alpha, using degree=2")
                    return minimize(2, alphas, reconstruction_losses)
        ...
        return minimize(degree, alphas, reconstruction_losses)