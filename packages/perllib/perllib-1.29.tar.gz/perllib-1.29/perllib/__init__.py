# perllib module for pythonizer, generated by makelib.py on Sun Mar 26 10:42:55 2023
#
...
EVAL_ERROR = ''
LIST_SEPARATOR = ' '
_TIE_MAP = {'EXISTS': '__contains__','DELETE': '__delitem__','FETCH': '__getitem__','CLEAR': 'clear','PUSH': 'append','DESTROY': '__del__','SCALAR': '__len__','FETCHSIZE': '__len__','STORE': '__setitem__','UNTIE': '__untie__'}
_PYTHONIZER_KEYWORDS = {'sys','tm_py','itertools','re','set','eval','property','pass','close','list','yield','isinstance','glob','object','update','finally','min','dataclasses','class','str','complex','any','slice','break','staticmethod','pop','stat','input','casefold','lower','insert','fcntl','collections.abc','not','float','setattr','super','range','except','exec','getopt','calendar','rstrip','help','tuple','pow','async','False','extend','int','values','oct','vars','find','getattr','os','def','is','breakpoint','next','issubclass','None','signal','get','perllib','builtins','type','raise','as','struct','filter','traceback','frozenset','elif','locals','nonlocal','chr','dict','sum','lambda','all','max','while','continue','try','ascii','anext','copy','bool','round','if','globals','divmod','functools','or','Array','True','hash','in','bytearray','wantarray','reversed','io','else','await','open','with','keys','return','global','types','abs','aiter','upper','format','delattr','enumerate','argparse','hasattr','Hash','sorted','for','abc','inspect','hex','map','subprocess','random','from','classmethod','bytes','compile','ord','iter','memoryview','print','callable','fileinput','pdb','atexit','id','dir','repr','bin','and','codecs','warnings','import','rfind','zip','math','assert','tempfile','ArrayHash','del','len'}
