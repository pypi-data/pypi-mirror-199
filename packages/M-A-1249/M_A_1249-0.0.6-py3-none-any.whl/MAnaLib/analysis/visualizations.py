def line(df, x_col, y_col, title='', x_title='', y_title='', color='blue', width=800, height=500, show_legend=True, filename=None):
    """
...
def bar(df, x_col, y_col, color_col=None, title='', x_title='', y_title='', width=800, height=500, template='plotly_white', filename=None, auto_open=True):
    """
...
def dist(df,col,lenght = 4, filename=None, auto_open = False):
    """
...
def plot_box(df, x_col, y_col, title='', x_title='', y_title='', color='blue', width=800, height=500, show_legend=True):
    """
