...
class SnapshotRequestModel(object):
    ...
    def __init__(self, name=None, description=None, consent_code=None, contents=None, readers=None, profile_id=None, properties=None, policies=None, global_file_ids=False, local_vars_configuration=None):  # noqa: E501
