...
# Initialize Variables
    ...
    def settings(self, nodialog=False):
        ...
        self.showprocesslog('Input File: '+self.ifile)

# Read entire file
        idata = read_ifile(self.ifile)
...
def read_ifile(ifile):
    ...
    """
    # Read entire file
    with open(ifile, encoding='windows-1252') as inputf:
        # try:
        idata = inputf.read()
        # except:
        #     breakpoint()
...
def _testfn():
    ...
    ifile = r"D:\Workdata\seismology\Scans\1989\TXT_FILES\APR89.txt"
