...
class NxMonorepoProject(
    ...
    def add_implicit_dependency(
        ...
        dependee: _projen_04054675.Project,
    ) -> None:
...
@jsii.data_type(
    jsii_type="@aws-prototyping-sdk/nx-monorepo.NxRunManyOptions",
    jsii_struct_bases=[],
    name_mapping={
        "target": "target",
        "configuration": "configuration",
...
class NxRunManyOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__285d360c1a0547a74735d9056bfec65c3d439caa100100df6c1d6f32bc268130)
...
def _typecheckingstub__285d360c1a0547a74735d9056bfec65c3d439caa100100df6c1d6f32bc268130(
    *,
    target: builtins.str,
    configuration: typing.Optional[builtins.str] = None,
    exclude: typing.Optional[builtins.str] = None,
