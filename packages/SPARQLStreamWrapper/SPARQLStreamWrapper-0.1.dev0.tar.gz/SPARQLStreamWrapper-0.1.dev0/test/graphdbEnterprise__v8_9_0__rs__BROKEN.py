...
################
    ...
    # For a SELECT query type, the default return mimetype (if Accept: */* is sent) is text/csv
    @unittest.skip("graphDB supports only Content Negotiation")
...
#############
    ...
    @unittest.skip("graphDB not supports CSV for ASK queryType")
    ...
    @unittest.skip("graphDB not supports TSV for ASK queryType")
